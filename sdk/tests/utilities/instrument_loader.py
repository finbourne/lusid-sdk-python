...
class InstrumentLoader:
    _InstrumentSpec = namedtuple("InstrumentSpec", ["Figi", "Name"])

    _instruments = [
        _InstrumentSpec("BBG000FD8G46", "HISCOX LTD"),
        _InstrumentSpec("BBG000DW76R4", "ITV PLC"),
        _InstrumentSpec("BBG000PQKVN8", "MONDI PLC"),
        _InstrumentSpec("BBG000BDWPY0", "NEXT PLC"),
        _InstrumentSpec("BBG000BF46Y8", "TESCO PLC")
    ]
