...
*ComplianceGenericApi* | [**delete_compliance_rule2**](docs/ComplianceGenericApi.md#delete_compliance_rule2) | **DELETE** /api/compliance/generic/rules/{scope}/{code} | [EARLY ACCESS] DeleteComplianceRule2: Delete compliance rule.
*ComplianceGenericApi* | [**get_compliance_rule2**](docs/ComplianceGenericApi.md#get_compliance_rule2) | **GET** /api/compliance/generic/rules/{scope}/{code} | [EARLY ACCESS] GetComplianceRule2: Get compliance rule.
*ComplianceGenericApi* | [**get_compliance_run_summary**](docs/ComplianceGenericApi.md#get_compliance_run_summary) | **GET** /api/compliance/generic/runs/summary/{scope}/{code} | [EARLY ACCESS] GetComplianceRunSummary: Get compliance summary results.
*ComplianceGenericApi* | [**get_compliance_template**](docs/ComplianceGenericApi.md#get_compliance_template) | **GET** /api/compliance/templates/{scope}/{code} | [EARLY ACCESS] GetComplianceTemplate: Get the requested compliance template.
*ComplianceGenericApi* | [**list_compliance_rules2**](docs/ComplianceGenericApi.md#list_compliance_rules2) | **GET** /api/compliance/generic/rules | [EARLY ACCESS] ListComplianceRules2: List compliance rules.
*ComplianceGenericApi* | [**list_compliance_runs**](docs/ComplianceGenericApi.md#list_compliance_runs) | **GET** /api/compliance/generic/runs | [EARLY ACCESS] ListComplianceRuns: List historical Compliance RunIds
*ComplianceGenericApi* | [**list_compliance_templates**](docs/ComplianceGenericApi.md#list_compliance_templates) | **GET** /api/compliance/templates | [EARLY ACCESS] ListComplianceTemplates: Get a specific compliance template
*ComplianceGenericApi* | [**run_generic_compliance**](docs/ComplianceGenericApi.md#run_generic_compliance) | **POST** /api/compliance/generic/runs | [EARLY ACCESS] RunGenericCompliance: Kick off the compliance check process
*ComplianceGenericApi* | [**upsert_compliance_rule**](docs/ComplianceGenericApi.md#upsert_compliance_rule) | **POST** /api/compliance/generic/rules | [EARLY ACCESS] UpsertComplianceRule: Upsert a compliance rule.
...
## Documentation For Models
 ...
 - [StringComplianceParameterAllOf](docs/StringComplianceParameterAllOf.md)
