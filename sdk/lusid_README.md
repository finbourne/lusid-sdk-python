...
- API version: 0.9.189.b1
- Package version: 0.9.189.b1
...
*InstrumentsApi* | [**find_instruments**](lusid/docs/InstrumentsApi.md#find_instruments) | **POST** /api/instruments/$find | Search instrument definition
...
*InstrumentsApi* | [**match_instruments**](lusid/docs/InstrumentsApi.md#match_instruments) | **POST** /api/instruments/$match | Find externally mastered instruments
...
## Documentation For Models
 ...
 - [MatchInstrumentsResponse](lusid/docs/MatchInstrumentsResponse.md)
 ...
 - [QuoteLineage](lusid/docs/QuoteLineage.md)
