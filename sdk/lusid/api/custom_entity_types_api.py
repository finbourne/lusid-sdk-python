...
class CustomEntityTypesApi:
    ...
    @overload
    async def delete_custom_entity_type(self, entity_type : Annotated[StrictStr, Field(..., description="The identifier for the Custom Entity type, derived from the \"entityTypeName\" provided on creation.")], **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @overload
    def delete_custom_entity_type(self, entity_type : Annotated[StrictStr, Field(..., description="The identifier for the Custom Entity type, derived from the \"entityTypeName\" provided on creation.")], async_req: Optional[bool]=True, **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @validate_arguments
    def delete_custom_entity_type(self, entity_type : Annotated[StrictStr, Field(..., description="The identifier for the Custom Entity type, derived from the \"entityTypeName\" provided on creation.")], async_req: Optional[bool]=None, **kwargs) -> Union[DeletedEntityResponse, Awaitable[DeletedEntityResponse]]:  # noqa: E501
        ...
        >>> thread = api.delete_custom_entity_type(entity_type, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def delete_custom_entity_type_with_http_info(self, entity_type : Annotated[StrictStr, Field(..., description="The identifier for the Custom Entity type, derived from the \"entityTypeName\" provided on creation.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EARLY ACCESS] DeleteCustomEntityType: Delete a Custom Entity type.  # noqa: E501
        ...
        >>> thread = api.delete_custom_entity_type_with_http_info(entity_type, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/customentitytypes/{entityType}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def get_custom_entity_type(self, entity_type : Annotated[StrictStr, Field(..., description="The identifier for the Custom Entity Type, derived from the \"entityTypeName\" provided on creation.")], as_at : Annotated[Optional[datetime], Field(description="The AsAt datetime at which to retrieve the definition.")] = None, **kwargs) -> CustomEntityType:  # noqa: E501
        ...

    @overload
    def get_custom_entity_type(self, entity_type : Annotated[StrictStr, Field(..., description="The identifier for the Custom Entity Type, derived from the \"entityTypeName\" provided on creation.")], as_at : Annotated[Optional[datetime], Field(description="The AsAt datetime at which to retrieve the definition.")] = None, async_req: Optional[bool]=True, **kwargs) -> CustomEntityType:  # noqa: E501
        ...
    ...
    @validate_arguments
    def get_custom_entity_type_with_http_info(self, entity_type : Annotated[StrictStr, Field(..., description="The identifier for the Custom Entity Type, derived from the \"entityTypeName\" provided on creation.")], as_at : Annotated[Optional[datetime], Field(description="The AsAt datetime at which to retrieve the definition.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EARLY ACCESS] GetCustomEntityType: Get a Custom Entity Type.  # noqa: E501
