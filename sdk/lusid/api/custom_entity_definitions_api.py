...
class CustomEntityDefinitionsApi(object):
    ...
    @validate_arguments
    def create_custom_entity_definition_with_http_info(self, custom_entity_definition_request : Annotated[CustomEntityDefinitionRequest, Field(..., description="The payload containing the description of the Custom Entity type.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] CreateCustomEntityDefinition: Define a new Custom Entity type.  # noqa: E501
        ...
        _body_params = None
        if _params['custom_entity_definition_request']:
    ...
    @validate_arguments
    def update_custom_entity_definition_with_http_info(self, entity_type : Annotated[constr(strict=True, max_length=65, min_length=1), Field(..., description="The identifier for the Custom Entity type, derived from the \"entityTypeName\" provided on creation.")], update_custom_entity_definition_request : Annotated[UpdateCustomEntityDefinitionRequest, Field(..., description="The payload containing the description of the Custom Entity type.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] UpdateCustomEntityDefinition: Modify an existing Custom Entity type.  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['update_custom_entity_definition_request']:
