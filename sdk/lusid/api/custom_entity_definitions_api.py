...
class CustomEntityDefinitionsApi(object):
    ...
    def get_custom_entity_definition(self, entity_type, **kwargs):  # noqa: E501
        """[EARLY ACCESS] GetCustomEntityDefinition: Get a Custom Entity type definition.  # noqa: E501

        Retrieve a CustomEntityDefinition by a specific entityType at a point in AsAt time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_custom_entity_definition(entity_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_custom_entity_definition_with_http_info(entity_type, **kwargs)  # noqa: E501

    def get_custom_entity_definition_with_http_info(self, entity_type, **kwargs):  # noqa: E501
        """[EARLY ACCESS] GetCustomEntityDefinition: Get a Custom Entity type definition.  # noqa: E501
        ...
        >>> thread = api.get_custom_entity_definition_with_http_info(entity_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_custom_entity_definition" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('entity_type' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `entity_type` when calling `get_custom_entity_definition`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('entity_type' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `entity_type` when calling `get_custom_entity_definition`, length must be less than or equal to `65`")  # noqa: E501
        if self.api_client.client_side_validation and ('entity_type' in local_var_params and  # noqa: E501
                                                        len(local_var_params['entity_type']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `entity_type` when calling `get_custom_entity_definition`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_definition(self, entity_type, **kwargs):  # noqa: E501
        """[DEPRECATED] GetDefinition: Get a Custom Entity type definition.  # noqa: E501
    ...
    def get_definition_with_http_info(self, entity_type, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/customentities/entitytypes/{entityType}/$deprecated', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
