...
class BlocksApi(object):
    ...
    @validate_arguments
    def delete_block_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The block scope.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The block's code. This, together with the scope uniquely identifies the block to delete.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] DeleteBlock: Delete block  # noqa: E501
    ...
    @validate_arguments
    def upsert_blocks_with_http_info(self, block_set_request : Annotated[Optional[BlockSetRequest], Field(description="The collection of block requests.")] = None, **kwargs):  # noqa: E501
        """[EARLY ACCESS] UpsertBlocks: Upsert Block  # noqa: E501
