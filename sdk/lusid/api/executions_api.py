...
class ExecutionsApi:
    ...
    @overload
    async def delete_execution(self, scope : Annotated[StrictStr, Field(..., description="The execution scope.")], code : Annotated[StrictStr, Field(..., description="The execution's code. This, together with the scope uniquely identifies the execution to delete.")], **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @overload
    def delete_execution(self, scope : Annotated[StrictStr, Field(..., description="The execution scope.")], code : Annotated[StrictStr, Field(..., description="The execution's code. This, together with the scope uniquely identifies the execution to delete.")], async_req: Optional[bool]=True, **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...
    ...
    @overload
    async def get_execution(self, scope : Annotated[StrictStr, Field(..., description="The scope to which the execution belongs.")], code : Annotated[StrictStr, Field(..., description="The execution's unique identifier.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the execution. Defaults to return the latest version of the execution if not specified.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the \"Execution\" domain to decorate onto the execution.              These take the format {domain}/{scope}/{code} e.g. \"Execution/system/Name\".")] = None, **kwargs) -> Execution:  # noqa: E501
        ...
