...
class ExecutionsApi:
    ...
    @validate_arguments
    def delete_execution_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The execution scope.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The execution's code. This, together with the scope uniquely identifies the execution to delete.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EARLY ACCESS] DeleteExecution: Delete execution  # noqa: E501
    ...
    def upsert_executions_with_http_info(self, execution_set_request : Annotated[Optional[ExecutionSetRequest], Field(description="The collection of execution requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['execution_set_request'] is not None:
