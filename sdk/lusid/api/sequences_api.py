...
class SequencesApi(object):
    ...
    @validate_arguments
    def create_sequence_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="Scope of the sequence.")], create_sequence_request : Annotated[CreateSequenceRequest, Field(..., description="Request to create sequence")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] CreateSequence: Create a new sequence  # noqa: E501
        ...
        _body_params = None
        if _params['create_sequence_request']:
    ...
    @validate_arguments
    def get_sequence_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="Scope of the sequence.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="Code of the sequence. This together with stated scope uniquely              identifies the sequence.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] GetSequence: Get a specified sequence  # noqa: E501
