...
class CutLabelDefinitionsApi(object):
    ...
    def delete_cut_label_definition_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_cut_label_definition`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
    ...
    def get_cut_label_definition_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_cut_label_definition`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def update_cut_label_definition_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `update_cut_label_definition`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
