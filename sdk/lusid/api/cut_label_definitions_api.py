...
class CutLabelDefinitionsApi(object):
    ...
    @validate_arguments
    def create_cut_label_definition_with_http_info(self, create_cut_label_definition_request : Annotated[Optional[CreateCutLabelDefinitionRequest], Field(description="The cut label definition")] = None, **kwargs):  # noqa: E501
        """CreateCutLabelDefinition: Create a Cut Label  # noqa: E501
        ...
        _body_params = None
        if _params['create_cut_label_definition_request']:
    ...
    @validate_arguments
    def delete_cut_label_definition_with_http_info(self, code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The Code of the Cut Label that is being Deleted")], **kwargs):  # noqa: E501
        """DeleteCutLabelDefinition: Delete a Cut Label  # noqa: E501
    ...
    @validate_arguments
    def get_cut_label_definition_with_http_info(self, code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The Code of the Cut Label that is being queried")], as_at : Annotated[Optional[datetime], Field(description="The time at which to get the Cut Label")] = None, **kwargs):  # noqa: E501
        """GetCutLabelDefinition: Get a Cut Label  # noqa: E501
    ...
    def update_cut_label_definition_with_http_info(self, code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The Code of the Cut Label that is being updated")], update_cut_label_definition_request : Annotated[Optional[UpdateCutLabelDefinitionRequest], Field(description="The cut label update definition")] = None, **kwargs):  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['update_cut_label_definition_request']:
