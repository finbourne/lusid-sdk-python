...
class InstrumentsApi(object):
    ...
    def get_instruments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['identifier_type', 'effective_at', 'as_at', 'instrument_property_keys', 'request_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_instruments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['as_at', 'effective_at', 'sort_by', 'start', 'limit', 'filter', 'instrument_property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
