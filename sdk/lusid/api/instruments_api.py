...
class InstrumentsApi:
    ...
    @overload
    async def delete_instruments(self, request_body : Annotated[List[StrictStr], Field(description="The list of lusidInstrumentId's to delete.")], delete_mode : Annotated[Optional[StrictStr], Field( description="The delete mode to use. Default value: Soft. Available values: Soft, Hard.")] = None, scope : Annotated[Optional[StrictStr], Field( description="The scope in which the instruments lie. When not supplied the scope is 'default'.")] = None, **kwargs) -> DeleteInstrumentsResponse:  # noqa: E501
        ...

    @overload
    def delete_instruments(self, request_body : Annotated[List[StrictStr], Field(description="The list of lusidInstrumentId's to delete.")], delete_mode : Annotated[Optional[StrictStr], Field( description="The delete mode to use. Default value: Soft. Available values: Soft, Hard.")] = None, scope : Annotated[Optional[StrictStr], Field( description="The scope in which the instruments lie. When not supplied the scope is 'default'.")] = None, async_req: Optional[bool]=True, **kwargs) -> DeleteInstrumentsResponse:  # noqa: E501
        ...

    @validate_arguments
    def delete_instruments(self, request_body : Annotated[List[StrictStr], Field(description="The list of lusidInstrumentId's to delete.")], delete_mode : Annotated[Optional[StrictStr], Field( description="The delete mode to use. Default value: Soft. Available values: Soft, Hard.")] = None, scope : Annotated[Optional[StrictStr], Field( description="The scope in which the instruments lie. When not supplied the scope is 'default'.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[DeleteInstrumentsResponse, Awaitable[DeleteInstrumentsResponse]]:  # noqa: E501
