...
class PackagesApi(object):
    ...
    @validate_arguments
    def delete_package_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The package scope.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The package's code. This, together with the scope uniquely identifies the package to delete.")], **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeletePackage: Delete package  # noqa: E501
    ...
    @overload
    def upsert_packages(self, package_set_request : Annotated[Optional[PackageSetRequest], Field(description="The collection of package requests.")] = None, async_req: Optional[bool]=True, **kwargs) -> ResourceListOfPackage:  # noqa: E501
        ...

    @validate_arguments
    def upsert_packages(self, package_set_request : Annotated[Optional[PackageSetRequest], Field(description="The collection of package requests.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ResourceListOfPackage, Awaitable[ResourceListOfPackage]]:  # noqa: E501
    ...
    @validate_arguments
    def upsert_packages_with_http_info(self, package_set_request : Annotated[Optional[PackageSetRequest], Field(description="The collection of package requests.")] = None, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] UpsertPackages: Upsert Package  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['package_set_request']:
