...
class LoginApi(object):
    ...
    def get_saml_identity_provider_id(self, domain, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_saml_identity_provider_id_with_http_info(domain, **kwargs)  # noqa: E501
            return data
    ...
    def get_saml_identity_provider_id_with_http_info(self, domain, **kwargs):  # noqa: E501
        ...
        if ('domain' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `domain` when calling `get_saml_identity_provider_id`")  # noqa: E501
