...
class ConfigurationRecipeApi(object):
    ...
    def upsert_configuration_recipe(self, scope, structured_data, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_configuration_recipe(scope, structured_data, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope to use when updating or inserting the Configuration Recipe. (required)
        :param UpsertRecipeRequest structured_data: The Configuration Recipe to update or insert (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_configuration_recipe_with_http_info(scope, structured_data, **kwargs)  # noqa: E501

    def upsert_configuration_recipe_with_http_info(self, scope, structured_data, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert a Configuration Recipe. This creates or updates the data in Lusid.  # noqa: E501

        Update or insert one Configuration Recipe in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Configuration Recipe or failure message if unsuccessful                It is important to always check to verify success (or failure).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_configuration_recipe_with_http_info(scope, structured_data, async_req=True)
        >>> result = thread.get()
