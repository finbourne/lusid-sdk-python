...
class PortfoliosApi(object):
    ...
    def delete_portfolio_properties(self, scope, code, portfolio_property_keys, **kwargs):  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to delete the properties. Defaults to the current LUSID system datetime if not specified.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_portfolio(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified.
    ...
    def get_portfolio_properties(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to list the portfolio's properties. Defaults to the current LUSID system datetime if not specified.
    ...
    def list_portfolios(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str effective_at: The effective datetime at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified.
    ...
    def update_portfolio(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to update the definition. Defaults to the current              LUSID system datetime if not specified.
