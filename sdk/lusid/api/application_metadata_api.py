...
class ApplicationMetadataApi(object):
    ...
    @validate_arguments
    def get_excel_addin_with_http_info(self, version : Annotated[Optional[constr(strict=True, max_length=30, min_length=1)], Field(description="The requested version of the Excel plugin")] = None, **kwargs):  # noqa: E501
        """GetExcelAddin: Download Excel Addin  # noqa: E501
