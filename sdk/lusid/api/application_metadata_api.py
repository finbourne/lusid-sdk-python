...
class ApplicationMetadataApi:
    ...
    @overload
    async def get_excel_addin(self, version : Annotated[Optional[StrictStr], Field( description="The requested version of the Excel plugin")] = None, **kwargs) -> FileResponse:  # noqa: E501
        ...

    @overload
    def get_excel_addin(self, version : Annotated[Optional[StrictStr], Field( description="The requested version of the Excel plugin")] = None, async_req: Optional[bool]=True, **kwargs) -> FileResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_excel_addin(self, version : Annotated[Optional[StrictStr], Field( description="The requested version of the Excel plugin")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[FileResponse, Awaitable[FileResponse]]:  # noqa: E501
    ...
    @validate_arguments
    def get_excel_addin_with_http_info(self, version : Annotated[Optional[StrictStr], Field( description="The requested version of the Excel plugin")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """GetExcelAddin: Download Excel Addin  # noqa: E501
    ...
    @overload
    async def get_latest_as_at(self, **kwargs) -> LatestAsAt:  # noqa: E501
        ...

    @overload
    def get_latest_as_at(self, async_req: Optional[bool]=True, **kwargs) -> LatestAsAt:  # noqa: E501
        ...

    @validate_arguments
    def get_latest_as_at(self, async_req: Optional[bool]=None, **kwargs) -> Union[LatestAsAt, Awaitable[LatestAsAt]]:  # noqa: E501
        """[EXPERIMENTAL] GetLatestAsAt: Get latest AsAt  # noqa: E501

        Get the latest asAt datetime of the system, i.e. the asAt datetime of the most recent write.  This is the asAt datetime that a request made without an explicit asAt resolves to.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_latest_as_at(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_latest_as_at_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_latest_as_at_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_latest_as_at_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetLatestAsAt: Get latest AsAt  # noqa: E501
        ...
        >>> thread = api.get_latest_as_at_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LatestAsAt, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_latest_as_at" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
