...
class ApplicationMetadataApi(object):
    ...
    def get_excel_addin(self, **kwargs):  # noqa: E501
        """Download Excel Addin  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_excel_addin_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_excel_download_url(self, **kwargs):  # noqa: E501
        """Get Excel download url  # noqa: E501

        Request an authorised url for an Excel client version  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_excel_download_url(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_excel_download_url_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_excel_download_url_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_excel_download_url_with_http_info(self, **kwargs):  # noqa: E501
        """Get Excel download url  # noqa: E501

        Request an authorised url for an Excel client version  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_excel_download_url_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_excel_download_url" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def get_lusid_versions(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_lusid_versions_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def list_access_controlled_actions(self, **kwargs):  # noqa: E501
        """Get resources available for access control  # noqa: E501

        Get the comprehensive set of resources that are available for access control  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_access_controlled_actions(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: list[AccessControlledAction]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_access_controlled_actions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_access_controlled_actions_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_access_controlled_actions_with_http_info(self, **kwargs):  # noqa: E501
        """Get resources available for access control  # noqa: E501

        Get the comprehensive set of resources that are available for access control  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_access_controlled_actions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_access_controlled_actions" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/metadata/access/actions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[AccessControlledAction]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
