...
class EntitiesApi:
    ...
    @overload
    async def get_bookmark_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the bookmark.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the bookmark. Defaults to returning the latest version of the bookmark if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> BookmarkEntity:  # noqa: E501
        ...

    @overload
    def get_bookmark_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the bookmark.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the bookmark. Defaults to returning the latest version of the bookmark if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=True, **kwargs) -> BookmarkEntity:  # noqa: E501
        ...

    @validate_arguments
    def get_bookmark_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the bookmark.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the bookmark. Defaults to returning the latest version of the bookmark if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[BookmarkEntity, Awaitable[BookmarkEntity]]:  # noqa: E501
        """GetBookmarkByEntityUniqueId: Get bookmark by EntityUniqueId  # noqa: E501

        Retrieve the definition of a particular bookmark.    If the bookmark is deleted, this will return the state of the bookmark immediately prior to deletion.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_bookmark_by_entity_unique_id(entity_unique_id, as_at, previews, async_req=True)
        >>> result = thread.get()

        :param entity_unique_id: The universally unique identifier of the bookmark. (required)
        :type entity_unique_id: str
        :param as_at: The asAt datetime at which to retrieve the bookmark. Defaults to returning the latest version of the bookmark if not specified.
        :type as_at: datetime
        ...
        :rtype: BookmarkEntity
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_bookmark_by_entity_unique_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_bookmark_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, **kwargs)  # noqa: E501

    @validate_arguments
    def get_bookmark_by_entity_unique_id_with_http_info(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the bookmark.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the bookmark. Defaults to returning the latest version of the bookmark if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """GetBookmarkByEntityUniqueId: Get bookmark by EntityUniqueId  # noqa: E501
        ...
        >>> thread = api.get_bookmark_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(BookmarkEntity, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_bookmark_by_entity_unique_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/entities/bookmarks/{entityUniqueId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def get_compliance_rule_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the compliance rule.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the compliance rule. Defaults to returning the latest version of the compliance rule if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> ComplianceRuleEntity:  # noqa: E501
        ...

    @overload
    def get_compliance_rule_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the compliance rule.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the compliance rule. Defaults to returning the latest version of the compliance rule if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=True, **kwargs) -> ComplianceRuleEntity:  # noqa: E501
        ...

    @validate_arguments
    def get_compliance_rule_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the compliance rule.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the compliance rule. Defaults to returning the latest version of the compliance rule if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ComplianceRuleEntity, Awaitable[ComplianceRuleEntity]]:  # noqa: E501
        """[EARLY ACCESS] GetComplianceRuleByEntityUniqueId: Get compliance rule by EntityUniqueId  # noqa: E501

        Retrieve the definition of a particular compliance rule.    If the compliance rule is deleted, this will return the state of the rule immediately prior to deletion.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_compliance_rule_by_entity_unique_id(entity_unique_id, as_at, previews, async_req=True)
        >>> result = thread.get()

        :param entity_unique_id: The universally unique identifier of the compliance rule. (required)
        :type entity_unique_id: str
        :param as_at: The asAt datetime at which to retrieve the compliance rule. Defaults to returning the latest version of the compliance rule if not specified.
        :type as_at: datetime
        :param previews: The ids of the staged modifications to be previewed in the response.
        :type previews: List[str]
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ComplianceRuleEntity
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_compliance_rule_by_entity_unique_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_compliance_rule_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, **kwargs)  # noqa: E501

    @validate_arguments
    def get_compliance_rule_by_entity_unique_id_with_http_info(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the compliance rule.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the compliance rule. Defaults to returning the latest version of the compliance rule if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EARLY ACCESS] GetComplianceRuleByEntityUniqueId: Get compliance rule by EntityUniqueId  # noqa: E501
        ...
        >>> thread = api.get_compliance_rule_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ComplianceRuleEntity, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_compliance_rule_by_entity_unique_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ComplianceRuleEntity",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/entities/compliancerules/{entityUniqueId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def get_compliance_rule_template_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the compliance rule template.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> ComplianceRuleTemplateEntity:  # noqa: E501
        ...

    @overload
    def get_compliance_rule_template_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the compliance rule template.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=True, **kwargs) -> ComplianceRuleTemplateEntity:  # noqa: E501
        ...

    @validate_arguments
    def get_compliance_rule_template_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the compliance rule template.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ComplianceRuleTemplateEntity, Awaitable[ComplianceRuleTemplateEntity]]:  # noqa: E501
        """[EARLY ACCESS] GetComplianceRuleTemplateByEntityUniqueId: Get compliance rule template by EntityUniqueId  # noqa: E501

        Retrieve the definition of a particular compliance rule template.    If the compliance rule template is deleted, this will return the state of the template immediately prior to  deletion.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_compliance_rule_template_by_entity_unique_id(entity_unique_id, as_at, previews, async_req=True)
        >>> result = thread.get()

        :param entity_unique_id: The universally unique identifier of the compliance rule template. (required)
        :type entity_unique_id: str
        :param as_at: The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified.
        :type as_at: datetime
        :param previews: The ids of the staged modifications to be previewed in the response.
        :type previews: List[str]
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ComplianceRuleTemplateEntity
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_compliance_rule_template_by_entity_unique_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_compliance_rule_template_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, **kwargs)  # noqa: E501

    @validate_arguments
    def get_compliance_rule_template_by_entity_unique_id_with_http_info(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the compliance rule template.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EARLY ACCESS] GetComplianceRuleTemplateByEntityUniqueId: Get compliance rule template by EntityUniqueId  # noqa: E501
        ...
        >>> thread = api.get_compliance_rule_template_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ComplianceRuleTemplateEntity, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_compliance_rule_template_by_entity_unique_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ComplianceRuleTemplateEntity",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/entities/complianceruletemplates/{entityUniqueId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def get_custom_entity_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the Custom Entity.")], effective_at : Annotated[Optional[StrictStr], Field( description="The effective datetime or cut label at which to retrieve the Custom Entity. Defaults to the current LUSID system datetime if not specified.")] = None, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the Custom Entity. Defaults to returning the latest version of the Custom Entity if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> CustomEntityEntity:  # noqa: E501
        ...

    @overload
    def get_custom_entity_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the Custom Entity.")], effective_at : Annotated[Optional[StrictStr], Field( description="The effective datetime or cut label at which to retrieve the Custom Entity. Defaults to the current LUSID system datetime if not specified.")] = None, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the Custom Entity. Defaults to returning the latest version of the Custom Entity if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=True, **kwargs) -> CustomEntityEntity:  # noqa: E501
        ...

    @validate_arguments
    def get_custom_entity_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the Custom Entity.")], effective_at : Annotated[Optional[StrictStr], Field( description="The effective datetime or cut label at which to retrieve the Custom Entity. Defaults to the current LUSID system datetime if not specified.")] = None, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the Custom Entity. Defaults to returning the latest version of the Custom Entity if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[CustomEntityEntity, Awaitable[CustomEntityEntity]]:  # noqa: E501
    ...
    @overload
    async def get_data_type_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the DataType definition.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the DataType definition. Defaults to returning the latest version of the DataType definition if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> DataTypeEntity:  # noqa: E501
        ...

    @overload
    def get_data_type_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the DataType definition.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the DataType definition. Defaults to returning the latest version of the DataType definition if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=True, **kwargs) -> DataTypeEntity:  # noqa: E501
        ...

    @validate_arguments
    def get_data_type_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the DataType definition.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the DataType definition. Defaults to returning the latest version of the DataType definition if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[DataTypeEntity, Awaitable[DataTypeEntity]]:  # noqa: E501
    ...
    @overload
    def get_entity_history(self, entity_type : Annotated[StrictStr, Field(..., description="The type of the entity to list the change history for.")], entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the entity.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to list change history information. Defaults to return the change history at the latest datetime if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing change history information from a previous call to list change              history information. This value is returned from the previous call. If a pagination token is provided the filter, sortBy              and asAt fields must not have changed since the original request.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.")] = None, sort_by : Annotated[Optional[List[StrictStr]], Field(description="A list of field names suffixed by \" ASC\" or \" DESC\"")] = None, async_req: Optional[bool]=True, **kwargs) -> ResourceListOfChangeInterval:  # noqa: E501
        ...
    ...
    @overload
    async def get_portfolio_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the portfolio definition.")], effective_at : Annotated[Optional[StrictStr], Field( description="The effective datetime or cut label at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified.")] = None, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the portfolio definition. Defaults to returning the latest version of the portfolio definition if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> PortfolioEntity:  # noqa: E501
        ...

    @overload
    def get_portfolio_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the portfolio definition.")], effective_at : Annotated[Optional[StrictStr], Field( description="The effective datetime or cut label at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified.")] = None, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the portfolio definition. Defaults to returning the latest version of the portfolio definition if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=True, **kwargs) -> PortfolioEntity:  # noqa: E501
        ...

    @validate_arguments
    def get_portfolio_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the portfolio definition.")], effective_at : Annotated[Optional[StrictStr], Field( description="The effective datetime or cut label at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified.")] = None, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the portfolio definition. Defaults to returning the latest version of the portfolio definition if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[PortfolioEntity, Awaitable[PortfolioEntity]]:  # noqa: E501
    ...
    @overload
    async def get_transaction_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The entity unique identifier of the transaction. The expected format is '{portfolioEntityUniqueId}_{transactionId}'.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the transaction. Defaults to returning the latest version of the transaction if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, data_model_scope : Annotated[Optional[StrictStr], Field( description="The optional scope of a Custom Data Model to use.")] = None, data_model_code : Annotated[Optional[StrictStr], Field( description="The optional code of a Custom Data Model to use.")] = None, **kwargs) -> TransactionEntity:  # noqa: E501
        ...

    @overload
    def get_transaction_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The entity unique identifier of the transaction. The expected format is '{portfolioEntityUniqueId}_{transactionId}'.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the transaction. Defaults to returning the latest version of the transaction if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, data_model_scope : Annotated[Optional[StrictStr], Field( description="The optional scope of a Custom Data Model to use.")] = None, data_model_code : Annotated[Optional[StrictStr], Field( description="The optional code of a Custom Data Model to use.")] = None, async_req: Optional[bool]=True, **kwargs) -> TransactionEntity:  # noqa: E501
        ...

    @validate_arguments
    def get_transaction_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The entity unique identifier of the transaction. The expected format is '{portfolioEntityUniqueId}_{transactionId}'.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the transaction. Defaults to returning the latest version of the transaction if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, data_model_scope : Annotated[Optional[StrictStr], Field( description="The optional scope of a Custom Data Model to use.")] = None, data_model_code : Annotated[Optional[StrictStr], Field( description="The optional code of a Custom Data Model to use.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[TransactionEntity, Awaitable[TransactionEntity]]:  # noqa: E501
        """GetTransactionByEntityUniqueId: Get transaction by EntityUniqueId  # noqa: E501

        Retrieve a transaction by its entity unique identifier.    If the transaction's portfolio is deleted, this will return the state of the transaction immediately prior to portfolio deletion.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_transaction_by_entity_unique_id(entity_unique_id, as_at, previews, data_model_scope, data_model_code, async_req=True)
        >>> result = thread.get()

        :param entity_unique_id: The entity unique identifier of the transaction. The expected format is '{portfolioEntityUniqueId}_{transactionId}'. (required)
        :type entity_unique_id: str
        :param as_at: The asAt datetime at which to retrieve the transaction. Defaults to returning the latest version of the transaction if not specified.
        :type as_at: datetime
        :param previews: The ids of the staged modifications to be previewed in the response.
        :type previews: List[str]
        :param data_model_scope: The optional scope of a Custom Data Model to use.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: TransactionEntity
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_transaction_by_entity_unique_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_transaction_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, data_model_scope, data_model_code, **kwargs)  # noqa: E501

    @validate_arguments
    def get_transaction_by_entity_unique_id_with_http_info(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The entity unique identifier of the transaction. The expected format is '{portfolioEntityUniqueId}_{transactionId}'.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the transaction. Defaults to returning the latest version of the transaction if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, data_model_scope : Annotated[Optional[StrictStr], Field( description="The optional scope of a Custom Data Model to use.")] = None, data_model_code : Annotated[Optional[StrictStr], Field( description="The optional code of a Custom Data Model to use.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """GetTransactionByEntityUniqueId: Get transaction by EntityUniqueId  # noqa: E501
        ...
        >>> thread = api.get_transaction_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, data_model_scope, data_model_code, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TransactionEntity, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_transaction_by_entity_unique_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "TransactionEntity",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/entities/transactions/{entityUniqueId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def get_valuation_point_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the valuation point.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the valuation point. Defaults to returning the latest version of the valuation point if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> ValuationPointEntity:  # noqa: E501
        ...

    @overload
    def get_valuation_point_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the valuation point.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the valuation point. Defaults to returning the latest version of the valuation point if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=True, **kwargs) -> ValuationPointEntity:  # noqa: E501
        ...

    @validate_arguments
    def get_valuation_point_by_entity_unique_id(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the valuation point.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the valuation point. Defaults to returning the latest version of the valuation point if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ValuationPointEntity, Awaitable[ValuationPointEntity]]:  # noqa: E501
        ...
        >>> thread = api.get_valuation_point_by_entity_unique_id(entity_unique_id, as_at, previews, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_valuation_point_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, **kwargs)  # noqa: E501

    @validate_arguments
    def get_valuation_point_by_entity_unique_id_with_http_info(self, entity_unique_id : Annotated[StrictStr, Field(..., description="The universally unique identifier of the valuation point.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the valuation point. Defaults to returning the latest version of the valuation point if not specified.")] = None, previews : Annotated[Optional[List[StrictStr]], Field(description="The ids of the staged modifications to be previewed in the response.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """GetValuationPointByEntityUniqueId: Get valuation point by EntityUniqueId  # noqa: E501
        ...
        >>> thread = api.get_valuation_point_by_entity_unique_id_with_http_info(entity_unique_id, as_at, previews, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/entities/valuationpoints/{entityUniqueId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
