...
class EntitiesApi(object):
    ...
    def get_portfolio_changes(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_portfolio_changes(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str scope: The scope
        :param datetime effective_at: The effective date of the origin.
        ...
        if kwargs.get('async_req'):
            return self.get_portfolio_changes_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_portfolio_changes_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_portfolio_changes_with_http_info(self, **kwargs):  # noqa: E501
        """Get the next change to each portfolio in a scope.  # noqa: E501

        Gets the time of the next (earliest effective at) modification (correction and/or amendment) to each portfolio in a scope relative to a point in bitemporal time.  Includes changes from parent portfolios in different scopes.  Excludes changes from subcriptions (e.g corporate actions).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_portfolio_changes_with_http_info(async_req=True)
        >>> result = thread.get()
