...
class RelationDefinitionsApi(object):
    ...
    @validate_arguments
    def create_relation_definition_with_http_info(self, create_relation_definition_request : Annotated[CreateRelationDefinitionRequest, Field(..., description="The definition of the new relation.")], **kwargs):  # noqa: E501
        """[EXPERIMENTAL] CreateRelationDefinition: Create a relation definition  # noqa: E501
        ...
        _body_params = None
        if _params['create_relation_definition_request']:
    ...
    @validate_arguments
    def delete_relation_definition_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope of the relation to be deleted.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The code of the relation to be deleted. Together with the domain and scope this uniquely              identifies the relation.")], **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteRelationDefinition: Delete relation definition  # noqa: E501
