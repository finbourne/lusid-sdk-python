...
class QuotesApi(object):
    ...
    def delete_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param list[DeleteQuoteRequest] delete_quote_request: The quotes to delete
    ...
    def delete_quotes_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'delete_quote_request']  # noqa: E501
        ...
        if ('scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `scope` when calling `delete_quotes`")  # noqa: E501
        ...
        body_params = None
        if 'delete_quote_request' in local_var_params:
            body_params = local_var_params['delete_quote_request']
        # HTTP header `Accept`
    ...
    def get_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param list[QuoteId] quote_id: The ids of the quotes
    ...
    def get_quotes_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'effective_at', 'as_at', 'max_age', 'page', 'limit', 'quote_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_quotes`")  # noqa: E501
        ...
        if 'quote_id' in local_var_params:
            body_params = local_var_params['quote_id']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
    ...
    def upsert_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str scope: The scope of the quotes (required)
        :param list[UpsertQuoteRequest] upsert_quote_request: The quotes to upsert
    ...
    def upsert_quotes_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'upsert_quote_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `upsert_quotes`")  # noqa: E501
        ...
        body_params = None
        if 'upsert_quote_request' in local_var_params:
            body_params = local_var_params['upsert_quote_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
