...
class ReconciliationsApi(object):
    ...
    def reconcile_holdings_preview(self, **kwargs):  # noqa: E501
        ...
        :param PortfoliosReconciliationRequestPreview request: The specifications of the inputs to the reconciliation. This request can take tolerance for units and cost.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
