...
class ReconciliationsApi(object):
    ...
    def reconcile_holdings(self, **kwargs):  # noqa: E501
        """Reconcile portfolio holdings  # noqa: E501
        ...
        :param PortfoliosReconciliationRequest request: The specifications of the inputs to the reconciliation
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.reconcile_holdings_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def reconcile_valuation(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.reconcile_valuation_with_http_info(**kwargs)  # noqa: E501
            return data
