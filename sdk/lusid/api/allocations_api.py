...
class AllocationsApi(object):
    ...
    @validate_arguments
    def delete_allocation_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The allocation scope.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The allocation's code. This, together with the scope uniquely identifies the allocation to delete.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] DeleteAllocation: Delete allocation  # noqa: E501
    ...
    @validate_arguments
    def upsert_allocations_with_http_info(self, allocation_set_request : Annotated[Optional[AllocationSetRequest], Field(description="The collection of allocation requests.")] = None, **kwargs):  # noqa: E501
        """[EARLY ACCESS] UpsertAllocations: Upsert Allocations  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['allocation_set_request']:
