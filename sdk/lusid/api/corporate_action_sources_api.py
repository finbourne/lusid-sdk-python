...
class CorporateActionSourcesApi(object):
    ...
    def batch_upsert_corporate_actions(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param list[CreateCorporateAction] create_corporate_action: The corporate action definitions
    ...
    def batch_upsert_corporate_actions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'create_corporate_action']  # noqa: E501
        ...
        if ('scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `scope` when calling `batch_upsert_corporate_actions`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `batch_upsert_corporate_actions`")  # noqa: E501
        ...
        body_params = None
        if 'create_corporate_action' in local_var_params:
            body_params = local_var_params['create_corporate_action']
        # HTTP header `Accept`
    ...
    def create_corporate_action_source(self, create_corporate_action_source_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_corporate_action_source_with_http_info(create_corporate_action_source_request, **kwargs)  # noqa: E501
            return data
    ...
    def create_corporate_action_source_with_http_info(self, create_corporate_action_source_request, **kwargs):  # noqa: E501
        ...
        if ('create_corporate_action_source_request' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `create_corporate_action_source_request` when calling `create_corporate_action_source`")  # noqa: E501
    ...
    def delete_corporate_action_source(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param datetime effective_at: Optional. The start effective date of the data
    ...
    def delete_corporate_action_source_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `delete_corporate_action_source`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `delete_corporate_action_source`")  # noqa: E501
    ...
    def get_corporate_actions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_corporate_actions`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_corporate_actions`")  # noqa: E501
    ...
    def list_corporate_action_sources(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param datetime effective_at: Optional. The start effective date of the data range
        :param datetime as_at: Optional. The AsAt date of the data
        :param list[str] sort_by: Optional. Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName
        :param int start: Optional. When paginating, skip this number of results
        :param int limit: Optional. When paginating, limit the number of returned results to this many
    ...
    def list_corporate_action_sources_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['effective_at', 'as_at', 'sort_by', 'start', 'limit', 'filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
