...
class AggregationApi:
    ...
    @overload
    async def generate_configuration_recipe(self, scope : Annotated[StrictStr, Field(..., description="The scope of the portfolio")], code : Annotated[StrictStr, Field(..., description="The code of the portfolio")], create_recipe_request : Annotated[Optional[CreateRecipeRequest], Field(description="The request specifying the parameters to generating the recipe")] = None, **kwargs) -> ConfigurationRecipe:  # noqa: E501
        ...
    ...
    @validate_arguments
    def generate_configuration_recipe_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the portfolio")], code : Annotated[StrictStr, Field(..., description="The code of the portfolio")], create_recipe_request : Annotated[Optional[CreateRecipeRequest], Field(description="The request specifying the parameters to generating the recipe")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GenerateConfigurationRecipe: Generates a recipe sufficient to perform valuations for the given portfolio.  # noqa: E501
    ...
    @overload
    async def get_queryable_keys_for_metrics(self, queryable_keys_for_metrics_request : Annotated[Optional[QueryableKeysForMetricsRequest], Field(description="The set of metrics whose queryable keys are to be described")] = None, **kwargs) -> QueryableKeysForMetricsResponse:  # noqa: E501
        ...

    @overload
    def get_queryable_keys_for_metrics(self, queryable_keys_for_metrics_request : Annotated[Optional[QueryableKeysForMetricsRequest], Field(description="The set of metrics whose queryable keys are to be described")] = None, async_req: Optional[bool]=True, **kwargs) -> QueryableKeysForMetricsResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_queryable_keys_for_metrics(self, queryable_keys_for_metrics_request : Annotated[Optional[QueryableKeysForMetricsRequest], Field(description="The set of metrics whose queryable keys are to be described")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[QueryableKeysForMetricsResponse, Awaitable[QueryableKeysForMetricsResponse]]:  # noqa: E501
        """[EXPERIMENTAL] GetQueryableKeysForMetrics: Query the queryable keys behind a given set of valuation metrics.  # noqa: E501
        ...
        >>> thread = api.get_queryable_keys_for_metrics(queryable_keys_for_metrics_request, async_req=True)
        >>> result = thread.get()

        :param queryable_keys_for_metrics_request: The set of metrics whose queryable keys are to be described
        :type queryable_keys_for_metrics_request: QueryableKeysForMetricsRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: Timeout setting. Do not use - use the opts parameter instead
        :param opts: Configuration options for this request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: QueryableKeysForMetricsResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_queryable_keys_for_metrics_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_queryable_keys_for_metrics_with_http_info(queryable_keys_for_metrics_request, **kwargs)  # noqa: E501

    @validate_arguments
    def get_queryable_keys_for_metrics_with_http_info(self, queryable_keys_for_metrics_request : Annotated[Optional[QueryableKeysForMetricsRequest], Field(description="The set of metrics whose queryable keys are to be described")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetQueryableKeysForMetrics: Query the queryable keys behind a given set of valuation metrics.  # noqa: E501
        ...
        >>> thread = api.get_queryable_keys_for_metrics_with_http_info(queryable_keys_for_metrics_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(QueryableKeysForMetricsResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'queryable_keys_for_metrics_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_queryable_keys_for_metrics" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['queryable_keys_for_metrics_request'] is not None:
            _body_params = _params['queryable_keys_for_metrics_request']
        ...
        _response_types_map = {
            '200': "QueryableKeysForMetricsResponse",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/aggregation/$queryablekeys', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
