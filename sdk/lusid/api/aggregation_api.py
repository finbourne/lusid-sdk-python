...
class AggregationApi(object):
    ...
    def get_aggregation_by_group_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `scope` when calling `get_aggregation_by_group`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_aggregation_by_group`")  # noqa: E501
    ...
    def get_aggregation_by_portfolio_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_aggregation_by_portfolio`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_aggregation_by_portfolio`")  # noqa: E501
    ...
    def get_aggregation_by_result_set_with_http_info(self, scope, results_key, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_aggregation_by_result_set`")  # noqa: E501
        ...
        if ('results_key' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `results_key` when calling `get_aggregation_by_result_set`")  # noqa: E501
    ...
    def get_nested_aggregation_by_group_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_nested_aggregation_by_group`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_nested_aggregation_by_group`")  # noqa: E501
