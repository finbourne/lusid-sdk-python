...
class AggregationApi(object):
    ...
    def generate_configuration_recipe_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope of the portfolio")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The code of the portfolio")], create_recipe_request : Annotated[Optional[CreateRecipeRequest], Field(description="The request specifying the parameters to generating the recipe")] = None, **kwargs):  # noqa: E501
        ...
        _body_params = None
        if _params['create_recipe_request']:
    ...
    @validate_arguments
    def get_valuation_with_http_info(self, valuation_request : Annotated[Optional[ValuationRequest], Field(description="The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics")] = None, **kwargs):  # noqa: E501
        """GetValuation: Perform valuation for a list of portfolios and/or portfolio groups  # noqa: E501
    ...
    @validate_arguments
    def get_valuation_of_weighted_instruments_with_http_info(self, inline_valuation_request : Annotated[Optional[InlineValuationRequest], Field(description="The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics")] = None, **kwargs):  # noqa: E501
        """GetValuationOfWeightedInstruments: Perform valuation for an inlined portfolio  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['inline_valuation_request']:
    ...
    @validate_arguments
    def supported_analytics_internal_with_http_info(self, supported_analytics_internal_request : Optional[SupportedAnalyticsInternalRequest] = None, **kwargs):  # noqa: E501
        """[INTERNAL] SupportedAnalyticsInternal: Generates a matrix of analytics features supported by LUSID.  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['supported_analytics_internal_request']:
