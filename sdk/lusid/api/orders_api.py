...
class OrdersApi(object):
    ...
    def list_orders(self, scope, **kwargs):  # noqa: E501
        ...
        :param str filter: Expression to filter the result set.  Currently Orders can be filtered by Code (e.g.              \"Code eq 'ORD001'), Quantity (e.g. \"Quantity lt 100\"), Portfolio (e.g. \"Portfolio eq 'TestScope/UKEquities'\"),              LUSID Instrument Id (e.g. \"LusidInstrumentId eq 'LUID_12345678'\") or by Property (Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid).
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_orders_with_http_info(scope, **kwargs)  # noqa: E501

    def list_orders_with_http_info(self, scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Fetch the last pre-AsAt date version of each order in scope (does not fetch the entire history).  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_orders_with_http_info(scope, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'as_at', 'page', 'sort_by', 'start', 'limit', 'filter', 'property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('scope' not in local_var_params or  # noqa: E501
                                                        local_var_params['scope'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `scope` when calling `list_orders`")  # noqa: E501
    ...
    def upsert_orders(self, scope, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_orders_with_http_info(scope, **kwargs)  # noqa: E501

    def upsert_orders_with_http_info(self, scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert; update existing orders with given ids, or create new orders otherwise.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_orders_with_http_info(scope, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('scope' not in local_var_params or  # noqa: E501
                                                        local_var_params['scope'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `scope` when calling `upsert_orders`")  # noqa: E501
