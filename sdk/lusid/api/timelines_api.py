...
class TimelinesApi:
    ...
    @overload
    async def batch_create_closed_period_candidates(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.")], batch_create_closed_periods_request : Annotated[Optional[BatchCreateClosedPeriodsRequest], Field(description="The ordered set of Closed Periods to create")] = None, **kwargs) -> ResourceListOfClosedPeriod:  # noqa: E501
        ...

    @overload
    def batch_create_closed_period_candidates(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.")], batch_create_closed_periods_request : Annotated[Optional[BatchCreateClosedPeriodsRequest], Field(description="The ordered set of Closed Periods to create")] = None, async_req: Optional[bool]=True, **kwargs) -> ResourceListOfClosedPeriod:  # noqa: E501
        ...

    @validate_arguments
    def batch_create_closed_period_candidates(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.")], batch_create_closed_periods_request : Annotated[Optional[BatchCreateClosedPeriodsRequest], Field(description="The ordered set of Closed Periods to create")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ResourceListOfClosedPeriod, Awaitable[ResourceListOfClosedPeriod]]:  # noqa: E501
        ...
        >>> thread = api.batch_create_closed_period_candidates(scope, code, batch_create_closed_periods_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.batch_create_closed_period_candidates_with_http_info(scope, code, batch_create_closed_periods_request, **kwargs)  # noqa: E501

    @validate_arguments
    def batch_create_closed_period_candidates_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.")], batch_create_closed_periods_request : Annotated[Optional[BatchCreateClosedPeriodsRequest], Field(description="The ordered set of Closed Periods to create")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] BatchCreateClosedPeriodCandidates: Atomically create an ordered series of confirmed closed period candidates against a timeline entity  # noqa: E501
        ...
        >>> thread = api.batch_create_closed_period_candidates_with_http_info(scope, code, batch_create_closed_periods_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/timelines/{scope}/{code}/closedperiods/candidate/$batchCreate', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def batch_create_closed_periods(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the domain and scope this uniquely identifies the Timeline.")], batch_create_closed_periods_request : Annotated[Optional[BatchCreateClosedPeriodsRequest], Field(description="The ordered set of Closed Periods to create")] = None, **kwargs) -> ResourceListOfClosedPeriod:  # noqa: E501
        ...

    @overload
    def batch_create_closed_periods(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the domain and scope this uniquely identifies the Timeline.")], batch_create_closed_periods_request : Annotated[Optional[BatchCreateClosedPeriodsRequest], Field(description="The ordered set of Closed Periods to create")] = None, async_req: Optional[bool]=True, **kwargs) -> ResourceListOfClosedPeriod:  # noqa: E501
        ...
    ...
    def batch_create_closed_periods(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the domain and scope this uniquely identifies the Timeline.")], batch_create_closed_periods_request : Annotated[Optional[BatchCreateClosedPeriodsRequest], Field(description="The ordered set of Closed Periods to create")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ResourceListOfClosedPeriod, Awaitable[ResourceListOfClosedPeriod]]:  # noqa: E501
        ...
        >>> thread = api.batch_create_closed_periods(scope, code, batch_create_closed_periods_request, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.batch_create_closed_periods_with_http_info(scope, code, batch_create_closed_periods_request, **kwargs)  # noqa: E501

    @validate_arguments
    def batch_create_closed_periods_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the domain and scope this uniquely identifies the Timeline.")], batch_create_closed_periods_request : Annotated[Optional[BatchCreateClosedPeriodsRequest], Field(description="The ordered set of Closed Periods to create")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] BatchCreateClosedPeriods: Atomically create an ordered series of confirmed closed periods against a timeline entity  # noqa: E501
        ...
        >>> thread = api.batch_create_closed_periods_with_http_info(scope, code, batch_create_closed_periods_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/timelines/{scope}/{code}/closedperiods/$batchCreate', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def delete_timeline(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the domain and scope this uniquely              identifies the Timeline.")], **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...
    ...
    @validate_arguments
    def delete_timeline_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the specified Timeline.")], code : Annotated[StrictStr, Field(..., description="The code of the specified Timeline. Together with the domain and scope this uniquely              identifies the Timeline.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] DeleteTimeline: Deletes a particular Timeline  # noqa: E501
