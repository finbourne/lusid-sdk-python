...
class PlacementsApi(object):
    ...
    @validate_arguments
    def delete_placement_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The placement scope.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The placement's code. This, together with the scope uniquely identifies the placement to delete.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] DeletePlacement: Delete placement  # noqa: E501
    ...
    @validate_arguments
    def upsert_placements_with_http_info(self, placement_set_request : Annotated[Optional[PlacementSetRequest], Field(description="The collection of placement requests.")] = None, **kwargs):  # noqa: E501
        """[EARLY ACCESS] UpsertPlacements: Upsert Placement  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['placement_set_request']:
