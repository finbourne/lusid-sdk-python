...
class DataTypesApi(object):
    ...
    def create_data_type(self, **kwargs):  # noqa: E501
        """Create data type definition  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_data_type_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_data_type(self, scope, code, **kwargs):  # noqa: E501
        """Get data type definition  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_data_type_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def get_data_type_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `scope` when calling `get_data_type`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_data_type`")  # noqa: E501
    ...
    def get_units_from_data_type(self, scope, code, **kwargs):  # noqa: E501
        """Get units from data type  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_units_from_data_type_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def get_units_from_data_type_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'units', 'filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_units_from_data_type`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_units_from_data_type`")  # noqa: E501
    ...
    def list_data_types(self, scope, **kwargs):  # noqa: E501
        ...
        :param bool include_default: Whether to additionally include those data types in the \"default\" scope
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_data_types_with_http_info(scope, **kwargs)  # noqa: E501
            return data
    ...
    def list_data_types_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'include_default', 'include_system', 'sort_by', 'start', 'limit', 'filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `list_data_types`")  # noqa: E501
        ...
        query_params = []
        if 'include_default' in local_var_params:
            query_params.append(('includeDefault', local_var_params['include_default']))  # noqa: E501
    ...
    def update_data_type(self, scope, code, **kwargs):  # noqa: E501
        """Update data type definition  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_data_type_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def update_data_type_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `update_data_type`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `update_data_type`")  # noqa: E501
