...
class DataTypesApi:
    ...
    @overload
    async def update_reference_values(self, scope : Annotated[StrictStr, Field(..., description="The scope of the data type")], code : Annotated[StrictStr, Field(..., description="The code of the data type")], field_value : Annotated[List[FieldValue], Field(description="The updated reference values")], **kwargs) -> DataType:  # noqa: E501
        ...

    @overload
    def update_reference_values(self, scope : Annotated[StrictStr, Field(..., description="The scope of the data type")], code : Annotated[StrictStr, Field(..., description="The code of the data type")], field_value : Annotated[List[FieldValue], Field(description="The updated reference values")], async_req: Optional[bool]=True, **kwargs) -> DataType:  # noqa: E501
        ...

    @validate_arguments
    def update_reference_values(self, scope : Annotated[StrictStr, Field(..., description="The scope of the data type")], code : Annotated[StrictStr, Field(..., description="The code of the data type")], field_value : Annotated[List[FieldValue], Field(description="The updated reference values")], async_req: Optional[bool]=None, **kwargs) -> Union[DataType, Awaitable[DataType]]:  # noqa: E501
    ...
    @validate_arguments
    def update_reference_values_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the data type")], code : Annotated[StrictStr, Field(..., description="The code of the data type")], field_value : Annotated[List[FieldValue], Field(description="The updated reference values")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EARLY ACCESS] UpdateReferenceValues: Update reference data on a data type  # noqa: E501
