...
class DerivedTransactionPortfoliosApi(object):
    ...
    def create_derived_portfolio(self, scope, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_derived_portfolio_with_http_info(scope, **kwargs)  # noqa: E501
            return data
    ...
    def create_derived_portfolio_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `scope` when calling `create_derived_portfolio`")  # noqa: E501
    ...
    def delete_derived_portfolio_details(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param datetime effective_at: The effective date of the change
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_derived_portfolio_details_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def delete_derived_portfolio_details_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `delete_derived_portfolio_details`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `delete_derived_portfolio_details`")  # noqa: E501
