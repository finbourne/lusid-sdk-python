...
class RelationshipsApi(object):
    ...
    @validate_arguments
    def create_relationship_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope of the relationship")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The code of the relationship")], create_relationship_request : Annotated[CreateRelationshipRequest, Field(..., description="The details of the relationship to create.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] CreateRelationship: Create Relationship  # noqa: E501
        ...
        _body_params = None
        if _params['create_relationship_request']:
    ...
    @validate_arguments
    def delete_relationship_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope of the relationship")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The code of the relationship")], delete_relationship_request : Annotated[DeleteRelationshipRequest, Field(..., description="The details of the relationship to delete.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] DeleteRelationship: Delete Relationship  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['delete_relationship_request']:
