...
class ConventionsApi:
    ...
    @overload
    async def delete_cds_flow_conventions(self, scope : Annotated[StrictStr, Field(..., description="The scope of the CDS Flow Conventions to delete.")], code : Annotated[StrictStr, Field(..., description="The CDS Flow Conventions to delete.")], **kwargs) -> AnnulSingleStructuredDataResponse:  # noqa: E501
        ...

    @overload
    def delete_cds_flow_conventions(self, scope : Annotated[StrictStr, Field(..., description="The scope of the CDS Flow Conventions to delete.")], code : Annotated[StrictStr, Field(..., description="The CDS Flow Conventions to delete.")], async_req: Optional[bool]=True, **kwargs) -> AnnulSingleStructuredDataResponse:  # noqa: E501
        ...
    ...
    @overload
    async def delete_flow_conventions(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Flow Conventions to delete.")], code : Annotated[StrictStr, Field(..., description="The Flow Conventions to delete.")], **kwargs) -> AnnulSingleStructuredDataResponse:  # noqa: E501
        ...

    @overload
    def delete_flow_conventions(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Flow Conventions to delete.")], code : Annotated[StrictStr, Field(..., description="The Flow Conventions to delete.")], async_req: Optional[bool]=True, **kwargs) -> AnnulSingleStructuredDataResponse:  # noqa: E501
        ...
    ...
    @overload
    async def delete_index_convention(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Index Convention to delete.")], code : Annotated[StrictStr, Field(..., description="The Index Convention to delete.")], **kwargs) -> AnnulSingleStructuredDataResponse:  # noqa: E501
        ...

    @overload
    def delete_index_convention(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Index Convention to delete.")], code : Annotated[StrictStr, Field(..., description="The Index Convention to delete.")], async_req: Optional[bool]=True, **kwargs) -> AnnulSingleStructuredDataResponse:  # noqa: E501
        ...
    ...
    @overload
    async def get_index_convention(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Index Convention to retrieve.")], code : Annotated[StrictStr, Field(..., description="The name of the Index Convention to retrieve the data for.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the Index Convention. Defaults to return the latest version if not specified.")] = None, **kwargs) -> GetIndexConventionResponse:  # noqa: E501
        ...
