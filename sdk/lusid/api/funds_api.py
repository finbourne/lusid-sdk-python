...
class FundsApi:
    ...
    def get_valuation_point_journal_entry_lines(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], valuation_point_data_query_parameters : Annotated[ValuationPointDataQueryParameters, Field(description="The arguments to use for querying the Journal Entry Lines.")], general_ledger_profile_code : Annotated[Optional[StrictStr], Field( description="The optional code of a General Ledger Profile used to decorate Journal Entry Lines with levels.")] = None, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve Journal Entry Lines. Defaults to returning the latest version if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing Journal Entry Lines from a previous call to GetValuationPointJournalEntryLines.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the 'Instrument', 'Transaction', 'Portfolio', 'Account', 'LegalEntity' or 'CustodianAccount'               domain to decorate onto the Journal Entry Lines.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, bucket_set_code : Annotated[Optional[StrictStr], Field( description="When provided, each line's bucketMemberships report only this bucket set's classification of it.               Otherwise, every bucket set covering the NAV Type is reported.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ValuationPointResourceListOfFundJournalEntryLine, Awaitable[ValuationPointResourceListOfFundJournalEntryLine]]:  # noqa: E501
        ...
        >>> thread = api.get_valuation_point_journal_entry_lines(scope, code, valuation_point_data_query_parameters, general_ledger_profile_code, as_at, filter, limit, page, property_keys, nav_type_code, bucket_set_code, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_valuation_point_journal_entry_lines_with_http_info(scope, code, valuation_point_data_query_parameters, general_ledger_profile_code, as_at, filter, limit, page, property_keys, nav_type_code, bucket_set_code, **kwargs)  # noqa: E501
    ...
    def get_valuation_point_journal_entry_lines_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], valuation_point_data_query_parameters : Annotated[ValuationPointDataQueryParameters, Field(description="The arguments to use for querying the Journal Entry Lines.")], general_ledger_profile_code : Annotated[Optional[StrictStr], Field( description="The optional code of a General Ledger Profile used to decorate Journal Entry Lines with levels.")] = None, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve Journal Entry Lines. Defaults to returning the latest version if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing Journal Entry Lines from a previous call to GetValuationPointJournalEntryLines.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the 'Instrument', 'Transaction', 'Portfolio', 'Account', 'LegalEntity' or 'CustodianAccount'               domain to decorate onto the Journal Entry Lines.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, bucket_set_code : Annotated[Optional[StrictStr], Field( description="When provided, each line's bucketMemberships report only this bucket set's classification of it.               Otherwise, every bucket set covering the NAV Type is reported.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_valuation_point_journal_entry_lines_with_http_info(scope, code, valuation_point_data_query_parameters, general_ledger_profile_code, as_at, filter, limit, page, property_keys, nav_type_code, bucket_set_code, async_req=True)
        >>> result = thread.get()
    ...
    def get_valuation_point_quotes(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], valuation_point_data_query_parameters : Annotated[ValuationPointDataQueryParameters, Field(description="The arguments to use for querying the quotes.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve quotes. Defaults to returning the latest version              of each quote if not specified.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing quotes from a previous call to GetValuationPointQuotes.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ValuationPointResourceListOfAccountedQuote, Awaitable[ValuationPointResourceListOfAccountedQuote]]:  # noqa: E501
        ...
        >>> thread = api.get_valuation_point_quotes(scope, code, valuation_point_data_query_parameters, as_at, limit, page, nav_type_code, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_valuation_point_quotes_with_http_info(scope, code, valuation_point_data_query_parameters, as_at, limit, page, nav_type_code, **kwargs)  # noqa: E501
    ...
    def get_valuation_point_quotes_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], valuation_point_data_query_parameters : Annotated[ValuationPointDataQueryParameters, Field(description="The arguments to use for querying the quotes.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve quotes. Defaults to returning the latest version              of each quote if not specified.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing quotes from a previous call to GetValuationPointQuotes.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_valuation_point_quotes_with_http_info(scope, code, valuation_point_data_query_parameters, as_at, limit, page, nav_type_code, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/funds/{scope}/{code}/valuationpoints/quotes/$query', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_valuation_point_unsettled_transactions(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the report. Defaults to latest.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing from a previous call.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the 'Instrument', 'Transaction', 'Portfolio', or 'Account'              domain to decorate onto the transactions.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, var_date : Annotated[Optional[StrictStr], Field( description="The optional date of the Valuation Point to report against, as an alternative to supplying              it in the request body. Must not be supplied together with diaryEntry.")] = None, diary_entry : Annotated[Optional[StrictStr], Field( description="The optional diary entry code of the Valuation Point to report against, as an              alternative to supplying it in the request body. Must not be supplied together with date.")] = None, variant : Annotated[Optional[StrictStr], Field( description="The optional variant code of the Valuation Point to report against, as an alternative to              supplying it in the request body. Only required when it is necessary to choose between scenarios with multiple              estimates.")] = None, single_valuation_point_query_parameters : Annotated[Optional[SingleValuationPointQueryParameters], Field(description="The optional arguments to use for querying the unsettled transactions. Can be              omitted when the Valuation Point is identified by the date or diaryEntry query parameters.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ValuationPointResourceListOfUnsettledTransaction, Awaitable[ValuationPointResourceListOfUnsettledTransaction]]:  # noqa: E501
        ...
        >>> thread = api.get_valuation_point_unsettled_transactions(scope, code, as_at, limit, page, property_keys, nav_type_code, var_date, diary_entry, variant, single_valuation_point_query_parameters, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.get_valuation_point_unsettled_transactions_with_http_info(scope, code, as_at, limit, page, property_keys, nav_type_code, var_date, diary_entry, variant, single_valuation_point_query_parameters, **kwargs)  # noqa: E501
    ...
    def get_valuation_point_unsettled_transactions_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the report. Defaults to latest.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing from a previous call.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the 'Instrument', 'Transaction', 'Portfolio', or 'Account'              domain to decorate onto the transactions.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, var_date : Annotated[Optional[StrictStr], Field( description="The optional date of the Valuation Point to report against, as an alternative to supplying              it in the request body. Must not be supplied together with diaryEntry.")] = None, diary_entry : Annotated[Optional[StrictStr], Field( description="The optional diary entry code of the Valuation Point to report against, as an              alternative to supplying it in the request body. Must not be supplied together with date.")] = None, variant : Annotated[Optional[StrictStr], Field( description="The optional variant code of the Valuation Point to report against, as an alternative to              supplying it in the request body. Only required when it is necessary to choose between scenarios with multiple              estimates.")] = None, single_valuation_point_query_parameters : Annotated[Optional[SingleValuationPointQueryParameters], Field(description="The optional arguments to use for querying the unsettled transactions. Can be              omitted when the Valuation Point is identified by the date or diaryEntry query parameters.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_valuation_point_unsettled_transactions_with_http_info(scope, code, as_at, limit, page, property_keys, nav_type_code, var_date, diary_entry, variant, single_valuation_point_query_parameters, async_req=True)
        >>> result = thread.get()
    ...
    @overload
    async def list_fund_calendar_entries(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to list the Calendar. Defaults to returning the latest version of each Calendar Entry if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing Calendar Entries; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the results to this number. Defaults to 100 if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the results. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.")] = None, sort_by : Annotated[Optional[List[StrictStr]], Field(description="A list of field names or properties to sort by, each suffixed by \" ASC\" or \" DESC\".")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the 'DiaryEntry' domain to decorate onto each item.")] = None, **kwargs) -> PagedResourceListOfFundCalendarEntries:  # noqa: E501
        ...

    @overload
    def list_fund_calendar_entries(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to list the Calendar. Defaults to returning the latest version of each Calendar Entry if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing Calendar Entries; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the results to this number. Defaults to 100 if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the results. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.")] = None, sort_by : Annotated[Optional[List[StrictStr]], Field(description="A list of field names or properties to sort by, each suffixed by \" ASC\" or \" DESC\".")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the 'DiaryEntry' domain to decorate onto each item.")] = None, async_req: Optional[bool]=True, **kwargs) -> PagedResourceListOfFundCalendarEntries:  # noqa: E501
        ...

    @validate_arguments
    def list_fund_calendar_entries(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to list the Calendar. Defaults to returning the latest version of each Calendar Entry if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing Calendar Entries; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the results to this number. Defaults to 100 if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the results. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.")] = None, sort_by : Annotated[Optional[List[StrictStr]], Field(description="A list of field names or properties to sort by, each suffixed by \" ASC\" or \" DESC\".")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the 'DiaryEntry' domain to decorate onto each item.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[PagedResourceListOfFundCalendarEntries, Awaitable[PagedResourceListOfFundCalendarEntries]]:  # noqa: E501
    ...
    @overload
    def list_valuation_point_complex_market_data(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], valuation_point_data_query_parameters : Annotated[ValuationPointDataQueryParameters, Field(description="The arguments to use for querying the complex market data.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve complex market data. Defaults to returning the latest version              of each item if not specified.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing complex market data from a previous call to ListValuationPointComplexMarketData.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, async_req: Optional[bool]=True, **kwargs) -> ValuationPointResourceListOfAccountedComplexMarketData:  # noqa: E501
        ...
    ...
    def list_valuation_point_complex_market_data(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], valuation_point_data_query_parameters : Annotated[ValuationPointDataQueryParameters, Field(description="The arguments to use for querying the complex market data.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve complex market data. Defaults to returning the latest version              of each item if not specified.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing complex market data from a previous call to ListValuationPointComplexMarketData.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ValuationPointResourceListOfAccountedComplexMarketData, Awaitable[ValuationPointResourceListOfAccountedComplexMarketData]]:  # noqa: E501
        ...
        >>> thread = api.list_valuation_point_complex_market_data(scope, code, valuation_point_data_query_parameters, as_at, limit, page, nav_type_code, async_req=True)
        >>> result = thread.get()
        ...
        :param code: The code of the Fund. Together with the scope this uniquely identifies the Fund. (required)
        :type code: str
        :param valuation_point_data_query_parameters: The arguments to use for querying the complex market data. (required)
        :type valuation_point_data_query_parameters: ValuationPointDataQueryParameters
        :param as_at: The asAt datetime at which to retrieve complex market data. Defaults to returning the latest version              of each item if not specified.
        :type as_at: datetime
        :param limit: When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.
        :type limit: int
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ValuationPointResourceListOfAccountedComplexMarketData
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_valuation_point_complex_market_data_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.list_valuation_point_complex_market_data_with_http_info(scope, code, valuation_point_data_query_parameters, as_at, limit, page, nav_type_code, **kwargs)  # noqa: E501
    ...
    def list_valuation_point_complex_market_data_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], valuation_point_data_query_parameters : Annotated[ValuationPointDataQueryParameters, Field(description="The arguments to use for querying the complex market data.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve complex market data. Defaults to returning the latest version              of each item if not specified.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing complex market data from a previous call to ListValuationPointComplexMarketData.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.list_valuation_point_complex_market_data_with_http_info(scope, code, valuation_point_data_query_parameters, as_at, limit, page, nav_type_code, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ValuationPointResourceListOfAccountedComplexMarketData, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_valuation_point_complex_market_data" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ValuationPointResourceListOfAccountedComplexMarketData",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/funds/{scope}/{code}/valuationpoints/complexmarketdata/$query', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def query_cash_statement(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], query_fund_cash_statement_parameters : Annotated[QueryFundCashStatementParameters, Field(description="The query parameters specifying the diary entry period and display mode.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the cash statement. Defaults to the latest version if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to get the next page of results.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys to decorate onto the cash statement rows.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="The code of the NAV type to use. Defaults to the primary NAV type if not specified.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ValuationPointResourceListOfFundCashStatementRow, Awaitable[ValuationPointResourceListOfFundCashStatementRow]]:  # noqa: E501
        """[DEPRECATED] QueryCashStatement: [DEPRECATED] QueryCashStatement: Query cash statement for a Fund valuation point.  # noqa: E501
    ...
    @overload
    async def query_cash_statement_local_currency(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], query_fund_cash_statement_parameters : Annotated[QueryFundCashStatementParameters, Field(description="The query parameters specifying the diary entry period and display mode.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the cash statement. Defaults to the latest version if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to get the next page of results.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys to decorate onto the cash statement rows.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="The code of the NAV type to use. Defaults to the primary NAV type if not specified.")] = None, **kwargs) -> ValuationPointResourceListOfFundCashStatementLocalCurrency:  # noqa: E501
        ...

    @overload
    def query_cash_statement_local_currency(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], query_fund_cash_statement_parameters : Annotated[QueryFundCashStatementParameters, Field(description="The query parameters specifying the diary entry period and display mode.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the cash statement. Defaults to the latest version if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to get the next page of results.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys to decorate onto the cash statement rows.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="The code of the NAV type to use. Defaults to the primary NAV type if not specified.")] = None, async_req: Optional[bool]=True, **kwargs) -> ValuationPointResourceListOfFundCashStatementLocalCurrency:  # noqa: E501
        ...
    ...
    def query_cash_statement_local_currency(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], query_fund_cash_statement_parameters : Annotated[QueryFundCashStatementParameters, Field(description="The query parameters specifying the diary entry period and display mode.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the cash statement. Defaults to the latest version if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to get the next page of results.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys to decorate onto the cash statement rows.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="The code of the NAV type to use. Defaults to the primary NAV type if not specified.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ValuationPointResourceListOfFundCashStatementLocalCurrency, Awaitable[ValuationPointResourceListOfFundCashStatementLocalCurrency]]:  # noqa: E501
        ...
        >>> thread = api.query_cash_statement_local_currency(scope, code, query_fund_cash_statement_parameters, as_at, filter, limit, page, property_keys, nav_type_code, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ValuationPointResourceListOfFundCashStatementLocalCurrency
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the query_cash_statement_local_currency_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.query_cash_statement_local_currency_with_http_info(scope, code, query_fund_cash_statement_parameters, as_at, filter, limit, page, property_keys, nav_type_code, **kwargs)  # noqa: E501
    ...
    def query_cash_statement_local_currency_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the Fund.")], code : Annotated[StrictStr, Field(..., description="The code of the Fund. Together with the scope this uniquely identifies the Fund.")], query_fund_cash_statement_parameters : Annotated[QueryFundCashStatementParameters, Field(description="The query parameters specifying the diary entry period and display mode.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the cash statement. Defaults to the latest version if not specified.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many. Defaults to 100 if not specified.")] = None, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to get the next page of results.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys to decorate onto the cash statement rows.")] = None, nav_type_code : Annotated[Optional[StrictStr], Field( description="The code of the NAV type to use. Defaults to the primary NAV type if not specified.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.query_cash_statement_local_currency_with_http_info(scope, code, query_fund_cash_statement_parameters, as_at, filter, limit, page, property_keys, nav_type_code, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ValuationPointResourceListOfFundCashStatementLocalCurrency, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_cash_statement_local_currency" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ValuationPointResourceListOfFundCashStatementLocalCurrency",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/funds/{scope}/{code}/valuationpoints/cashstatementlocalcurrency/$query', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
