...
class AnalyticsStoresApi(object):
    ...
    def create_analytic_store(self, **kwargs):  # noqa: E501
        ...
        :param CreateAnalyticStoreRequest request: A populated analytic store definition
    ...
    def delete_analytic_store_with_http_info(self, scope, year, month, day, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `scope` when calling `delete_analytic_store`")  # noqa: E501
        # verify the required parameter 'year' is set
        if ('year' not in local_var_params or
                local_var_params['year'] is None):
            raise ApiValueError("Missing the required parameter `year` when calling `delete_analytic_store`")  # noqa: E501
        # verify the required parameter 'month' is set
        if ('month' not in local_var_params or
                local_var_params['month'] is None):
            raise ApiValueError("Missing the required parameter `month` when calling `delete_analytic_store`")  # noqa: E501
        # verify the required parameter 'day' is set
        if ('day' not in local_var_params or
                local_var_params['day'] is None):
            raise ApiValueError("Missing the required parameter `day` when calling `delete_analytic_store`")  # noqa: E501
    ...
    def get_analytic_store_with_http_info(self, scope, year, month, day, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ApiValueError("Missing the required parameter `scope` when calling `get_analytic_store`")  # noqa: E501
        # verify the required parameter 'year' is set
        if ('year' not in local_var_params or
                local_var_params['year'] is None):
            raise ApiValueError("Missing the required parameter `year` when calling `get_analytic_store`")  # noqa: E501
        # verify the required parameter 'month' is set
        if ('month' not in local_var_params or
                local_var_params['month'] is None):
            raise ApiValueError("Missing the required parameter `month` when calling `get_analytic_store`")  # noqa: E501
        # verify the required parameter 'day' is set
        if ('day' not in local_var_params or
                local_var_params['day'] is None):
            raise ApiValueError("Missing the required parameter `day` when calling `get_analytic_store`")  # noqa: E501
    ...
    def set_analytics(self, scope, year, month, day, **kwargs):  # noqa: E501
        ...
        :param list[InstrumentAnalytic] data: The analytic data being inserted
        :return: AnalyticStore
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_analytics_with_http_info(self, scope, year, month, day, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'year', 'month', 'day', 'data']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ApiValueError("Missing the required parameter `scope` when calling `set_analytics`")  # noqa: E501
        # verify the required parameter 'year' is set
        if ('year' not in local_var_params or
                local_var_params['year'] is None):
            raise ApiValueError("Missing the required parameter `year` when calling `set_analytics`")  # noqa: E501
        # verify the required parameter 'month' is set
        if ('month' not in local_var_params or
                local_var_params['month'] is None):
            raise ApiValueError("Missing the required parameter `month` when calling `set_analytics`")  # noqa: E501
        # verify the required parameter 'day' is set
        if ('day' not in local_var_params or
                local_var_params['day'] is None):
            raise ApiValueError("Missing the required parameter `day` when calling `set_analytics`")  # noqa: E501
