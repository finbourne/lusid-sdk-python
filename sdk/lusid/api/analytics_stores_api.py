...
class AnalyticsStoresApi(object):
    ...
    def create_analytic_store(self, **kwargs):  # noqa: E501
        """Create analytic store  # noqa: E501

        Create a new analytic store for the specified scope and date  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_analytic_store(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateAnalyticStoreRequest create_analytic_store_request: A populated analytic store definition
        ...
        if kwargs.get('async_req'):
            return self.create_analytic_store_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.create_analytic_store_with_http_info(**kwargs)  # noqa: E501
            return data

    def create_analytic_store_with_http_info(self, **kwargs):  # noqa: E501
        """Create analytic store  # noqa: E501

        Create a new analytic store for the specified scope and date  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_analytic_store_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['create_analytic_store_request']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_analytic_store" % key
                )
        ...
        body_params = None
        if 'create_analytic_store_request' in local_var_params:
            body_params = local_var_params['create_analytic_store_request']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='AnalyticStore',  # noqa: E501
    ...
    def delete_analytic_store(self, scope, year, month, day, **kwargs):  # noqa: E501
        """Delete analytic store  # noqa: E501

        Delete stored analytic data in the specified scope for the specified date  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_analytic_store(scope, year, month, day, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str scope: The analytics data scope (required)
        :param int year: The year component of the date (required)
        :param int month: The month component of the date (required)
        :param int day: The day component of the date (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_analytic_store_with_http_info(scope, year, month, day, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_analytic_store_with_http_info(scope, year, month, day, **kwargs)  # noqa: E501
            return data

    def delete_analytic_store_with_http_info(self, scope, year, month, day, **kwargs):  # noqa: E501
        """Delete analytic store  # noqa: E501

        Delete stored analytic data in the specified scope for the specified date  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_analytic_store_with_http_info(scope, year, month, day, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'year', 'month', 'day']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytic_store" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if ('scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `scope` when calling `delete_analytic_store`")  # noqa: E501
        # verify the required parameter 'year' is set
        if ('year' not in local_var_params or
                local_var_params['year'] is None):
            raise ValueError("Missing the required parameter `year` when calling `delete_analytic_store`")  # noqa: E501
        # verify the required parameter 'month' is set
        if ('month' not in local_var_params or
                local_var_params['month'] is None):
            raise ValueError("Missing the required parameter `month` when calling `delete_analytic_store`")  # noqa: E501
        # verify the required parameter 'day' is set
        if ('day' not in local_var_params or
                local_var_params['day'] is None):
            raise ValueError("Missing the required parameter `day` when calling `delete_analytic_store`")  # noqa: E501
        ...
        if 'day' in local_var_params:
            path_params['day'] = local_var_params['day']  # noqa: E501
    ...
    def get_analytic_store(self, scope, year, month, day, **kwargs):  # noqa: E501
        """Get analytic store  # noqa: E501

        Get the meta data associated with a specified scope and date combination (analytic store)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_analytic_store(scope, year, month, day, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str scope: The analytics data scope (required)
        :param int year: The year component of the date for the data in the scope (required)
        :param int month: The month component of the date for the data in the scope (required)
        :param int day: The day component of the date for the data in the scope (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_analytic_store_with_http_info(scope, year, month, day, **kwargs)  # noqa: E501
        else:
            (data) = self.get_analytic_store_with_http_info(scope, year, month, day, **kwargs)  # noqa: E501
            return data

    def get_analytic_store_with_http_info(self, scope, year, month, day, **kwargs):  # noqa: E501
        """Get analytic store  # noqa: E501

        Get the meta data associated with a specified scope and date combination (analytic store)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_analytic_store_with_http_info(scope, year, month, day, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'year', 'month', 'day', 'as_at']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytic_store" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'scope' is set
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_analytic_store`")  # noqa: E501
        # verify the required parameter 'year' is set
        if ('year' not in local_var_params or
                local_var_params['year'] is None):
            raise ValueError("Missing the required parameter `year` when calling `get_analytic_store`")  # noqa: E501
        # verify the required parameter 'month' is set
        if ('month' not in local_var_params or
                local_var_params['month'] is None):
            raise ValueError("Missing the required parameter `month` when calling `get_analytic_store`")  # noqa: E501
        # verify the required parameter 'day' is set
        if ('day' not in local_var_params or
                local_var_params['day'] is None):
            raise ValueError("Missing the required parameter `day` when calling `get_analytic_store`")  # noqa: E501
    ...
    def list_analytic_stores(self, **kwargs):  # noqa: E501
        """List analytic stores  # noqa: E501

        List all defined analytic stores  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_analytic_stores(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_analytic_stores_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_analytic_stores_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_analytic_stores_with_http_info(self, **kwargs):  # noqa: E501
        """List analytic stores  # noqa: E501

        List all defined analytic stores  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_analytic_stores_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_analytic_stores" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResourceListOfAnalyticStoreKey',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def set_analytics(self, scope, year, month, day, **kwargs):  # noqa: E501
        """Set analytic data  # noqa: E501

        Store the complete set of analytics for an existing analytic store for the specified scope and date  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_analytics(scope, year, month, day, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str scope: The scope of the data being stored (required)
        :param int year: The year component of the date for the data (required)
        :param int month: The month component of the date for the data (required)
        :param int day: The day component of the date for the data (required)
        :param list[InstrumentAnalytic] instrument_analytic: The analytic data being inserted
        :return: AnalyticStore
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_analytics_with_http_info(scope, year, month, day, **kwargs)  # noqa: E501
        else:
            (data) = self.set_analytics_with_http_info(scope, year, month, day, **kwargs)  # noqa: E501
            return data

    def set_analytics_with_http_info(self, scope, year, month, day, **kwargs):  # noqa: E501
        """Set analytic data  # noqa: E501

        Store the complete set of analytics for an existing analytic store for the specified scope and date  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_analytics_with_http_info(scope, year, month, day, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'year', 'month', 'day', 'instrument_analytic']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `set_analytics`")  # noqa: E501
        # verify the required parameter 'year' is set
        if ('year' not in local_var_params or
                local_var_params['year'] is None):
            raise ValueError("Missing the required parameter `year` when calling `set_analytics`")  # noqa: E501
        # verify the required parameter 'month' is set
        if ('month' not in local_var_params or
                local_var_params['month'] is None):
            raise ValueError("Missing the required parameter `month` when calling `set_analytics`")  # noqa: E501
        # verify the required parameter 'day' is set
        if ('day' not in local_var_params or
                local_var_params['day'] is None):
            raise ValueError("Missing the required parameter `day` when calling `set_analytics`")  # noqa: E501
        ...
        body_params = None
        if 'instrument_analytic' in local_var_params:
            body_params = local_var_params['instrument_analytic']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
