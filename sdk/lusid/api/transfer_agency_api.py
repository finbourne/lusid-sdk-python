...
class TransferAgencyApi:
    ...
    @overload
    async def delete_transfer_agency_orders(self, request_body : Annotated[Dict[str, DeleteTransferAgencyOrderRequest], Field(description="The transfer agency orders to delete, keyed by a unique request identifier.")], **kwargs) -> DeleteTransferAgencyOrdersResponse:  # noqa: E501
        ...

    @overload
    def delete_transfer_agency_orders(self, request_body : Annotated[Dict[str, DeleteTransferAgencyOrderRequest], Field(description="The transfer agency orders to delete, keyed by a unique request identifier.")], async_req: Optional[bool]=True, **kwargs) -> DeleteTransferAgencyOrdersResponse:  # noqa: E501
        ...

    @validate_arguments
    def delete_transfer_agency_orders(self, request_body : Annotated[Dict[str, DeleteTransferAgencyOrderRequest], Field(description="The transfer agency orders to delete, keyed by a unique request identifier.")], async_req: Optional[bool]=None, **kwargs) -> Union[DeleteTransferAgencyOrdersResponse, Awaitable[DeleteTransferAgencyOrdersResponse]]:  # noqa: E501
        """[EXPERIMENTAL] DeleteTransferAgencyOrders: Delete transfer agency orders  # noqa: E501

        Deletes each order supplied, cancelling any cash transaction(s) already booked for it. Only an order in  'New' or 'Pending' can be deleted. A priced order must be un-priced first. An order with no cash transaction  booked against it is deleted successfully and reports no cancelled transactions. Transaction staging rules are not applied to these  cancellations.  The response contains both successfully deleted orders and any failures, each in the form of a  dictionary keyed by the request's keys. For each failure, a reason is provided. It is important to  check the failed set for unsuccessful results.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_transfer_agency_orders(request_body, async_req=True)
        >>> result = thread.get()

        :param request_body: The transfer agency orders to delete, keyed by a unique request identifier. (required)
        :type request_body: Dict[str, DeleteTransferAgencyOrderRequest]
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: Timeout setting. Do not use - use the opts parameter instead
        :param opts: Configuration options for this request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: DeleteTransferAgencyOrdersResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_transfer_agency_orders_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.delete_transfer_agency_orders_with_http_info(request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_transfer_agency_orders_with_http_info(self, request_body : Annotated[Dict[str, DeleteTransferAgencyOrderRequest], Field(description="The transfer agency orders to delete, keyed by a unique request identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] DeleteTransferAgencyOrders: Delete transfer agency orders  # noqa: E501
        ...
        >>> thread = api.delete_transfer_agency_orders_with_http_info(request_body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DeleteTransferAgencyOrdersResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_transfer_agency_orders" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "DeleteTransferAgencyOrdersResponse",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/transferagency/orders/$delete', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def estimate_transfer_agency_orders(self, request_body : Annotated[Dict[str, EstimateTransferAgencyOrderRequest], Field(description="The transfer agency orders to estimate, keyed by a unique request identifier.")], **kwargs) -> EstimateTransferAgencyOrdersResponse:  # noqa: E501
        ...

    @overload
    def estimate_transfer_agency_orders(self, request_body : Annotated[Dict[str, EstimateTransferAgencyOrderRequest], Field(description="The transfer agency orders to estimate, keyed by a unique request identifier.")], async_req: Optional[bool]=True, **kwargs) -> EstimateTransferAgencyOrdersResponse:  # noqa: E501
        ...

    @validate_arguments
    def estimate_transfer_agency_orders(self, request_body : Annotated[Dict[str, EstimateTransferAgencyOrderRequest], Field(description="The transfer agency orders to estimate, keyed by a unique request identifier.")], async_req: Optional[bool]=None, **kwargs) -> Union[EstimateTransferAgencyOrdersResponse, Awaitable[EstimateTransferAgencyOrdersResponse]]:  # noqa: E501
        ...
        >>> thread = api.estimate_transfer_agency_orders(request_body, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.estimate_transfer_agency_orders_with_http_info(request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def estimate_transfer_agency_orders_with_http_info(self, request_body : Annotated[Dict[str, EstimateTransferAgencyOrderRequest], Field(description="The transfer agency orders to estimate, keyed by a unique request identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] EstimateTransferAgencyOrders: Estimate the values of transfer agency orders  # noqa: E501
        ...
        >>> thread = api.estimate_transfer_agency_orders_with_http_info(request_body, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/transferagency/orders/$estimate', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def upsert_transfer_agency_orders(self, request_body : Annotated[Dict[str, UpsertTransferAgencyOrderRequest], Field(description="The transfer agency orders to upsert, keyed by a unique request identifier.")], **kwargs) -> TransferAgencyOrdersResponse:  # noqa: E501
        ...

    @overload
    def upsert_transfer_agency_orders(self, request_body : Annotated[Dict[str, UpsertTransferAgencyOrderRequest], Field(description="The transfer agency orders to upsert, keyed by a unique request identifier.")], async_req: Optional[bool]=True, **kwargs) -> TransferAgencyOrdersResponse:  # noqa: E501
        ...

    @validate_arguments
    def upsert_transfer_agency_orders(self, request_body : Annotated[Dict[str, UpsertTransferAgencyOrderRequest], Field(description="The transfer agency orders to upsert, keyed by a unique request identifier.")], async_req: Optional[bool]=None, **kwargs) -> Union[TransferAgencyOrdersResponse, Awaitable[TransferAgencyOrdersResponse]]:  # noqa: E501
        ...
        >>> thread = api.upsert_transfer_agency_orders(request_body, async_req=True)
        >>> result = thread.get()

        :param request_body: The transfer agency orders to upsert, keyed by a unique request identifier. (required)
        :type request_body: Dict[str, UpsertTransferAgencyOrderRequest]
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: Timeout setting. Do not use - use the opts parameter instead
        :param opts: Configuration options for this request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: TransferAgencyOrdersResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the upsert_transfer_agency_orders_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.upsert_transfer_agency_orders_with_http_info(request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def upsert_transfer_agency_orders_with_http_info(self, request_body : Annotated[Dict[str, UpsertTransferAgencyOrderRequest], Field(description="The transfer agency orders to upsert, keyed by a unique request identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] UpsertTransferAgencyOrders: Upsert transfer agency orders  # noqa: E501
        ...
        >>> thread = api.upsert_transfer_agency_orders_with_http_info(request_body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TransferAgencyOrdersResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upsert_transfer_agency_orders" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "TransferAgencyOrdersResponse",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/transferagency/orders', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
