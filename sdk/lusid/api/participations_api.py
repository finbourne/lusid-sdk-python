...
class ParticipationsApi:
    ...
    @overload
    async def get_participation(self, scope : Annotated[StrictStr, Field(..., description="The scope to which the participation belongs.")], code : Annotated[StrictStr, Field(..., description="The participation's unique identifier.")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the participation. Defaults to return the latest version of the participation if not specified.")] = None, property_keys : Annotated[Optional[List[StrictStr]], Field(description="A list of property keys from the \"Participation\" domain to decorate onto the participation.              These take the format {domain}/{scope}/{code} e.g. \"Participation/system/Name\".")] = None, **kwargs) -> Participation:  # noqa: E501
        ...
