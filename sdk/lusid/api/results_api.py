...
class ResultsApi(object):
    ...
    def get_results_with_http_info(self, entity_scope, entity_code, calculation_scope, calculation_code, effective_at, **kwargs):  # noqa: E501
        ...
        if ('entity_scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `entity_scope` when calling `get_results`")  # noqa: E501
        ...
        if ('entity_code' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `entity_code` when calling `get_results`")  # noqa: E501
        ...
        if ('calculation_scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `calculation_scope` when calling `get_results`")  # noqa: E501
        ...
        if ('calculation_code' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `calculation_code` when calling `get_results`")  # noqa: E501
        ...
        if ('effective_at' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `effective_at` when calling `get_results`")  # noqa: E501
