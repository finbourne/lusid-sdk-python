...
class ResultsApi(object):
    ...
    def get_results(self, scope, key, date, **kwargs):  # noqa: E501
        """Get results  # noqa: E501

        Retrieve some previously stored results  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_results(scope, key, date, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str scope: The scope of the data (required)
        :param str key: The key that identifies the data (required)
        :param datetime date: The date for which the data was loaded (required)
        ...
        if kwargs.get('async_req'):
            return self.get_results_with_http_info(scope, key, date, **kwargs)  # noqa: E501
        else:
            (data) = self.get_results_with_http_info(scope, key, date, **kwargs)  # noqa: E501
            return data

    def get_results_with_http_info(self, scope, key, date, **kwargs):  # noqa: E501
        """Get results  # noqa: E501

        Retrieve some previously stored results  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_results_with_http_info(scope, key, date, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'key', 'date', 'as_at', 'sort_by', 'start', 'limit']  # noqa: E501
        ...
        if ('scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `scope` when calling `get_results`")  # noqa: E501
        # verify the required parameter 'key' is set
        if ('key' not in local_var_params or
                local_var_params['key'] is None):
            raise ValueError("Missing the required parameter `key` when calling `get_results`")  # noqa: E501
        # verify the required parameter 'date' is set
        if ('date' not in local_var_params or
                local_var_params['date'] is None):
            raise ValueError("Missing the required parameter `date` when calling `get_results`")  # noqa: E501
    ...
    def upsert_results(self, scope, key, date, **kwargs):  # noqa: E501
        """Upsert results  # noqa: E501

        Upsert pre-calculated results against a specified scope/key/date combination  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_results(scope, key, date, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str scope: The scope of the data (required)
        :param str key: The key that identifies the data (required)
        :param datetime date: The date for which the data is relevant (required)
        :param CreateResults create_results: The results to upload
        :return: Results
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.upsert_results_with_http_info(scope, key, date, **kwargs)  # noqa: E501
        else:
            (data) = self.upsert_results_with_http_info(scope, key, date, **kwargs)  # noqa: E501
            return data

    def upsert_results_with_http_info(self, scope, key, date, **kwargs):  # noqa: E501
        """Upsert results  # noqa: E501

        Upsert pre-calculated results against a specified scope/key/date combination  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_results_with_http_info(scope, key, date, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'key', 'date', 'create_results']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `upsert_results`")  # noqa: E501
        # verify the required parameter 'key' is set
        if ('key' not in local_var_params or
                local_var_params['key'] is None):
            raise ValueError("Missing the required parameter `key` when calling `upsert_results`")  # noqa: E501
        # verify the required parameter 'date' is set
        if ('date' not in local_var_params or
                local_var_params['date'] is None):
            raise ValueError("Missing the required parameter `date` when calling `upsert_results`")  # noqa: E501
