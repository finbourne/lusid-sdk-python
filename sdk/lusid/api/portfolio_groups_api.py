...
class PortfolioGroupsApi(object):
    ...
    def delete_group_properties_with_http_info(self, scope, code, request_body, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_group_properties`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_group_properties`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_group_properties`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def delete_portfolio_from_group_with_http_info(self, scope, code, portfolio_scope, portfolio_code, **kwargs):  # noqa: E501
        ...
        if ('portfolio_scope' in local_var_params and
                len(local_var_params['portfolio_scope']) > 64):
        ...
        if ('portfolio_scope' in local_var_params and
                len(local_var_params['portfolio_scope']) < 1):
        ...
        if 'portfolio_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['portfolio_scope']):  # noqa: E501
        ...
        if ('portfolio_code' in local_var_params and
                len(local_var_params['portfolio_code']) > 64):
        ...
        if ('portfolio_code' in local_var_params and
                len(local_var_params['portfolio_code']) < 1):
        ...
        if 'portfolio_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['portfolio_code']):  # noqa: E501
    ...
    def delete_sub_group_from_group_with_http_info(self, scope, code, subgroup_scope, subgroup_code, **kwargs):  # noqa: E501
        ...
        if ('subgroup_scope' in local_var_params and
                len(local_var_params['subgroup_scope']) > 64):
            raise ApiValueError("Invalid value for parameter `subgroup_scope` when calling `delete_sub_group_from_group`, length must be less than or equal to `64`")  # noqa: E501
        if ('subgroup_scope' in local_var_params and
                len(local_var_params['subgroup_scope']) < 1):
            raise ApiValueError("Invalid value for parameter `subgroup_scope` when calling `delete_sub_group_from_group`, length must be greater than or equal to `1`")  # noqa: E501
        if 'subgroup_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['subgroup_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `subgroup_scope` when calling `delete_sub_group_from_group`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('subgroup_code' in local_var_params and
                len(local_var_params['subgroup_code']) > 64):
            raise ApiValueError("Invalid value for parameter `subgroup_code` when calling `delete_sub_group_from_group`, length must be less than or equal to `64`")  # noqa: E501
        if ('subgroup_code' in local_var_params and
                len(local_var_params['subgroup_code']) < 1):
            raise ApiValueError("Invalid value for parameter `subgroup_code` when calling `delete_sub_group_from_group`, length must be greater than or equal to `1`")  # noqa: E501
        if 'subgroup_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['subgroup_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `subgroup_code` when calling `delete_sub_group_from_group`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_group_properties_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_group_properties`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_group_properties`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_group_properties`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_group_commands_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('filter' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_portfolio_group_commands`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_portfolio_group_commands`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def list_portfolio_groups_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        if ('filter' in local_var_params and
                len(local_var_params['filter']) > 2147483647):
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_portfolio_groups`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) < 0):
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_portfolio_groups`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
