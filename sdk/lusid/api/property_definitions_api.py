...
class PropertyDefinitionsApi(object):
    ...
    def create_property_definition(self, **kwargs):  # noqa: E501
        ...
        :param CreatePropertyDefinitionRequest create_property_definition_request: The definition of the new property
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_property_definition_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def delete_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_property_definition_with_http_info(domain, scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def delete_property_definition_with_http_info(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        if ('domain' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `domain` when calling `delete_property_definition`")  # noqa: E501
        # verify the required parameter 'scope' is set
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `delete_property_definition`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `delete_property_definition`")  # noqa: E501
    ...
    def get_multiple_property_definitions(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_multiple_property_definitions_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_property_definition_with_http_info(domain, scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def get_property_definition_with_http_info(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        if ('domain' not in local_var_params or
                local_var_params['domain'] is None):
            raise ValueError("Missing the required parameter `domain` when calling `get_property_definition`")  # noqa: E501
        # verify the required parameter 'scope' is set
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_property_definition`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_property_definition`")  # noqa: E501
    ...
    def update_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        :param UpdatePropertyDefinitionRequest update_property_definition_request: The updated definition of the property
        :return: PropertyDefinition
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_property_definition_with_http_info(domain, scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def update_property_definition_with_http_info(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        if ('domain' not in local_var_params or
                local_var_params['domain'] is None):
            raise ValueError("Missing the required parameter `domain` when calling `update_property_definition`")  # noqa: E501
        # verify the required parameter 'scope' is set
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `update_property_definition`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `update_property_definition`")  # noqa: E501
