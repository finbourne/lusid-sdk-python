...
class LegacyComplianceApi:
    ...
    @overload
    async def delete_legacy_compliance_rule(self, scope : Annotated[StrictStr, Field(..., description="The compliance rule scope.")], code : Annotated[StrictStr, Field(..., description="The compliance rule code.")], **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @overload
    def delete_legacy_compliance_rule(self, scope : Annotated[StrictStr, Field(..., description="The compliance rule scope.")], code : Annotated[StrictStr, Field(..., description="The compliance rule code.")], async_req: Optional[bool]=True, **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...
    ...
    @validate_arguments
    def get_legacy_breached_orders_info_with_http_info(self, run_id : Annotated[StrictStr, Field(..., description="The RunId that the results should be checked for")], order_scope : Annotated[Optional[StrictStr], Field( description="Optional. Find rules related to a specific order by providing an Order Scope/Code combination")] = None, order_code : Annotated[Optional[StrictStr], Field( description="Optional. Find rules related to a specific order by providing an Order Scope/Code combination")] = None, limit : Annotated[Optional[conint(strict=True, le=5000, ge=1)], Field(description="When paginating, limit the number of returned results to this many.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetLegacyBreachedOrdersInfo: Get the Ids of Breached orders in a given compliance run and the corresponding list of rules that could have caused it.  # noqa: E501
