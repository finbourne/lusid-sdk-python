...
class RelationshipDefinitionsApi(object):
    ...
    @validate_arguments
    def create_relationship_definition_with_http_info(self, create_relationship_definition_request : Annotated[CreateRelationshipDefinitionRequest, Field(..., description="The definition of the new relationship.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] CreateRelationshipDefinition: Create Relationship Definition  # noqa: E501
        ...
        _body_params = None
        if _params['create_relationship_definition_request']:
    ...
    @validate_arguments
    def delete_relationship_definition_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope of the relationship definition to be deleted.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The code of the relationship definition to be deleted. Together with the domain and scope this uniquely              identifies the relationship.")], **kwargs):  # noqa: E501
        """[EARLY ACCESS] DeleteRelationshipDefinition: Delete Relationship Definition  # noqa: E501
    ...
    def update_relationship_definition_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope of the relationship definition being updated.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The code of the relationship definition being updated. Together with the scope this uniquely              identifies the relationship definition.")], update_relationship_definition_request : Annotated[UpdateRelationshipDefinitionRequest, Field(..., description="The details of relationship definition to update.")], **kwargs):  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['update_relationship_definition_request']:
