...
class OrderInstructionsApi(object):
    ...
    @validate_arguments
    def delete_order_instruction_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The orderInstruction scope.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The orderInstruction's code. This, together with the scope uniquely identifies the orderInstruction to delete.")], **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteOrderInstruction: Delete orderInstruction  # noqa: E501
    ...
    @validate_arguments
    def upsert_order_instructions_with_http_info(self, order_instruction_set_request : Annotated[Optional[OrderInstructionSetRequest], Field(description="The collection of orderInstruction requests.")] = None, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] UpsertOrderInstructions: Upsert OrderInstruction  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['order_instruction_set_request']:
