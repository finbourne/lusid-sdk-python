...
class ReferencePortfolioApi(object):
    ...
    def create_reference_portfolio(self, scope, **kwargs):  # noqa: E501
        ...
        :param CreateReferencePortfolioRequest create_reference_portfolio_request: The portfolio creation request object
        :return: Portfolio
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_reference_portfolio_with_http_info(scope, **kwargs)  # noqa: E501
            return data
    ...
    def create_reference_portfolio_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `scope` when calling `create_reference_portfolio`")  # noqa: E501
    ...
    def get_reference_portfolio_constituents(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param datetime effective_at: Optional. The effective date of the constituents to retrieve
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_reference_portfolio_constituents_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def get_reference_portfolio_constituents_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `get_reference_portfolio_constituents`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_reference_portfolio_constituents`")  # noqa: E501
    ...
    def list_constituents_adjustments(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param datetime from_effective_at: Events between this time (inclusive) and the toEffectiveAt are returned.
        :param datetime to_effective_at: Events between this time (inclusive) and the fromEffectiveAt are returned.
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_constituents_adjustments_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def list_constituents_adjustments_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `list_constituents_adjustments`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `list_constituents_adjustments`")  # noqa: E501
    ...
    def upsert_reference_portfolio_constituents(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param UpsertReferencePortfolioConstituentsRequest upsert_reference_portfolio_constituents_request: The constituents to upload to the portfolio
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.upsert_reference_portfolio_constituents_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def upsert_reference_portfolio_constituents_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ValueError("Missing the required parameter `scope` when calling `upsert_reference_portfolio_constituents`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `upsert_reference_portfolio_constituents`")  # noqa: E501
