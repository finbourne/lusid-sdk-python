...
class ReferencePortfolioApi(object):
    ...
    @validate_arguments
    def create_reference_portfolio_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope in which to create the reference portfolio.")], create_reference_portfolio_request : Annotated[CreateReferencePortfolioRequest, Field(..., description="The definition of the reference portfolio.")], **kwargs):  # noqa: E501
        """CreateReferencePortfolio: Create reference portfolio  # noqa: E501
        ...
        _body_params = None
        if _params['create_reference_portfolio_request']:
    ...
    @validate_arguments
    def upsert_reference_portfolio_constituents_with_http_info(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope of the reference portfolio.")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The code of the reference portfolio. Together with the scope this uniquely identifies              the reference portfolio.")], upsert_reference_portfolio_constituents_request : Annotated[UpsertReferencePortfolioConstituentsRequest, Field(..., description="The constituents to upload to the reference portfolio.")], **kwargs):  # noqa: E501
        """UpsertReferencePortfolioConstituents: Upsert reference portfolio constituents  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['upsert_reference_portfolio_constituents_request']:
