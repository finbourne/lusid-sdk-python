...
class ReferencePortfolioApi:
    ...
    @overload
    async def delete_reference_portfolio_constituent_adjustment(self, scope : Annotated[StrictStr, Field(..., description="The scope of the reference portfolio.")], code : Annotated[StrictStr, Field(..., description="The code of the reference portfolio. Together with the scope this uniquely              identifies the reference portfolio.")], effective_at : Annotated[StrictStr, Field(..., description="The effective datetime or cut label at which the constituents adjustment was made.")], **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @overload
    def delete_reference_portfolio_constituent_adjustment(self, scope : Annotated[StrictStr, Field(..., description="The scope of the reference portfolio.")], code : Annotated[StrictStr, Field(..., description="The code of the reference portfolio. Together with the scope this uniquely              identifies the reference portfolio.")], effective_at : Annotated[StrictStr, Field(..., description="The effective datetime or cut label at which the constituents adjustment was made.")], async_req: Optional[bool]=True, **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @validate_arguments
    def delete_reference_portfolio_constituent_adjustment(self, scope : Annotated[StrictStr, Field(..., description="The scope of the reference portfolio.")], code : Annotated[StrictStr, Field(..., description="The code of the reference portfolio. Together with the scope this uniquely              identifies the reference portfolio.")], effective_at : Annotated[StrictStr, Field(..., description="The effective datetime or cut label at which the constituents adjustment was made.")], async_req: Optional[bool]=None, **kwargs) -> Union[DeletedEntityResponse, Awaitable[DeletedEntityResponse]]:  # noqa: E501
        """DeleteReferencePortfolioConstituentAdjustment: Delete constituents adjustment  # noqa: E501

        Delete the constituents adjustment made to a reference portfolio at the specified effective  datetime. After deletion the constituents in effect revert to the previous effective-dated  adjustment, or to none if there is no earlier adjustment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_reference_portfolio_constituent_adjustment(scope, code, effective_at, async_req=True)
        >>> result = thread.get()
        ...
        :type code: str
        :param effective_at: The effective datetime or cut label at which the constituents adjustment was made. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_reference_portfolio_constituent_adjustment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.delete_reference_portfolio_constituent_adjustment_with_http_info(scope, code, effective_at, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_reference_portfolio_constituent_adjustment_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The scope of the reference portfolio.")], code : Annotated[StrictStr, Field(..., description="The code of the reference portfolio. Together with the scope this uniquely              identifies the reference portfolio.")], effective_at : Annotated[StrictStr, Field(..., description="The effective datetime or cut label at which the constituents adjustment was made.")], **kwargs) -> ApiResponse:  # noqa: E501
        """DeleteReferencePortfolioConstituentAdjustment: Delete constituents adjustment  # noqa: E501
        ...
        >>> thread = api.delete_reference_portfolio_constituent_adjustment_with_http_info(scope, code, effective_at, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_reference_portfolio_constituent_adjustment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/referenceportfolios/{scope}/{code}/constituentsadjustment', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
