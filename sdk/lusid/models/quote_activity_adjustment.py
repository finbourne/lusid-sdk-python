...
class QuoteActivityAdjustment(NavActivityAdjustmentResponse):
    """
    ...
    def nav_activity_adjustment_type_validate_enum(cls, value):
        ...
        if 'QuoteActivityAdjustment' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QuoteActivityAdjustment:
        """Create an instance of QuoteActivityAdjustment from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QuoteActivityAdjustment:
        """Create an instance of QuoteActivityAdjustment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QuoteActivityAdjustment.parse_obj(obj)

        _obj = QuoteActivityAdjustment.parse_obj({
...
QuoteActivityAdjustment.update_forward_refs()
