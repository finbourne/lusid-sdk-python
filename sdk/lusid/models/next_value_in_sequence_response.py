...
class NextValueInSequenceResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NextValueInSequenceResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NextValueInSequenceResponse:
        """Create an instance of NextValueInSequenceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NextValueInSequenceResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in NextValueInSequenceResponse) in the input: " + obj)

        _obj = NextValueInSequenceResponse.parse_obj({
