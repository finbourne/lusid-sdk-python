...
class BoolListComplianceParameter(ComplianceParameter):
    """
    ...
    def compliance_parameter_type_validate_enum(cls, value):
        ...
        if 'BoolListComplianceParameter' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BoolListComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BoolListComplianceParameter:
        """Create an instance of BoolListComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BoolListComplianceParameter.parse_obj(obj)

        _obj = BoolListComplianceParameter.parse_obj({
...
BoolListComplianceParameter.update_forward_refs()
