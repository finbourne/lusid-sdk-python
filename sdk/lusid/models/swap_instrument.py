...
class SwapInstrument(object):
    ...
    def __init__(self, start_date=None, maturity_date=None, legs=None, notional=None, is_amortizing=None, notional_exchange_type=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        """
    ...
    def is_amortizing(self, is_amortizing):
        ...
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and is_amortizing is None:  # noqa: E501
    ...
    def notional_exchange_type(self, notional_exchange_type):
        ...
        if self.local_vars_configuration.client_side_validation and notional_exchange_type not in allowed_values:  # noqa: E501
            raise ValueError(
