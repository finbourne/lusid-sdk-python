...
class PreferredShareAllOfIdentifiers(BaseModel):
    """
    External market codes and identifiers for the share, e.g. its ISIN. A series is mastered once  per distinct security and shared across every holder.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreferredShareAllOfIdentifiers:
        """Create an instance of PreferredShareAllOfIdentifiers from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreferredShareAllOfIdentifiers:
        """Create an instance of PreferredShareAllOfIdentifiers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreferredShareAllOfIdentifiers.parse_obj(obj)

        _obj = PreferredShareAllOfIdentifiers.parse_obj({
...
PreferredShareAllOfIdentifiers.update_forward_refs()
