...
class TransactionQueryParameters(object):
    ...
    def start_date(self):
        ...
        The required set of transactions should begin from this date  # noqa: E501
    ...
    def end_date(self):
        ...
        The required set of transactions should end at this date  # noqa: E501
    ...
    def query_mode(self):
        ...
        The method for date selection. Trade date or Settlement date  # noqa: E501
    ...
    def show_cancelled_transactions(self):
        ...
        Option to include cancelled transactions in the results  # noqa: E501
