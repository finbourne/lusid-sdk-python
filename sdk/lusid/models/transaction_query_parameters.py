...
class TransactionQueryParameters(object):
    ...
    def start_date(self):
        ...
        The lower bound effective datetime (inclusive) from which to build the transactions.  # noqa: E501
    ...
    def end_date(self):
        ...
        The upper bound effective datetime (inclusive) from which to retrieve transactions.  # noqa: E501
    ...
    def query_mode(self):
        ...
        The date to compare against the upper and lower bounds for the effective datetime. Defaults to 'TradeDate' if not specified.  # noqa: E501
