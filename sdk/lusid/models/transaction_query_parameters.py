...
class TransactionQueryParameters(object):
    ...
    def __init__(self, start_date=None, end_date=None, query_mode=None, show_cancelled_transactions=None):  # noqa: E501
        """TransactionQueryParameters - a model defined in OpenAPI"""  # noqa: E501
    ...
    def start_date(self):
        ...
        The lower bound effectiveAt datetime (inclusive) from which to build the transactions.  # noqa: E501
    ...
    def end_date(self):
        ...
        The upper bound effectiveAt datetime (inclusive) from which to retrieve transactions.  # noqa: E501
    ...
    def query_mode(self):
        ...
        The date to compare against the upper and lower bounds for the effectiveAt datetime. Defaults to 'TradeDate' if not specified.  # noqa: E501
    ...
    def query_mode(self, query_mode):
        ...
        :type: str
        """
        allowed_values = ["None", "TradeDate", "SettleDate"]  # noqa: E501
