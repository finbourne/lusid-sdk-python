...
class ValuationPointEntity(BaseModel):
    """
    ...
    prevailing_valuation_point: Optional[FundCalendarEntry] = Field(default=None, alias="prevailingValuationPoint")
    deleted_valuation_point: Optional[FundCalendarEntry] = Field(default=None, alias="deletedValuationPoint")
    ...
    previewed_valuation_point: Optional[FundCalendarEntry] = Field(default=None, alias="previewedValuationPoint")
    links: Optional[List[Link]] = None
    __properties = ["href", "entityUniqueId", "asAtVersionNumber", "status", "asAtDeleted", "userIdDeleted", "requestIdDeleted", "effectiveAtCreated", "prevailingValuationPoint", "deletedValuationPoint", "previewedStatus", "previewedValuationPoint", "links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValuationPointEntity:
        """Create an instance of ValuationPointEntity from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of prevailing_valuation_point
        if self.prevailing_valuation_point:
            _dict['prevailingValuationPoint'] = self.prevailing_valuation_point.to_dict()
        # override the default output from pydantic by calling `to_dict()` of deleted_valuation_point
        if self.deleted_valuation_point:
            _dict['deletedValuationPoint'] = self.deleted_valuation_point.to_dict()
        # override the default output from pydantic by calling `to_dict()` of previewed_valuation_point
        if self.previewed_valuation_point:
            _dict['previewedValuationPoint'] = self.previewed_valuation_point.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValuationPointEntity:
        """Create an instance of ValuationPointEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValuationPointEntity.parse_obj(obj)

        _obj = ValuationPointEntity.parse_obj({
            "href": obj.get("href"),
            ...
            "prevailing_valuation_point": FundCalendarEntry.from_dict(obj.get("prevailingValuationPoint")) if obj.get("prevailingValuationPoint") is not None else None,
            "deleted_valuation_point": FundCalendarEntry.from_dict(obj.get("deletedValuationPoint")) if obj.get("deletedValuationPoint") is not None else None,
            "previewed_status": obj.get("previewedStatus"),
            "previewed_valuation_point": FundCalendarEntry.from_dict(obj.get("previewedValuationPoint")) if obj.get("previewedValuationPoint") is not None else None,
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

ValuationPointEntity.update_forward_refs()
