...
class SimpleInstrumentAllOf(BaseModel):
    """
    ...
    __properties = ["maturityDate", "domCcy", "assetClass", "fgnCcys", "simpleInstrumentType", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimpleInstrumentAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimpleInstrumentAllOf:
        """Create an instance of SimpleInstrumentAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimpleInstrumentAllOf.parse_obj(obj)

        _obj = SimpleInstrumentAllOf.parse_obj({
