...
class ResetEventAllOf(BaseModel):
    """
    ResetEventAllOf
    """
    ...
    __properties = ["value", "resetType", "fixingSource", "eventStatus", "fixingDate", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResetEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResetEventAllOf:
        """Create an instance of ResetEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResetEventAllOf.parse_obj(obj)

        _obj = ResetEventAllOf.parse_obj({
            "value": obj.get("value"),
