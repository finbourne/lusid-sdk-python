...
class VendorDependencyAllOf(BaseModel):
    """
    ...
    __properties = ["vendorName", "vendorPath", "date", "dependencyType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VendorDependencyAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VendorDependencyAllOf:
        """Create an instance of VendorDependencyAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VendorDependencyAllOf.parse_obj(obj)

        _obj = VendorDependencyAllOf.parse_obj({
