...
class ForwardRateAgreementAllOf(BaseModel):
    """
    ...
    __properties = ["startDate", "maturityDate", "domCcy", "fixingDate", "fraRate", "notional", "indexConvention", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ForwardRateAgreementAllOf:
        """Create an instance of ForwardRateAgreementAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ForwardRateAgreementAllOf:
        """Create an instance of ForwardRateAgreementAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ForwardRateAgreementAllOf.parse_obj(obj)

        _obj = ForwardRateAgreementAllOf.parse_obj({
