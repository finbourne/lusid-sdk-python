...
class NavType(BaseModel):
    ...
    code:  Optional[StrictStr] = Field(None,alias="code", description="The Code for the Nav Type. Must be unique within the Fund.") 
    display_name:  Optional[StrictStr] = Field(None,alias="displayName", description="The Display Name for the Nav Type. Must be unique within the Fund.") 
    description:  Optional[StrictStr] = Field(None,alias="description", description="The Description for the Nav Type.") 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NavType:
        """Create an instance of NavType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NavType:
        """Create an instance of NavType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NavType.parse_obj(obj)

        _obj = NavType.parse_obj({
            ...
            "settlement_configuration": NavSettlementConfiguration.from_dict(obj.get("settlementConfiguration")) if obj.get("settlementConfiguration") is not None else None,
