...
class FxForwardTenorCurveDataAllOf(BaseModel):
    """
    ...
    __properties = ["baseDate", "domCcy", "fgnCcy", "tenors", "rates", "lineage", "marketDataOptions", "calendars", "spotDaysCalculationType", "marketDataType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FxForwardTenorCurveDataAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FxForwardTenorCurveDataAllOf:
        """Create an instance of FxForwardTenorCurveDataAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FxForwardTenorCurveDataAllOf.parse_obj(obj)

        _obj = FxForwardTenorCurveDataAllOf.parse_obj({
