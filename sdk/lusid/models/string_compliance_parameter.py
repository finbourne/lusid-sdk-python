...
class StringComplianceParameter(ComplianceParameter):
    """
    ...
    def compliance_parameter_type_validate_enum(cls, value):
        ...
        if 'StringComplianceParameter' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StringComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StringComplianceParameter:
        """Create an instance of StringComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StringComplianceParameter.parse_obj(obj)

        _obj = StringComplianceParameter.parse_obj({
...
StringComplianceParameter.update_forward_refs()
