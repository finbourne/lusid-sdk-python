...
class GetInstrumentsResponse(object):
    ...
    def values(self):
        ...
        The instruments, keyed by their requested identifier. Only instruments that were found  will be contained in this collection.  # noqa: E501
    ...
    def failed(self):
        ...
        If any instruments were not found, then they will be listed in as 'Failed', along with the nature  of their failure.  # noqa: E501
