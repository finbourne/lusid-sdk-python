...
class GetInstrumentsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetInstrumentsResponse:
        ...
        _obj = GetInstrumentsResponse.parse_obj({
            "href": obj.get("href"),
            "values": {k: None if v is None else {ik: Instrument.from_dict(iv) for ik, iv in v.items()} for k, v in obj.get("values").items()} if obj.get("values") is not None else None,
