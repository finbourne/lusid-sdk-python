...
class ValuationPointResourceListOfUnsettledTransaction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfUnsettledTransaction:
        ...
        if not isinstance(obj, dict):
            return ValuationPointResourceListOfUnsettledTransaction.parse_obj(obj)

        _obj = ValuationPointResourceListOfUnsettledTransaction.parse_obj({
            ...
            "values": [UnsettledTransaction.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfUnsettledTransaction.update_forward_refs()
