...
class LoanFacility(LusidInstrument):
    ...
    initial_commitment: Union[StrictFloat, StrictInt] = Field(description="The initial commitment for the loan facility.", alias="initialCommitment")
...
LoanFacility.update_forward_refs()
