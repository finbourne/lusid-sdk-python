...
class ResourceListOfAccessControlledResource(object):
    ...
    @property
    def count(self):
        """Gets the count of this ResourceListOfAccessControlledResource.  # noqa: E501

        The total number of items (when available)  # noqa: E501

        :return: The count of this ResourceListOfAccessControlledResource.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this ResourceListOfAccessControlledResource.

        The total number of items (when available)  # noqa: E501

        :param count: The count of this ResourceListOfAccessControlledResource.  # noqa: E501
        :type: int
        """
