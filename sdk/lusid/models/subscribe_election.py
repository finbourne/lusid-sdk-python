...
class SubscribeElection(BaseModel):
    """
    Subscribe (opt-in) election. The inverse of a LapseElection: a chosen SubscribeElection signals that the  holder elects to participate in (subscribe to) the event.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscribeElection:
        """Create an instance of SubscribeElection from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscribeElection:
        """Create an instance of SubscribeElection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscribeElection.parse_obj(obj)

        _obj = SubscribeElection.parse_obj({
...
SubscribeElection.update_forward_refs()
