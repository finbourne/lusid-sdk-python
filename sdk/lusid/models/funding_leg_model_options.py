...
class FundingLegModelOptions(ModelOptions):
    """
    ...
    def model_options_type_validate_enum(cls, value):
        ...
        if 'FundingLegModelOptions' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FundingLegModelOptions:
        """Create an instance of FundingLegModelOptions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FundingLegModelOptions:
        """Create an instance of FundingLegModelOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FundingLegModelOptions.parse_obj(obj)

        _obj = FundingLegModelOptions.parse_obj({
...
FundingLegModelOptions.update_forward_refs()
