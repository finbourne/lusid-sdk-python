...
class ResultValueCurrencyAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultValueCurrencyAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultValueCurrencyAllOf:
        """Create an instance of ResultValueCurrencyAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultValueCurrencyAllOf.parse_obj(obj)

        _obj = ResultValueCurrencyAllOf.parse_obj({
            "value": obj.get("value"),
