...
class CreatePortfolioGroupRequest(object):
    ...
    def __init__(self, id=None, values=None, sub_groups=None, display_name=None, description=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this CreatePortfolioGroupRequest.  # noqa: E501


        :return: The id of this CreatePortfolioGroupRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CreatePortfolioGroupRequest.


        :param id: The id of this CreatePortfolioGroupRequest.  # noqa: E501
        :type: str
        """
        if id is None:
