...
class CreditSpreadShiftDefinition(ScenarioShiftDefinition):
    ...
    ccy:  Optional[StrictStr] = Field(None,alias="ccy", description="The currency the curve is quoted in; disambiguates a ticker quoted in more than one  currency. Omitted, the shift matches the ticker in every currency.") 
    ...
    __properties = ["scenarioShiftType", "ticker", "ccy", "amount", "startTenor", "endTenor", "shiftType", "scale", "pivotTenor", "minimumAmountBps", "applyWhenValue"]
    ...
    def from_dict(cls, obj: dict) -> CreditSpreadShiftDefinition:
        ...
        if not isinstance(obj, dict):
            return CreditSpreadShiftDefinition.parse_obj(obj)

        _obj = CreditSpreadShiftDefinition.parse_obj({
...
CreditSpreadShiftDefinition.update_forward_refs()
