...
class CreditDefaultSwapAllOf(BaseModel):
    """
    ...
    __properties = ["ticker", "startDate", "maturityDate", "flowConventions", "couponRate", "conventionName", "notional", "protectionDetailSpecification", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditDefaultSwapAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditDefaultSwapAllOf:
        """Create an instance of CreditDefaultSwapAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditDefaultSwapAllOf.parse_obj(obj)

        _obj = CreditDefaultSwapAllOf.parse_obj({
