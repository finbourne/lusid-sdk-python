...
class DecimalComplianceParameter(ComplianceParameter):
    ...
    def compliance_parameter_type_validate_enum(cls, value):
        ...
        if 'DecimalComplianceParameter' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecimalComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecimalComplianceParameter:
        """Create an instance of DecimalComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecimalComplianceParameter.parse_obj(obj)
...
DecimalComplianceParameter.update_forward_refs()
