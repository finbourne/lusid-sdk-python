...
class LifeCycleEventValueAllOf(BaseModel):
    """
    ...
    __properties = ["effectiveDate", "eventValues", "eventLineage", "resultValueType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifeCycleEventValueAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LifeCycleEventValueAllOf:
        """Create an instance of LifeCycleEventValueAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifeCycleEventValueAllOf.parse_obj(obj)

        _obj = LifeCycleEventValueAllOf.parse_obj({
