...
class MarketDataKeyRule(object):
    ...
    def __init__(self, key=None, supplier=None, data_scope=None, quote_type=None, field=None, quote_interval=None, as_at=None, local_vars_configuration=None):  # noqa: E501
        """
        ...
        :type data_scope: str
        :param quote_type:  Is the quote to be looked for a price, yield etc. (required)
        :type quote_type: str
