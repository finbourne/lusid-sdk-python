...
class LusidValidationProblemDetails(object):
    ...
    def __init__(self, name=None, error_details=None, code=None, errors=None, type=None, title=None, status=None, detail=None, instance=None):  # noqa: E501
        """LusidValidationProblemDetails - a model defined in OpenAPI"""  # noqa: E501
