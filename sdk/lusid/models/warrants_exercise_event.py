...
class WarrantsExerciseEvent(InstrumentEvent):
    ...
    __properties = ["instrumentEventType", "paymentDate", "periodOfActionStart", "periodOfActionEnd", "responseDeadlineDate", "marketDeadlineDate", "earlyResponseDeadline", "strikePerUnit", "strikeCurrency", "unitsRatio", "newInstrument", "fractionDisposition", "optionExerciseElections", "lapseElections", "unknownProceedsElections"]
