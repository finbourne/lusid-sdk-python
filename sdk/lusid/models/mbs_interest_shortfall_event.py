...
class MbsInterestShortfallEvent(InstrumentEvent):
    ...
    payment_date: Optional[datetime] = Field(default=None, description="The payment date of the interest", alias="paymentDate")
    currency:  StrictStr = Field(...,alias="currency", description="The currency in which the interest amount is notated") 
    interest_per_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount by which the coupon amount will fall short for each unit of the instrument held on the ex date", alias="interestPerUnit")
...
MbsInterestShortfallEvent.update_forward_refs()
