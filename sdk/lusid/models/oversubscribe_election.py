...
class OversubscribeElection(BaseModel):
    """
    Election to request more than the guaranteed entitlement (OVER).  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OversubscribeElection:
        """Create an instance of OversubscribeElection from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OversubscribeElection:
        """Create an instance of OversubscribeElection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OversubscribeElection.parse_obj(obj)

        _obj = OversubscribeElection.parse_obj({
...
OversubscribeElection.update_forward_refs()
