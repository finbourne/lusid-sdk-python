...
class FxSwapAllOf(BaseModel):
    ...
    __properties = ["nearFxForward", "farFxForward", "notionalSymmetry", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FxSwapAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FxSwapAllOf:
        """Create an instance of FxSwapAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FxSwapAllOf.parse_obj(obj)

        _obj = FxSwapAllOf.parse_obj({
