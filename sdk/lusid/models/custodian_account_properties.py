...
class CustodianAccountProperties(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustodianAccountProperties:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustodianAccountProperties:
        """Create an instance of CustodianAccountProperties from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustodianAccountProperties.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CustodianAccountProperties) in the input: " + obj)

        _obj = CustodianAccountProperties.parse_obj({
            "href": obj.get("href"),
