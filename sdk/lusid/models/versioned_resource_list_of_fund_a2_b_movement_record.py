...
class VersionedResourceListOfFundA2BMovementRecord(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> VersionedResourceListOfFundA2BMovementRecord:
        ...
        if not isinstance(obj, dict):
            return VersionedResourceListOfFundA2BMovementRecord.parse_obj(obj)

        _obj = VersionedResourceListOfFundA2BMovementRecord.parse_obj({
            "version": Version.from_dict(obj.get("version")) if obj.get("version") is not None else None,
            "values": [FundA2BMovementRecord.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
...
VersionedResourceListOfFundA2BMovementRecord.update_forward_refs()
