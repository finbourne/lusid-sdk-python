...
class ComplianceRuleEntity(BaseModel):
    ...
    __properties = ["href", "entityUniqueId", "asAtVersionNumber", "status", "asAtDeleted", "userIdDeleted", "requestIdDeleted", "effectiveAtCreated", "prevailingComplianceRule", "deletedComplianceRule", "previewedStatus", "previewedComplianceRule", "links"]
    ...
    def to_dict(self):
        ...
        if self.prevailing_compliance_rule:
            _dict['prevailingComplianceRule'] = self.prevailing_compliance_rule.to_dict()
        # override the default output from pydantic by calling `to_dict()` of deleted_compliance_rule
        if self.deleted_compliance_rule:
            _dict['deletedComplianceRule'] = self.deleted_compliance_rule.to_dict()
        ...
        if self.previewed_compliance_rule:
            _dict['previewedComplianceRule'] = self.previewed_compliance_rule.to_dict()
    ...
    def from_dict(cls, obj: dict) -> ComplianceRuleEntity:
        ...
        if not isinstance(obj, dict):
            return ComplianceRuleEntity.parse_obj(obj)

        _obj = ComplianceRuleEntity.parse_obj({
            "href": obj.get("href"),
            ...
            "prevailing_compliance_rule": ComplianceRuleResponse.from_dict(obj.get("prevailingComplianceRule")) if obj.get("prevailingComplianceRule") is not None else None,
            "deleted_compliance_rule": ComplianceRuleResponse.from_dict(obj.get("deletedComplianceRule")) if obj.get("deletedComplianceRule") is not None else None,
            "previewed_status": obj.get("previewedStatus"),
            "previewed_compliance_rule": ComplianceRuleResponse.from_dict(obj.get("previewedComplianceRule")) if obj.get("previewedComplianceRule") is not None else None,
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

ComplianceRuleEntity.update_forward_refs()
