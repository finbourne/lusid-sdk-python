...
class CashFlowValueSetAllOf(BaseModel):
    """
    ...
    __properties = ["cashflows", "resultValueType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashFlowValueSetAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashFlowValueSetAllOf:
        """Create an instance of CashFlowValueSetAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CashFlowValueSetAllOf.parse_obj(obj)

        _obj = CashFlowValueSetAllOf.parse_obj({
