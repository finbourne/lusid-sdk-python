...
class ResultDataKeyRuleAllOf(object):
    ...
    attribute_map = {
        ...
        'document_result_type': 'documentResultType',
    ...
    def __init__(self, supplier=None, data_scope=None, document_code=None, quote_interval=None, as_at=None, resource_key=None, document_result_type=None, result_key_rule_type=None, local_vars_configuration=None):  # noqa: E501
        """ResultDataKeyRuleAllOf - a model defined in OpenAPI"
        ...
        :param document_result_type:  (required)
        :type document_result_type: str
        ...
        self._document_result_type = None
        ...
        self.document_result_type = document_result_type
        self.result_key_rule_type = result_key_rule_type

    @property
    def supplier(self):
        """Gets the supplier of this ResultDataKeyRuleAllOf.  # noqa: E501

        the result resource supplier (where the data comes from)  # noqa: E501

        :return: The supplier of this ResultDataKeyRuleAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def supplier(self, supplier):
        """Sets the supplier of this ResultDataKeyRuleAllOf.

        the result resource supplier (where the data comes from)  # noqa: E501

        :param supplier: The supplier of this ResultDataKeyRuleAllOf.  # noqa: E501
        :type supplier: str
        """
    ...
    @property
    def data_scope(self):
        """Gets the data_scope of this ResultDataKeyRuleAllOf.  # noqa: E501

        which is the scope in which the data should be found  # noqa: E501

        :return: The data_scope of this ResultDataKeyRuleAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def data_scope(self, data_scope):
        """Sets the data_scope of this ResultDataKeyRuleAllOf.

        which is the scope in which the data should be found  # noqa: E501

        :param data_scope: The data_scope of this ResultDataKeyRuleAllOf.  # noqa: E501
        :type data_scope: str
        """
    ...
    def document_code(self):
        """Gets the document_code of this ResultDataKeyRuleAllOf.  # noqa: E501

        document code that defines which document is desired  # noqa: E501

        :return: The document_code of this ResultDataKeyRuleAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def document_code(self, document_code):
        """Sets the document_code of this ResultDataKeyRuleAllOf.

        document code that defines which document is desired  # noqa: E501

        :param document_code: The document_code of this ResultDataKeyRuleAllOf.  # noqa: E501
        :type document_code: str
        """
    ...
    def quote_interval(self):
        """Gets the quote_interval of this ResultDataKeyRuleAllOf.  # noqa: E501
        ...
        :return: The quote_interval of this ResultDataKeyRuleAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def quote_interval(self, quote_interval):
        """Sets the quote_interval of this ResultDataKeyRuleAllOf.

        Shorthand for the time interval used to select result data. This must be a dot-separated string              specifying a start and end date, for example '5D.0D' to look back 5 days from today (0 days ago).  # noqa: E501

        :param quote_interval: The quote_interval of this ResultDataKeyRuleAllOf.  # noqa: E501
        :type quote_interval: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def as_at(self):
        """Gets the as_at of this ResultDataKeyRuleAllOf.  # noqa: E501

        The AsAt predicate specification.  # noqa: E501

        :return: The as_at of this ResultDataKeyRuleAllOf.  # noqa: E501
        :rtype: datetime
        """
        return self._as_at
    ...
    def as_at(self, as_at):
        """Sets the as_at of this ResultDataKeyRuleAllOf.

        The AsAt predicate specification.  # noqa: E501

        :param as_at: The as_at of this ResultDataKeyRuleAllOf.  # noqa: E501
        :type as_at: datetime
        """
    ...
    def resource_key(self):
        """Gets the resource_key of this ResultDataKeyRuleAllOf.  # noqa: E501

        The result data key that identifies the address pattern that this is a rule for  # noqa: E501

        :return: The resource_key of this ResultDataKeyRuleAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_key(self, resource_key):
        """Sets the resource_key of this ResultDataKeyRuleAllOf.

        The result data key that identifies the address pattern that this is a rule for  # noqa: E501

        :param resource_key: The resource_key of this ResultDataKeyRuleAllOf.  # noqa: E501
        :type resource_key: str
        """
    ...
    @property
    def document_result_type(self):
        """Gets the document_result_type of this ResultDataKeyRuleAllOf.  # noqa: E501


        :return: The document_result_type of this ResultDataKeyRuleAllOf.  # noqa: E501
        :rtype: str
        """
        return self._document_result_type

    @document_result_type.setter
    def document_result_type(self, document_result_type):
        """Sets the document_result_type of this ResultDataKeyRuleAllOf.


        :param document_result_type: The document_result_type of this ResultDataKeyRuleAllOf.  # noqa: E501
        :type document_result_type: str
        """
        if self.local_vars_configuration.client_side_validation and document_result_type is None:  # noqa: E501
            raise ValueError("Invalid value for `document_result_type`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                document_result_type is not None and len(document_result_type) < 1):
            raise ValueError("Invalid value for `document_result_type`, length must be greater than or equal to `1`")  # noqa: E501

        self._document_result_type = document_result_type

    @property
    def result_key_rule_type(self):
        """Gets the result_key_rule_type of this ResultDataKeyRuleAllOf.  # noqa: E501

        The available values are: Invalid, ResultDataKeyRule, PortfolioResultDataKeyRule  # noqa: E501

        :return: The result_key_rule_type of this ResultDataKeyRuleAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def result_key_rule_type(self, result_key_rule_type):
        """Sets the result_key_rule_type of this ResultDataKeyRuleAllOf.

        The available values are: Invalid, ResultDataKeyRule, PortfolioResultDataKeyRule  # noqa: E501

        :param result_key_rule_type: The result_key_rule_type of this ResultDataKeyRuleAllOf.  # noqa: E501
        :type result_key_rule_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResultDataKeyRuleAllOf):
            return False
