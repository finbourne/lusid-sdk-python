...
class FundingLegOptionsAllOf(BaseModel):
    """
    ...
    __properties = ["expectedFundingLegNotional", "modelOptionsType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FundingLegOptionsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FundingLegOptionsAllOf:
        """Create an instance of FundingLegOptionsAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FundingLegOptionsAllOf.parse_obj(obj)

        _obj = FundingLegOptionsAllOf.parse_obj({
