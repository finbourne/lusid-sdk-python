...
class PagedResourceListOfVersion(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfVersion:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfVersion.parse_obj(obj)

        _obj = PagedResourceListOfVersion.parse_obj({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [Version.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

PagedResourceListOfVersion.update_forward_refs()
