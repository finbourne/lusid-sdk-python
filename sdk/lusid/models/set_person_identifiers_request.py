...
class SetPersonIdentifiersRequest(BaseModel):
    ...
    """
    identifiers: Optional[Dict[str, ModelProperty]] = Field(default=None, description="Identifiers to set for a Person. Identifiers not included in the request will not be amended.")
...
SetPersonIdentifiersRequest.update_forward_refs()
