...
class CompositeDispersionResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CompositeDispersionResponse:
        ...
        _obj = CompositeDispersionResponse.parse_obj({
            "href": obj.get("href"),
            "results": {k: None if v is None else {ik: List[CompositeDispersion].from_dict(iv) for ik, iv in v.items()} for k, v in obj.get("results").items()} if obj.get("results") is not None else None,
