...
class OrderFlowConfiguration(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderFlowConfiguration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderFlowConfiguration:
        """Create an instance of OrderFlowConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderFlowConfiguration.parse_obj(obj)

        _obj = OrderFlowConfiguration.parse_obj({
            "include_entity_types": obj.get("includeEntityTypes")
        })
        return _obj

OrderFlowConfiguration.update_forward_refs()
