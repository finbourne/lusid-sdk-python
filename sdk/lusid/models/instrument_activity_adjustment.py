...
class InstrumentActivityAdjustment(NavActivityAdjustmentResponse):
    """
    ...
    def nav_activity_adjustment_type_validate_enum(cls, value):
        ...
        if 'InstrumentActivityAdjustment' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstrumentActivityAdjustment:
        """Create an instance of InstrumentActivityAdjustment from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstrumentActivityAdjustment:
        """Create an instance of InstrumentActivityAdjustment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstrumentActivityAdjustment.parse_obj(obj)

        _obj = InstrumentActivityAdjustment.parse_obj({
...
InstrumentActivityAdjustment.update_forward_refs()
