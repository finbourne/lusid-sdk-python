...
class ComplexMarketDataId(BaseModel):
    ...
    market_asset: constr(strict=True, max_length=32, min_length=0) = Field(..., alias="marketAsset", description="The name of the market entity that the document represents")
    ...
    def from_dict(cls, obj: dict) -> ComplexMarketDataId:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ComplexMarketDataId) in the input: " + obj)
