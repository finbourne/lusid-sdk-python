...
class AggregatedReturnsRequest(object):
    ...
    def __init__(self, metrics=None, return_ids=None, recipe_id=None, composite_method=None, period=None, output_frequency=None, alternative_inception_date=None, holiday_calendars=None, currency=None, local_vars_configuration=None):  # noqa: E501
