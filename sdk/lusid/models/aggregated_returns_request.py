...
class AggregatedReturnsRequest(object):
    ...
    def __init__(self, metrics=None, return_ids=None, recipe_id=None, composite_method=None, period=None, output_frequency=None, alternative_inception_date=None, holiday_calendars=None, currency=None, run_mode=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type currency: str
        :param run_mode:  The RunMode the aggregation will calculate metrics for. Defaults to ReturnData.
        :type run_mode: str
    ...
    def run_mode(self):
        ...
        The RunMode the aggregation will calculate metrics for. Defaults to ReturnData.  # noqa: E501
