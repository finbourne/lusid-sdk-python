...
class AdjustHoldingRequest(object):
    ...
    def sub_holding_keys(self):
        ...
        Set of unique transaction properties and associated values to associate with the holding adjustment transaction automatically created by LUSID. Each property must be from the 'Trade' domain.  # noqa: E501
