...
class InterestRateSwapAllOf(BaseModel):
    """
    ...
    __properties = ["startDate", "maturityDate", "isNonDeliverable", "legs", "settlementCcy", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterestRateSwapAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterestRateSwapAllOf:
        """Create an instance of InterestRateSwapAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterestRateSwapAllOf.parse_obj(obj)

        _obj = InterestRateSwapAllOf.parse_obj({
