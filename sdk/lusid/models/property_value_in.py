...
class PropertyValueIn(MatchCriterion):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PropertyValueIn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PropertyValueIn:
        """Create an instance of PropertyValueIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PropertyValueIn.parse_obj(obj)

        _obj = PropertyValueIn.parse_obj({
