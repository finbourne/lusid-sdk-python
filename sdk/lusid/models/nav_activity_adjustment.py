...
class NavActivityAdjustment(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(ComplexMarketDataActivity, InstrumentActivity, PortfolioSettlementInstruction, PortfolioTransaction, QuoteActivity):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(ComplexMarketDataActivity, InstrumentActivity, PortfolioSettlementInstruction, PortfolioTransaction, QuoteActivity):
