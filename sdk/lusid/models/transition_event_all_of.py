...
class TransitionEventAllOf(BaseModel):
    """
    ...
    __properties = ["announcementDate", "exDate", "recordDate", "paymentDate", "inputTransition", "outputTransitions", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransitionEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransitionEventAllOf:
        """Create an instance of TransitionEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransitionEventAllOf.parse_obj(obj)

        _obj = TransitionEventAllOf.parse_obj({
