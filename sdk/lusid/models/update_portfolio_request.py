...
class UpdatePortfolioRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpdatePortfolioRequest:
        ...
        if not isinstance(obj, dict):
            return UpdatePortfolioRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpdatePortfolioRequest) in the input: " + obj)

        _obj = UpdatePortfolioRequest.parse_obj({
