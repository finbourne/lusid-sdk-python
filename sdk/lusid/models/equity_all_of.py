...
class EquityAllOf(BaseModel):
    ...
    __properties = ["identifiers", "domCcy", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EquityAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EquityAllOf:
        """Create an instance of EquityAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EquityAllOf.parse_obj(obj)

        _obj = EquityAllOf.parse_obj({
