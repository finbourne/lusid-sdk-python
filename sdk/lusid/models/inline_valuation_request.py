...
class InlineValuationRequest(BaseModel):
    ...
    __properties = ["recipeId", "asAt", "metrics", "groupBy", "filters", "sort", "reportCurrency", "equipWithSubtotals", "returnResultAsExpandedTypes", "valuationSchedule", "instruments", "marketDataOverrides"]
    ...
    def from_dict(cls, obj: dict) -> InlineValuationRequest:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InlineValuationRequest) in the input: " + obj)
