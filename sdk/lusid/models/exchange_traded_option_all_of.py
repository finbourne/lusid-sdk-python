...
class ExchangeTradedOptionAllOf(BaseModel):
    """
    ...
    __properties = ["startDate", "contractDetails", "contracts", "refSpotPrice", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExchangeTradedOptionAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExchangeTradedOptionAllOf:
        """Create an instance of ExchangeTradedOptionAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExchangeTradedOptionAllOf.parse_obj(obj)

        _obj = ExchangeTradedOptionAllOf.parse_obj({
