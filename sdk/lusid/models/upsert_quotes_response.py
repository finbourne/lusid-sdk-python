...
class UpsertQuotesResponse(BaseModel):
    ...
    values: Optional[Dict[str, Quote]] = Field(default=None, description="The quotes which have been successfully updated or inserted.")
    failed: Optional[Dict[str, ErrorDetail]] = Field(default=None, description="The quotes that could not be updated or inserted along with a reason for their failure.")
...
UpsertQuotesResponse.update_forward_refs()
