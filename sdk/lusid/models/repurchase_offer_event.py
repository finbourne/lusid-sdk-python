...
class RepurchaseOfferEvent(InstrumentEvent):
    ...
    cash_offer_elections: List[CashOfferElection] = Field(description="List of possible CashOfferElections for this event.    - The event requires at least one election of any type.    - Any number of CashOfferElections may be supplied.    - At most one election on the event may be the default, and at most one may be chosen.", alias="cashOfferElections")
    lapse_elections: List[LapseElection] = Field(description="List of possible LapseElections for this event. Allows the user to opt out of the offer.    - The event requires at least one election of any type.    - Any number of LapseElections may be supplied.    - At most one election on the event may be the default, and at most one may be chosen.", alias="lapseElections")
    tender_offer_elections: List[TenderOfferElection] = Field(description="List of possible TenderOfferElections for this event.    - The event requires at least one election of any type.    - Any number of TenderOfferElections may be supplied.    - At most one election on the event may be the default, and at most one may be chosen.", alias="tenderOfferElections")
    ...
    consent_and_tender_elections: Optional[List[ConsentAndTenderElection]] = Field(default=None, description="List of possible consent-and-tender elections for this event (CTEN) — tender the holding and grant consent together.    - The event requires at least one election of any type.    - Any number of ConsentAndTenderElections may be supplied.    - At most one election on the event may be the default, and at most one may be chosen.", alias="consentAndTenderElections")
    consent_granted_elections: Optional[List[ConsentGrantedElection]] = Field(default=None, description="List of possible consent-granted elections for this event (CONY) — vote in favour, optionally attracting a consent fee.    - The event requires at least one election of any type.    - Any number of ConsentGrantedElections may be supplied.    - At most one election on the event may be the default, and at most one may be chosen.", alias="consentGrantedElections")
    consent_denied_elections: Optional[List[ConsentDeniedElection]] = Field(default=None, description="List of possible consent-denied elections for this event (CONN) — vote against the proposal.    - The event requires at least one election of any type.    - Any number of ConsentDeniedElections may be supplied.    - At most one election on the event may be the default, and at most one may be chosen.", alias="consentDeniedElections")
    abstain_elections: Optional[List[AbstainElection]] = Field(default=None, description="List of possible abstain elections for this event (ABST) — decline to vote on the consent.    - The event requires at least one election of any type.    - Any number of AbstainElections may be supplied.    - At most one election on the event may be the default, and at most one may be chosen.", alias="abstainElections")
    unknown_proceeds_elections: Optional[List[UnknownProceedsElection]] = Field(default=None, description="List of possible unknown-proceeds elections for this event (UNKNOWN) — the outturn is not yet known.    - The event requires at least one election of any type.    - Any number of UnknownProceedsElections may be supplied.    - At most one election on the event may be the default, and at most one may be chosen.", alias="unknownProceedsElections")
    ...
    __properties = ["instrumentEventType", "paymentDate", "marketDeadlineDate", "repurchaseQuantity", "cashOfferElections", "lapseElections", "tenderOfferElections", "prorationRate", "responseDeadlineDate", "earlyResponseDeadline", "minPieceSize", "minIncrement", "accruedInterestPerUnit", "consentAndTenderElections", "consentGrantedElections", "consentDeniedElections", "abstainElections", "unknownProceedsElections"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.consent_granted_elections is None and "consent_granted_elections" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> RepurchaseOfferEvent:
        ...
        _obj = RepurchaseOfferEvent.parse_obj({
            ...
            "consent_granted_elections": [ConsentGrantedElection.from_dict(_item) for _item in obj.get("consentGrantedElections")] if obj.get("consentGrantedElections") is not None else None,
