...
class BondCouponEvent(InstrumentEvent):
    ...
    """
    ex_date: Optional[datetime] = Field(default=None, description="Ex-Dividend date of the coupon payment", alias="exDate")
    payment_date: Optional[datetime] = Field(default=None, description="Payment date of the coupon payment", alias="paymentDate")
    currency:  StrictStr = Field(...,alias="currency", description="Currency of the coupon payment") 
    coupon_per_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="CouponRate*Principal", alias="couponPerUnit")
...
BondCouponEvent.update_forward_refs()
