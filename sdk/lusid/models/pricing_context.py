...
class PricingContext(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> PricingContext:
        ...
        _obj = PricingContext.parse_obj({
            ...
            "model_choice": {k: None if v is None else {ik: ModelSelection.from_dict(iv) for ik, iv in v.items()} for k, v in obj.get("modelChoice").items()} if obj.get("modelChoice") is not None else None,
