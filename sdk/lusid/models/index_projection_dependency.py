...
class IndexProjectionDependency(object):
    ...
    def __init__(self, currency=None, tenor=None, index_name=None, date=None, dependency_type=None, local_vars_configuration=None):  # noqa: E501
        """IndexProjectionDependency - a model defined in OpenAPI"
    ...
    @property
    def currency(self):
        """Gets the currency of this IndexProjectionDependency.  # noqa: E501

        The currency of the corresponding IndexConvention. E.g. this would be USD for a convention named USD.6M.LIBOR  # noqa: E501

        :return: The currency of this IndexProjectionDependency.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this IndexProjectionDependency.

        The currency of the corresponding IndexConvention. E.g. this would be USD for a convention named USD.6M.LIBOR  # noqa: E501

        :param currency: The currency of this IndexProjectionDependency.  # noqa: E501
        :type currency: str
        """
    ...
    @property
    def tenor(self):
        """Gets the tenor of this IndexProjectionDependency.  # noqa: E501

        The tenor of the corresponding IndexConvention. E.g. this would be \"6M\" for a convention named USD.6M.LIBOR  # noqa: E501

        :return: The tenor of this IndexProjectionDependency.  # noqa: E501
        :rtype: str
        """
        return self._tenor
    ...
    def tenor(self, tenor):
        """Sets the tenor of this IndexProjectionDependency.

        The tenor of the corresponding IndexConvention. E.g. this would be \"6M\" for a convention named USD.6M.LIBOR  # noqa: E501

        :param tenor: The tenor of this IndexProjectionDependency.  # noqa: E501
        :type tenor: str
        """
    ...
    @property
    def index_name(self):
        """Gets the index_name of this IndexProjectionDependency.  # noqa: E501

        The IndexName of the corresponding IndexConvention. E.g. this would be \"LIBOR\" for a convention named USD.6M.LIBOR  # noqa: E501

        :return: The index_name of this IndexProjectionDependency.  # noqa: E501
        :rtype: str
        """
    ...
    def index_name(self, index_name):
        """Sets the index_name of this IndexProjectionDependency.

        The IndexName of the corresponding IndexConvention. E.g. this would be \"LIBOR\" for a convention named USD.6M.LIBOR  # noqa: E501

        :param index_name: The index_name of this IndexProjectionDependency.  # noqa: E501
        :type index_name: str
        """
    ...
    @property
    def date(self):
        """Gets the date of this IndexProjectionDependency.  # noqa: E501
        ...
        :return: The date of this IndexProjectionDependency.  # noqa: E501
        :rtype: datetime
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this IndexProjectionDependency.

        The effectiveDate of the entity that this is a dependency for.  Unless there is an obvious date this should be, like for a historic reset, then this is the valuation date.  # noqa: E501

        :param date: The date of this IndexProjectionDependency.  # noqa: E501
        :type date: datetime
        """
    ...
    def dependency_type(self):
        """Gets the dependency_type of this IndexProjectionDependency.  # noqa: E501
        ...
        :return: The dependency_type of this IndexProjectionDependency.  # noqa: E501
        :rtype: str
        """
    ...
    def dependency_type(self, dependency_type):
        """Sets the dependency_type of this IndexProjectionDependency.

        The available values are: OpaqueDependency, CashDependency, DiscountingDependency, EquityCurveDependency, EquityVolDependency, FxDependency, FxForwardsDependency, FxVolDependency, IndexProjectionDependency, IrVolDependency, QuoteDependency, Vendor  # noqa: E501

        :param dependency_type: The dependency_type of this IndexProjectionDependency.  # noqa: E501
        :type dependency_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IndexProjectionDependency):
            return False
