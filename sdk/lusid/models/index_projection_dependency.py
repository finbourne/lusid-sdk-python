...
class IndexProjectionDependency(EconomicDependency):
    ...
    def dependency_type_validate_enum(cls, value):
        ...
        if 'IndexProjectionDependency' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IndexProjectionDependency:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IndexProjectionDependency:
        """Create an instance of IndexProjectionDependency from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IndexProjectionDependency.parse_obj(obj)

        _obj = IndexProjectionDependency.parse_obj({
