...
class ValuationPointResourceListOfFundCashStatementRow(BaseModel):
    """
    ...
    version: Version
    values: List[FundCashStatementRow]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValuationPointResourceListOfFundCashStatementRow:
        """Create an instance of ValuationPointResourceListOfFundCashStatementRow from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfFundCashStatementRow:
        """Create an instance of ValuationPointResourceListOfFundCashStatementRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValuationPointResourceListOfFundCashStatementRow.parse_obj(obj)

        _obj = ValuationPointResourceListOfFundCashStatementRow.parse_obj({
            ...
            "values": [FundCashStatementRow.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfFundCashStatementRow.update_forward_refs()
