...
class AccountProperties(BaseModel):
    ...
    properties: Optional[Dict[str, ModelProperty]] = Field(default=None, description="The Account properties. These will be from the 'Account' domain.")
...
AccountProperties.update_forward_refs()
