...
class UpsertPortfolioGroupAccessMetadataRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpsertPortfolioGroupAccessMetadataRequest:
        ...
        if not isinstance(obj, dict):
            return UpsertPortfolioGroupAccessMetadataRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpsertPortfolioGroupAccessMetadataRequest) in the input: " + obj)

        _obj = UpsertPortfolioGroupAccessMetadataRequest.parse_obj({
