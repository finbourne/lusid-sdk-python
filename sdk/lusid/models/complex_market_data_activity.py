...
class ComplexMarketDataActivity(NavActivityAdjustment):
    """
    ...
    __properties = ["navActivityAdjustmentType", "asAt", "effectiveAt", "entityUniqueId"]
    ...
    def nav_activity_adjustment_type_validate_enum(cls, value):
        ...
        if 'ComplexMarketDataActivity' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ComplexMarketDataActivity:
        """Create an instance of ComplexMarketDataActivity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ComplexMarketDataActivity:
        """Create an instance of ComplexMarketDataActivity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ComplexMarketDataActivity.parse_obj(obj)

        _obj = ComplexMarketDataActivity.parse_obj({
...
ComplexMarketDataActivity.update_forward_refs()
