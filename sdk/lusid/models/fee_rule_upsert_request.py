...
class FeeRuleUpsertRequest(BaseModel):
    ...
    country: constr(strict=True, max_length=64, min_length=1) = ...
    counterparty: constr(strict=True, max_length=64, min_length=1) = ...
    ...
    custodian: constr(strict=True, max_length=64, min_length=1) = ...
    exchange: constr(strict=True, max_length=64, min_length=1) = ...
    fee: CalculationInfo = ...
