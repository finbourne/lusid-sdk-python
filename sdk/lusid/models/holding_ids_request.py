...
class HoldingIdsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HoldingIdsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HoldingIdsRequest:
        """Create an instance of HoldingIdsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HoldingIdsRequest.parse_obj(obj)

        _obj = HoldingIdsRequest.parse_obj({
