...
class TenderOfferElection(BaseModel):
    ...
    tender_offer_price: Union[StrictFloat, StrictInt] = Field(description="Price per share of the cash offer", alias="tenderOfferPrice")
...
TenderOfferElection.update_forward_refs()
