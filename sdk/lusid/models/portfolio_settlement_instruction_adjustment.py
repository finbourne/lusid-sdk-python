...
class PortfolioSettlementInstructionAdjustment(NavActivityAdjustmentResponse):
    ...
    __properties = ["navActivityAdjustmentType", "navActivityAdjustmentSource", "asAt", "portfolioScope", "portfolioCode", "settlementInstructionId"]
    ...
    def nav_activity_adjustment_type_validate_enum(cls, value):
        ...
        if 'PortfolioSettlementInstructionAdjustment' not in [ 
    ...
    def from_dict(cls, obj: dict) -> PortfolioSettlementInstructionAdjustment:
        ...
        if not isinstance(obj, dict):
            return PortfolioSettlementInstructionAdjustment.parse_obj(obj)

        _obj = PortfolioSettlementInstructionAdjustment.parse_obj({
...
PortfolioSettlementInstructionAdjustment.update_forward_refs()
