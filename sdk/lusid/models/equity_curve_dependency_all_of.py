...
class EquityCurveDependencyAllOf(object):
    ...
    def __init__(self, market_identifier=None, code=None, curve_type=None, date=None, dependency_type=None, local_vars_configuration=None):  # noqa: E501
        """EquityCurveDependencyAllOf - a model defined in OpenAPI"
    ...
    def market_identifier(self):
        """Gets the market_identifier of this EquityCurveDependencyAllOf.  # noqa: E501

        Type of the code identifying the corresponding equity, e.g. ISIN or CUSIP  # noqa: E501

        :return: The market_identifier of this EquityCurveDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def market_identifier(self, market_identifier):
        """Sets the market_identifier of this EquityCurveDependencyAllOf.

        Type of the code identifying the corresponding equity, e.g. ISIN or CUSIP  # noqa: E501

        :param market_identifier: The market_identifier of this EquityCurveDependencyAllOf.  # noqa: E501
        :type market_identifier: str
        """
    ...
    @property
    def code(self):
        """Gets the code of this EquityCurveDependencyAllOf.  # noqa: E501

        The code identifying the corresponding equity, e.g. US0378331005 if the MarketIdentifier was set to ISIN  # noqa: E501

        :return: The code of this EquityCurveDependencyAllOf.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this EquityCurveDependencyAllOf.

        The code identifying the corresponding equity, e.g. US0378331005 if the MarketIdentifier was set to ISIN  # noqa: E501

        :param code: The code of this EquityCurveDependencyAllOf.  # noqa: E501
        :type code: str
        """
    ...
    @property
    def curve_type(self):
        """Gets the curve_type of this EquityCurveDependencyAllOf.  # noqa: E501

        The curve type of the EquityCurve required. E.g. EquityCurveByPrices  # noqa: E501

        :return: The curve_type of this EquityCurveDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def curve_type(self, curve_type):
        """Sets the curve_type of this EquityCurveDependencyAllOf.

        The curve type of the EquityCurve required. E.g. EquityCurveByPrices  # noqa: E501

        :param curve_type: The curve_type of this EquityCurveDependencyAllOf.  # noqa: E501
        :type curve_type: str
        """
    ...
    @property
    def date(self):
        """Gets the date of this EquityCurveDependencyAllOf.  # noqa: E501
        ...
        :return: The date of this EquityCurveDependencyAllOf.  # noqa: E501
        :rtype: datetime
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this EquityCurveDependencyAllOf.

        The effectiveDate of the entity that this is a dependency for.  Unless there is an obvious date this should be, like for a historic reset, then this is the valuation date.  # noqa: E501

        :param date: The date of this EquityCurveDependencyAllOf.  # noqa: E501
        :type date: datetime
        """
    ...
    def dependency_type(self):
        """Gets the dependency_type of this EquityCurveDependencyAllOf.  # noqa: E501
        ...
        :return: The dependency_type of this EquityCurveDependencyAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def dependency_type(self, dependency_type):
        """Sets the dependency_type of this EquityCurveDependencyAllOf.

        The available values are: OpaqueDependency, CashDependency, DiscountingDependency, EquityCurveDependency, EquityVolDependency, FxDependency, FxForwardsDependency, FxVolDependency, IndexProjectionDependency, IrVolDependency, QuoteDependency, Vendor, CalendarDependency, InflationFixingDependency  # noqa: E501

        :param dependency_type: The dependency_type of this EquityCurveDependencyAllOf.  # noqa: E501
        :type dependency_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EquityCurveDependencyAllOf):
            return False
