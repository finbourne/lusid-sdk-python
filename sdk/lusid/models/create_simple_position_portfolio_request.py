...
class CreateSimplePositionPortfolioRequest(BaseModel):
    ...
    enablement_date: Optional[datetime] = Field(default=None, description="The effective datetime from which instrument events and corporate actions are generated and applied to the simple position portfolio. Holdings set on the portfolio contribute to valuations and other computed results from the portfolio's creation date whatever the enablement date. Defaults to the portfolio's creation date if not specified.", alias="enablementDate")
    ...
    def from_dict(cls, obj: dict) -> CreateSimplePositionPortfolioRequest:
        ...
        if not isinstance(obj, dict):
            return CreateSimplePositionPortfolioRequest.parse_obj(obj)

        _obj = CreateSimplePositionPortfolioRequest.parse_obj({
...
CreateSimplePositionPortfolioRequest.update_forward_refs()
