...
class MatchInstrumentsResponse(object):
    ...
    openapi_types = {
        'href': 'str',
        'values': 'dict(str, list[InstrumentDefinition])',
        'links': 'list[Link]'
    }
    ...
    def __init__(self, href=None, values=None, links=None):  # noqa: E501
        """MatchInstrumentsResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def href(self):
        """Gets the href of this MatchInstrumentsResponse.  # noqa: E501


        :return: The href of this MatchInstrumentsResponse.  # noqa: E501
        :rtype: str
        """
        return self._href
    ...
    @href.setter
    def href(self, href):
        """Sets the href of this MatchInstrumentsResponse.


        :param href: The href of this MatchInstrumentsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def values(self):
        """Gets the values of this MatchInstrumentsResponse.  # noqa: E501

        A dictionary of instruments that are keyed by the search criteria supplied in the  matching request. If no match was found, then there will be no values in the collection  for that key.  # noqa: E501

        :return: The values of this MatchInstrumentsResponse.  # noqa: E501
        :rtype: dict(str, list[InstrumentDefinition])
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this MatchInstrumentsResponse.

        A dictionary of instruments that are keyed by the search criteria supplied in the  matching request. If no match was found, then there will be no values in the collection  for that key.  # noqa: E501

        :param values: The values of this MatchInstrumentsResponse.  # noqa: E501
        :type: dict(str, list[InstrumentDefinition])
        """
    ...
    @property
    def links(self):
        """Gets the links of this MatchInstrumentsResponse.  # noqa: E501


        :return: The links of this MatchInstrumentsResponse.  # noqa: E501
        :rtype: list[Link]
        """
        return self._links
    ...
    def links(self, links):
        """Sets the links of this MatchInstrumentsResponse.


        :param links: The links of this MatchInstrumentsResponse.  # noqa: E501
        :type: list[Link]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MatchInstrumentsResponse):
            return False
