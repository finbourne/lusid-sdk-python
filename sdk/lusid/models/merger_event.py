...
class MergerEvent(InstrumentEvent):
    ...
    lapse_elections: Optional[List[LapseElection]] = Field(default=None, description="List of possible lapse elections for this merger event (NOAC).", alias="lapseElections")
    unknown_proceeds_elections: Optional[List[UnknownProceedsElection]] = Field(default=None, description="List of possible unknown-proceeds elections for this merger event (UNKNOWN) — the outturn is not yet known.", alias="unknownProceedsElections")
...
MergerEvent.update_forward_refs()
