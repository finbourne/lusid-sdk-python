...
class CustodianAccount(object):
    ...
    def __init__(self, custodian_account_id=None, status=None, account_number=None, account_name=None, accounting_method=None, currency=None, account_type=None, properties=None, custodian=None, local_vars_configuration=None):  # noqa: E501
