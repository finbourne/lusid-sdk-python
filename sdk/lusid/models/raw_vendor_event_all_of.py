...
class RawVendorEventAllOf(BaseModel):
    """
    RawVendorEventAllOf
    """
    ...
    __properties = ["effectiveAt", "eventValue", "eventType", "eventStatus", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RawVendorEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RawVendorEventAllOf:
        """Create an instance of RawVendorEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RawVendorEventAllOf.parse_obj(obj)

        _obj = RawVendorEventAllOf.parse_obj({
