...
class UpsertInstrumentPropertiesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsertInstrumentPropertiesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsertInstrumentPropertiesResponse:
        """Create an instance of UpsertInstrumentPropertiesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpsertInstrumentPropertiesResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpsertInstrumentPropertiesResponse) in the input: " + obj)

        _obj = UpsertInstrumentPropertiesResponse.parse_obj({
