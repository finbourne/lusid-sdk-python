...
class PortfolioIdComplianceParameter(ComplianceParameter):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortfolioIdComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortfolioIdComplianceParameter:
        """Create an instance of PortfolioIdComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortfolioIdComplianceParameter.parse_obj(obj)

        _obj = PortfolioIdComplianceParameter.parse_obj({
...
PortfolioIdComplianceParameter.update_forward_refs()
