...
class EquityCurveByPricesDataAllOf(BaseModel):
    """
    ...
    __properties = ["baseDate", "dates", "lineage", "prices", "marketDataOptions", "marketDataType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EquityCurveByPricesDataAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EquityCurveByPricesDataAllOf:
        """Create an instance of EquityCurveByPricesDataAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EquityCurveByPricesDataAllOf.parse_obj(obj)

        _obj = EquityCurveByPricesDataAllOf.parse_obj({
