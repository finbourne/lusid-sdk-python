...
class PortfolioTransactionAdjustment(NavActivityAdjustmentResponse):
    ...
    __properties = ["navActivityAdjustmentType", "navActivityAdjustmentSource", "asAt", "portfolioScope", "portfolioCode", "transactionId"]
    ...
    def from_dict(cls, obj: dict) -> PortfolioTransactionAdjustment:
        ...
        if not isinstance(obj, dict):
            return PortfolioTransactionAdjustment.parse_obj(obj)

        _obj = PortfolioTransactionAdjustment.parse_obj({
...
PortfolioTransactionAdjustment.update_forward_refs()
