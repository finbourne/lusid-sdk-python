...
class ValuationPointResourceListOfAccountedQuote(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValuationPointResourceListOfAccountedQuote:
        """Create an instance of ValuationPointResourceListOfAccountedQuote from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfAccountedQuote:
        """Create an instance of ValuationPointResourceListOfAccountedQuote from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValuationPointResourceListOfAccountedQuote.parse_obj(obj)

        _obj = ValuationPointResourceListOfAccountedQuote.parse_obj({
            ...
            "values": [AccountedQuote.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfAccountedQuote.update_forward_refs()
