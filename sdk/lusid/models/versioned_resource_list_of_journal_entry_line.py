...
class VersionedResourceListOfJournalEntryLine(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VersionedResourceListOfJournalEntryLine:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VersionedResourceListOfJournalEntryLine:
        """Create an instance of VersionedResourceListOfJournalEntryLine from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VersionedResourceListOfJournalEntryLine.parse_obj(obj)

        _obj = VersionedResourceListOfJournalEntryLine.parse_obj({
...
VersionedResourceListOfJournalEntryLine.update_forward_refs()
