...
class SubHoldingKeyValueEqualsAllOf(BaseModel):
    """
    ...
    __properties = ["subHoldingKey", "value", "criterionType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubHoldingKeyValueEqualsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubHoldingKeyValueEqualsAllOf:
        """Create an instance of SubHoldingKeyValueEqualsAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubHoldingKeyValueEqualsAllOf.parse_obj(obj)

        _obj = SubHoldingKeyValueEqualsAllOf.parse_obj({
