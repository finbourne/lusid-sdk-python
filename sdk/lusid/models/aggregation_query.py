...
class AggregationQuery(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> AggregationQuery:
        ...
        _obj = AggregationQuery.parse_obj({
            ...
            "applicable_options": {k: None if v is None else {ik: AddressKeyOptionDefinition.from_dict(iv) for ik, iv in v.items()} for k, v in obj.get("applicableOptions").items()} if obj.get("applicableOptions") is not None else None,
        })
        return _obj
