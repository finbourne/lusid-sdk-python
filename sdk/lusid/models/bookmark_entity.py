...
class BookmarkEntity(BaseModel):
    ...
    prevailing_bookmark: Optional[FundCalendarEntry] = Field(default=None, alias="prevailingBookmark")
    deleted_bookmark: Optional[FundCalendarEntry] = Field(default=None, alias="deletedBookmark")
    ...
    previewed_bookmark: Optional[FundCalendarEntry] = Field(default=None, alias="previewedBookmark")
    links: Optional[List[Link]] = None
    __properties = ["href", "entityUniqueId", "asAtVersionNumber", "status", "asAtDeleted", "userIdDeleted", "requestIdDeleted", "effectiveAtCreated", "prevailingBookmark", "deletedBookmark", "previewedStatus", "previewedBookmark", "links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookmarkEntity:
        """Create an instance of BookmarkEntity from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of prevailing_bookmark
        if self.prevailing_bookmark:
            _dict['prevailingBookmark'] = self.prevailing_bookmark.to_dict()
        # override the default output from pydantic by calling `to_dict()` of deleted_bookmark
        if self.deleted_bookmark:
            _dict['deletedBookmark'] = self.deleted_bookmark.to_dict()
        # override the default output from pydantic by calling `to_dict()` of previewed_bookmark
        if self.previewed_bookmark:
            _dict['previewedBookmark'] = self.previewed_bookmark.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BookmarkEntity:
        """Create an instance of BookmarkEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BookmarkEntity.parse_obj(obj)

        _obj = BookmarkEntity.parse_obj({
            "href": obj.get("href"),
            ...
            "prevailing_bookmark": FundCalendarEntry.from_dict(obj.get("prevailingBookmark")) if obj.get("prevailingBookmark") is not None else None,
            "deleted_bookmark": FundCalendarEntry.from_dict(obj.get("deletedBookmark")) if obj.get("deletedBookmark") is not None else None,
            "previewed_status": obj.get("previewedStatus"),
            "previewed_bookmark": FundCalendarEntry.from_dict(obj.get("previewedBookmark")) if obj.get("previewedBookmark") is not None else None,
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

BookmarkEntity.update_forward_refs()
