...
class CreateRelationRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRelationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRelationRequest:
        """Create an instance of CreateRelationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRelationRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateRelationRequest) in the input: " + obj)

        _obj = CreateRelationRequest.parse_obj({
