...
class PortfolioIdListComplianceParameter(ComplianceParameter):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortfolioIdListComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortfolioIdListComplianceParameter:
        """Create an instance of PortfolioIdListComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortfolioIdListComplianceParameter.parse_obj(obj)

        _obj = PortfolioIdListComplianceParameter.parse_obj({
...
PortfolioIdListComplianceParameter.update_forward_refs()
