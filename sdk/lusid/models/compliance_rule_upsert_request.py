...
class ComplianceRuleUpsertRequest(BaseModel):
    ...
    """
    scope: constr(strict=True, max_length=64, min_length=1) = ...
    ...
    schedule: constr(strict=True, min_length=1) = ...
    ...
    def from_dict(cls, obj: dict) -> ComplianceRuleUpsertRequest:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ComplianceRuleUpsertRequest) in the input: " + obj)
