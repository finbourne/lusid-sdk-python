...
class IndustryClassifier(object):
    ...
    def __init__(self, classification_system_name=None, classification_code=None):  # noqa: E501
        """
    ...
    def classification_system_name(self, classification_system_name):
        ...
        :type: str
        """
        if classification_system_name is None:
    ...
    def classification_code(self, classification_code):
        ...
        if classification_code is not None and len(classification_code) > 64:
            raise ValueError("Invalid value for `classification_code`, length must be less than or equal to `64`")  # noqa: E501
        if classification_code is not None and len(classification_code) < 1:
            raise ValueError("Invalid value for `classification_code`, length must be greater than or equal to `1`")  # noqa: E501
        if (classification_code is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', classification_code)):  # noqa: E501
