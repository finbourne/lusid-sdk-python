...
class EquityVolSurfaceDataAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EquityVolSurfaceDataAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EquityVolSurfaceDataAllOf:
        """Create an instance of EquityVolSurfaceDataAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EquityVolSurfaceDataAllOf.parse_obj(obj)

        _obj = EquityVolSurfaceDataAllOf.parse_obj({
