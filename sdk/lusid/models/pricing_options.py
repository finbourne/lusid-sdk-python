...
class PricingOptions(object):
    ...
    openapi_types = {
        ...
        'conserved_quantity_for_lookthrough_expansion': 'str'
    }
    ...
    attribute_map = {
        ...
        'conserved_quantity_for_lookthrough_expansion': 'conservedQuantityForLookthroughExpansion'
    }
    ...
    required_map = {
        ...
        'conserved_quantity_for_lookthrough_expansion': 'optional'
    }
    ...
    def __init__(self, model_selection=None, use_instrument_type_to_determine_pricer=None, allow_any_instruments_with_sec_uid_to_price_off_lookup=None, allow_partially_successful_evaluation=None, produce_separate_result_for_linear_otc_legs=None, enable_use_of_cached_unit_results=None, window_valuation_on_instrument_start_end=None, remove_contingent_cashflows_in_payment_diary=None, use_child_sub_holding_keys_for_portfolio_expansion=None, validate_domestic_and_quote_currencies_are_consistent=None, conserved_quantity_for_lookthrough_expansion=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._conserved_quantity_for_lookthrough_expansion = None
        ...
        self.conserved_quantity_for_lookthrough_expansion = conserved_quantity_for_lookthrough_expansion
    ...
    @property
    def conserved_quantity_for_lookthrough_expansion(self):
        """Gets the conserved_quantity_for_lookthrough_expansion of this PricingOptions.  # noqa: E501

        When performing lookthrough portfolio expansion with ScalingMethodology set to \"Sum\" or \"AbsoluteSum\",  the quantity specified here will be conserved and apportioned to lookthrough constituents.  For example, an equal-weighting index with 100 constituents can be modelled as a reference portfolio with 1% weights on each equity.  When expanding a $9000 holding of that index into its constituents while conserving PV, we end up with $90 of each equity.  The number of units of each equity held is then implied.  Note that conservation of one quantity may imply non-conservation of others, especially when some constituents are OTCs.                Allowed values are: \"PV\" (default), \"Exposure\".  # noqa: E501

        :return: The conserved_quantity_for_lookthrough_expansion of this PricingOptions.  # noqa: E501
        :rtype: str
        """
        return self._conserved_quantity_for_lookthrough_expansion

    @conserved_quantity_for_lookthrough_expansion.setter
    def conserved_quantity_for_lookthrough_expansion(self, conserved_quantity_for_lookthrough_expansion):
        """Sets the conserved_quantity_for_lookthrough_expansion of this PricingOptions.

        When performing lookthrough portfolio expansion with ScalingMethodology set to \"Sum\" or \"AbsoluteSum\",  the quantity specified here will be conserved and apportioned to lookthrough constituents.  For example, an equal-weighting index with 100 constituents can be modelled as a reference portfolio with 1% weights on each equity.  When expanding a $9000 holding of that index into its constituents while conserving PV, we end up with $90 of each equity.  The number of units of each equity held is then implied.  Note that conservation of one quantity may imply non-conservation of others, especially when some constituents are OTCs.                Allowed values are: \"PV\" (default), \"Exposure\".  # noqa: E501

        :param conserved_quantity_for_lookthrough_expansion: The conserved_quantity_for_lookthrough_expansion of this PricingOptions.  # noqa: E501
        :type conserved_quantity_for_lookthrough_expansion: str
        """

        self._conserved_quantity_for_lookthrough_expansion = conserved_quantity_for_lookthrough_expansion
