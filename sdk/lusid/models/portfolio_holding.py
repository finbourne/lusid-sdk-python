...
class PortfolioHolding(object):
    ...
    def __init__(self, instrument_scope=None, instrument_uid=None, sub_holding_keys=None, properties=None, holding_type=None, holding_type_name=None, units=None, settled_units=None, cost=None, cost_portfolio_ccy=None, transaction=None, currency=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param holding_type_name:  The decoded type of the holding e.g. Position, Balance, CashCommitment, Receivable, ForwardFX etc. (required)
    ...
    def holding_type_name(self, holding_type_name):
        ...
        :type holding_type_name: str
        """
        if self.local_vars_configuration.client_side_validation and holding_type_name is None:  # noqa: E501
            raise ValueError("Invalid value for `holding_type_name`, must not be `None`")  # noqa: E501
