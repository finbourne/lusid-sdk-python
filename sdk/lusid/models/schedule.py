...
class Schedule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(FixedSchedule, FloatSchedule, FxRateSchedule, StepSchedule):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(FixedSchedule, FloatSchedule, FxRateSchedule, StepSchedule):
