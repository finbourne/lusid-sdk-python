...
class CancelOrdersResponse(BaseModel):
    ...
    values: Optional[Dict[str, CancelledOrderResult]] = Field(default=None, description="The orders which have been successfully cancelled.")
    failed: Optional[Dict[str, ErrorDetail]] = Field(default=None, description="The orders that could not be cancelled, along with a reason for their failure.")
...
CancelOrdersResponse.update_forward_refs()
