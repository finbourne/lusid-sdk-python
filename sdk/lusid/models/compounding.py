...
class Compounding(object):
    ...
    required_map = {
        ...
        'shift': 'optional',
        'spread_compounding_method': 'optional'
    }
    ...
    def __init__(self, averaging_method=None, calculation_shift_method=None, compounding_method=None, reset_frequency=None, shift=None, spread_compounding_method=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type shift: int
        :param spread_compounding_method:  Defines how the computed leg spread is applied to compounded rate.  It applies only when CompoundingMethod = ‘Compounded‘.    Supported string (enumeration) values are: [Straight, IsdaCompounding, NoCompounding, SpreadExclusive, IsdaFlatCompounding, Flat, None].
    ...
    def averaging_method(self, averaging_method):
        ...
        if (self.local_vars_configuration.client_side_validation and
                averaging_method is not None and len(averaging_method) > 32):
            raise ValueError("Invalid value for `averaging_method`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                averaging_method is not None and len(averaging_method) < 0):
            raise ValueError("Invalid value for `averaging_method`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def spread_compounding_method(self, spread_compounding_method):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                spread_compounding_method is not None and len(spread_compounding_method) > 32):
            raise ValueError("Invalid value for `spread_compounding_method`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                spread_compounding_method is not None and len(spread_compounding_method) < 0):
            raise ValueError("Invalid value for `spread_compounding_method`, length must be greater than or equal to `0`")  # noqa: E501
