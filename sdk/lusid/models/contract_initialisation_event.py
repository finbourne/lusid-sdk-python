...
class ContractInitialisationEvent(InstrumentEvent):
    ...
    var_date: Optional[datetime] = Field(default=None, description="Initialisation date of the contract.", alias="date")
...
ContractInitialisationEvent.update_forward_refs()
