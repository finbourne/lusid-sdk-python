...
class AborConfiguration(BaseModel):
    ...
    id: ResourceId = ...
    description: Optional[StrictStr] = Field(None, description="The description for the AborConfiguration.")
    name: Optional[StrictStr] = Field(None, description="The given name for the AborConfiguration.")
    ...
    __properties = ["href", "id", "description", "name", "recipeId", "chartOfAccountsId", "properties", "version", "links"]
    ...
    def from_dict(cls, obj: dict) -> AborConfiguration:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AborConfiguration) in the input: " + obj)
