...
class ConstantVolatilitySurface(ComplexMarketData):
    ...
    """
    base_date: datetime = Field(description="Base date of the engine - this is the reference date for resolution of tenors.", alias="baseDate")
...
ConstantVolatilitySurface.update_forward_refs()
