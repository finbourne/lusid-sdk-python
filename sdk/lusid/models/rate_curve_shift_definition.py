...
class RateCurveShiftDefinition(ScenarioShiftDefinition):
    ...
    start_tenor:  Optional[StrictStr] = Field(None,alias="startTenor", description="The near end of the tenor window the shift applies over, resolved against the valuation  date. A whole number of units, in any case: BD (business day), D, W, M, Q or Qtr, SA  (semi-annual), Y or A - for example \"1BD\", \"3m\", \"6M\", \"1Qtr\", \"5y\". Omitted, the window  is open at this end and every point up to EndTenor is in it.") 
    end_tenor:  Optional[StrictStr] = Field(None,alias="endTenor", description="The far end of the tenor window, in the same units as StartTenor. Omitted, the window is  open at this end.") 
    ...
    __properties = ["scenarioShiftType", "ccy", "amount", "startTenor", "endTenor", "shiftType", "scale", "applyTo", "pivotTenor", "windowBounds", "curveName", "minimumAmountBps", "applyWhenValue"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.curve_name is None and "curve_name" in self.__fields_set__:
