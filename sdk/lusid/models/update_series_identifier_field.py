...
class UpdateSeriesIdentifierField(BaseModel):
    """
    ...
    required: StrictBool = Field(description="Whether this field is mandatory in the dataset.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateSeriesIdentifierField:
        """Create an instance of UpdateSeriesIdentifierField from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateSeriesIdentifierField:
        """Create an instance of UpdateSeriesIdentifierField from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateSeriesIdentifierField.parse_obj(obj)

        _obj = UpdateSeriesIdentifierField.parse_obj({
...
UpdateSeriesIdentifierField.update_forward_refs()
