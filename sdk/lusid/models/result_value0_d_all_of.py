...
class ResultValue0DAllOf(BaseModel):
    """
    ResultValue0DAllOf
    """
    ...
    __properties = ["units", "value", "dimension", "resultValueType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultValue0DAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultValue0DAllOf:
        """Create an instance of ResultValue0DAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultValue0DAllOf.parse_obj(obj)

        _obj = ResultValue0DAllOf.parse_obj({
            "units": obj.get("units"),
            "value": obj.get("value"),
