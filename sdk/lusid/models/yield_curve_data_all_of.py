...
class YieldCurveDataAllOf(BaseModel):
    """
    YieldCurveDataAllOf
    """
    ...
    __properties = ["baseDate", "instruments", "quotes", "lineage", "marketDataOptions", "marketDataType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> YieldCurveDataAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> YieldCurveDataAllOf:
        """Create an instance of YieldCurveDataAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return YieldCurveDataAllOf.parse_obj(obj)

        _obj = YieldCurveDataAllOf.parse_obj({
