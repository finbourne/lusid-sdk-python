...
class ConsentEvent(InstrumentEvent):
    ...
    __properties = ["instrumentEventType", "consentType", "recordDate", "responseDeadline", "marketDeadline", "earlyResponseDeadline", "paymentDate", "cashOfferElections", "lapseElections", "consentGrantedElections", "consentDeniedElections", "abstainElections"]
