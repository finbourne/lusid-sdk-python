...
class Bond(LusidInstrument):
    ...
    __properties = ["instrumentType", "startDate", "maturityDate", "domCcy", "flowConventions", "principal", "couponRate", "identifiers", "exDividendDays", "initialCouponDate", "firstCouponPayDate", "calculationType", "roundingConventions", "exDividendConfiguration", "originalIssuePrice", "parPerUnit", "tradingConventions", "timeZoneConventions"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.par_per_unit is None and "par_per_unit" in self.__fields_set__:
