...
class AddressKeyFilter(object):
    ...
    def __init__(self, left=None, operator=None, right=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type left: str
        :param operator:  What sort of comparison is the filter preforming
        :type operator: str
        :param right: 
    ...
    def operator(self):
        ...
        What sort of comparison is the filter preforming  # noqa: E501
    ...
    def operator(self, operator):
        ...
        if (self.local_vars_configuration.client_side_validation and
                operator is not None and len(operator) > 2):
            raise ValueError("Invalid value for `operator`, length must be less than or equal to `2`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
