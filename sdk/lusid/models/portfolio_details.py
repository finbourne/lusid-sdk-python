...
class PortfolioDetails(BaseModel):
    ...
    __properties = ["href", "originPortfolioId", "version", "baseCurrency", "corporateActionSourceId", "subHoldingKeys", "instrumentScopes", "accountingMethod", "amortisationMethod", "links"]
    ...
    def from_dict(cls, obj: dict) -> PortfolioDetails:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PortfolioDetails) in the input: " + obj)
