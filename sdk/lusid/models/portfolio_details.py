...
class PortfolioDetails(object):
    ...
    def __init__(self, href=None, origin_portfolio_id=None, version=None, base_currency=None, corporate_action_source_id=None, links=None):  # noqa: E501
        """PortfolioDetails - a model defined in OpenAPI"""  # noqa: E501
        ...
        if href is not None:
            self.href = href
        if origin_portfolio_id is not None:
