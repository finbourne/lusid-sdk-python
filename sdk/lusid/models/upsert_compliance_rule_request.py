...
class UpsertComplianceRuleRequest(object):
    ...
    def __init__(self, id=None, name=None, description=None, active=None, template_id=None, variation=None, parameters=None, properties=None, local_vars_configuration=None):  # noqa: E501
