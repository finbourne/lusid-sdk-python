...
class PikElection(BaseModel):
    """
    PIK election.  # noqa: E501
    """
    election_key:  StrictStr = Field(...,alias="electionKey", description="Unique key associated to this election (the PIK type)") 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PikElection:
        """Create an instance of PikElection from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PikElection:
        """Create an instance of PikElection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PikElection.parse_obj(obj)

        _obj = PikElection.parse_obj({
...
PikElection.update_forward_refs()
