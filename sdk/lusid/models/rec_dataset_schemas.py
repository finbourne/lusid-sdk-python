...
class RecDatasetSchemas(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> RecDatasetSchemas:
        ...
        if not isinstance(obj, dict):
            return RecDatasetSchemas.parse_obj(obj)

        _obj = RecDatasetSchemas.parse_obj({
            "left": RecDatasetSchema.from_dict(obj.get("left")) if obj.get("left") is not None else None,
            "right": RecDatasetSchema.from_dict(obj.get("right")) if obj.get("right") is not None else None
        })
        return _obj

RecDatasetSchemas.update_forward_refs()
