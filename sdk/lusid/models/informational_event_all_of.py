...
class InformationalEventAllOf(BaseModel):
    """
    ...
    __properties = ["eventType", "eventStatus", "anchorDate", "eventWindowEnd", "diagnostics", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InformationalEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InformationalEventAllOf:
        """Create an instance of InformationalEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InformationalEventAllOf.parse_obj(obj)

        _obj = InformationalEventAllOf.parse_obj({
