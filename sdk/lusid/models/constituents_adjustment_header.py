...
class ConstituentsAdjustmentHeader(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConstituentsAdjustmentHeader:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConstituentsAdjustmentHeader:
        """Create an instance of ConstituentsAdjustmentHeader from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConstituentsAdjustmentHeader.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ConstituentsAdjustmentHeader) in the input: " + obj)

        _obj = ConstituentsAdjustmentHeader.parse_obj({
