...
class CreateResults(object):
    ...
    def __init__(self, data=None, scope=None, key=None, date=None, format=None):  # noqa: E501
    ...
    @property
    def scope(self):
        """Gets the scope of this CreateResults.  # noqa: E501

        The scope of the data to be stored.  # noqa: E501

        :return: The scope of this CreateResults.  # noqa: E501
        :rtype: str
        """
        return self._scope
    ...
    def scope(self, scope):
        """Sets the scope of this CreateResults.

        The scope of the data to be stored.  # noqa: E501

        :param scope: The scope of this CreateResults.  # noqa: E501
        :type: str
        """
    ...
    @property
    def key(self):
        """Gets the key of this CreateResults.  # noqa: E501

        The key is a unique point in 'run' space. For a given scope and time point, one would wish to  identify a unique result set for a given recipe. In essence, this key is the unique identifier for the tuple (recipe,portfolios)  However, that only matters when one is trying to use it automatically to retrieve them.  A question becomes whether we would wish to store groups of protfolio results together, or only single ones.  Also, whether we would accept uploading of groups and then split them apart.  # noqa: E501

        :return: The key of this CreateResults.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this CreateResults.

        The key is a unique point in 'run' space. For a given scope and time point, one would wish to  identify a unique result set for a given recipe. In essence, this key is the unique identifier for the tuple (recipe,portfolios)  However, that only matters when one is trying to use it automatically to retrieve them.  A question becomes whether we would wish to store groups of protfolio results together, or only single ones.  Also, whether we would accept uploading of groups and then split them apart.  # noqa: E501

        :param key: The key of this CreateResults.  # noqa: E501
        :type: str
        """
    ...
    @property
    def date(self):
        """Gets the date of this CreateResults.  # noqa: E501

        The date for which the results should be stored.  # noqa: E501

        :return: The date of this CreateResults.  # noqa: E501
        :rtype: datetime
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this CreateResults.

        The date for which the results should be stored.  # noqa: E501

        :param date: The date of this CreateResults.  # noqa: E501
        :type: datetime
        """
