...
class AccountsUpsertResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountsUpsertResponse:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.accounts is None and "accounts" in self.__fields_set__:
            _dict['accounts'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountsUpsertResponse:
        """Create an instance of AccountsUpsertResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountsUpsertResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AccountsUpsertResponse) in the input: " + obj)

        _obj = AccountsUpsertResponse.parse_obj({
            "href": obj.get("href"),
