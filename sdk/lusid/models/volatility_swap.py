...
class VolatilitySwap(LusidInstrument):
    ...
    underlying:  Optional[StrictStr] = Field(None,alias="underlying", description="Free-text reference label identifying the underlying index or asset (e.g. 'SPX', 'SX5E', 'KOSPI2').  Reference only; not used in valuation.") 
    ...
    __properties = ["instrumentType", "startDate", "maturityDate", "domCcy", "strike", "notional", "priceDenominator", "timeZoneConventions", "underlying"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.underlying is None and "underlying" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> VolatilitySwap:
        ...
        if not isinstance(obj, dict):
            return VolatilitySwap.parse_obj(obj)

        _obj = VolatilitySwap.parse_obj({
...
VolatilitySwap.update_forward_refs()
