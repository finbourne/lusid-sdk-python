...
class FundValuationSchedule(BaseModel):
    ...
    variant:  Optional[StrictStr] = Field(None,alias="variant", description="The diary entry variant to use, together with the diary entry to be used for the valuation schedule.") 
