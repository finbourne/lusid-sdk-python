...
class SideDefinition(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SideDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SideDefinition:
        """Create an instance of SideDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SideDefinition.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SideDefinition) in the input: " + obj)

        _obj = SideDefinition.parse_obj({
            "side": obj.get("side"),
