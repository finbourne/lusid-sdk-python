...
class AddressKeyListComplianceParameter(ComplianceParameter):
    """
    ...
    def compliance_parameter_type_validate_enum(cls, value):
        ...
        if 'AddressKeyListComplianceParameter' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressKeyListComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressKeyListComplianceParameter:
        """Create an instance of AddressKeyListComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressKeyListComplianceParameter.parse_obj(obj)

        _obj = AddressKeyListComplianceParameter.parse_obj({
...
AddressKeyListComplianceParameter.update_forward_refs()
