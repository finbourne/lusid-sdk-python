...
class ResultValue0D(ResultValue):
    ...
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The value of the result")
...
ResultValue0D.update_forward_refs()
