...
class FeeRule(BaseModel):
    ...
    FeeRule
    """
    code: constr(strict=True, min_length=1) = ...
    ...
    country: constr(strict=True, min_length=1) = ...
    counterparty: constr(strict=True, min_length=1) = ...
    ...
    custodian: constr(strict=True, min_length=1) = ...
    exchange: constr(strict=True, min_length=1) = ...
    fee: CalculationInfo = ...
    ...
    def from_dict(cls, obj: dict) -> FeeRule:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in FeeRule) in the input: " + obj)
