...
class UpdateInstrumentIdentifierRequest(object):
    ...
    def __init__(self, type=None, value=None, effective_at=None):  # noqa: E501
        """UpdateInstrumentIdentifierRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def type(self):
        ...
        The type of the identifier to upsert. This must be one of the code types marked as   allowable for instrument identifiers.  # noqa: E501
    ...
    def value(self):
        ...
        The value of the identifier. If set to `null`, this will remove the identifier completely.  Note that, if an instrument only has one identifier, it is an error to remove this.  # noqa: E501
    ...
    def effective_at(self):
        ...
        The date at which the identifier modification is to be effective from. If unset, will  default to `now`.  # noqa: E501
