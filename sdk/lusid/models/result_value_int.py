...
class ResultValueInt(ResultValue):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultValueInt:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultValueInt:
        """Create an instance of ResultValueInt from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultValueInt.parse_obj(obj)

        _obj = ResultValueInt.parse_obj({
...
ResultValueInt.update_forward_refs()
