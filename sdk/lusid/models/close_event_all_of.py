...
class CloseEventAllOf(BaseModel):
    """
    CloseEventAllOf
    """
    ...
    __properties = ["startDate", "endDate", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloseEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloseEventAllOf:
        """Create an instance of CloseEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloseEventAllOf.parse_obj(obj)

        _obj = CloseEventAllOf.parse_obj({
