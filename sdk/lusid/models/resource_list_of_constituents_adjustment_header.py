...
"""
    ...
    OpenAPI spec version: 0.9.189.b1
...
class ResourceListOfConstituentsAdjustmentHeader(object):
    ...
    def __init__(self, values=None, href=None, count=None, links=None):  # noqa: E501
        """ResourceListOfConstituentsAdjustmentHeader - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def count(self):
        """Gets the count of this ResourceListOfConstituentsAdjustmentHeader.  # noqa: E501

        The total number of records returned in the set.  Note: If count is set by the func 'AddDynamicCounter', Count will be zero until the values  are evaluated. This is due to lazy evaluation.  # noqa: E501

        :return: The count of this ResourceListOfConstituentsAdjustmentHeader.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this ResourceListOfConstituentsAdjustmentHeader.

        The total number of records returned in the set.  Note: If count is set by the func 'AddDynamicCounter', Count will be zero until the values  are evaluated. This is due to lazy evaluation.  # noqa: E501

        :param count: The count of this ResourceListOfConstituentsAdjustmentHeader.  # noqa: E501
        :type: int
        """
