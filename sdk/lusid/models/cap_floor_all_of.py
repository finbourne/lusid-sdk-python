...
class CapFloorAllOf(BaseModel):
    ...
    __properties = ["capFloorType", "capStrike", "floorStrike", "includeFirstCaplet", "underlyingFloatingLeg", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CapFloorAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CapFloorAllOf:
        """Create an instance of CapFloorAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CapFloorAllOf.parse_obj(obj)

        _obj = CapFloorAllOf.parse_obj({
