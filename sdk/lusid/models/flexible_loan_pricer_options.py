...
class FlexibleLoanPricerOptions(ModelOptions):
    ...
    __properties = ["modelOptionsType", "setCleanPVToZero"]
    ...
    def model_options_type_validate_enum(cls, value):
        ...
        if 'FlexibleLoanPricerOptions' not in [ 
    ...
    def from_dict(cls, obj: dict) -> FlexibleLoanPricerOptions:
        ...
        if not isinstance(obj, dict):
            return FlexibleLoanPricerOptions.parse_obj(obj)

        _obj = FlexibleLoanPricerOptions.parse_obj({
...
FlexibleLoanPricerOptions.update_forward_refs()
