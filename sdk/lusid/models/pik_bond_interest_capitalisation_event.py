...
class PikBondInterestCapitalisationEvent(InstrumentEvent):
    """
    Definition of a PIK Bond Interest Capitalisation Event  This is an event that describes the capitalised (paid-in-kind) portion of a coupon period on a  Payment-in-Kind ComplexBond, whereby the coupon amount is added to the bond's current face.  # noqa: E501
    """
    ...
    def instrument_event_type_validate_enum(cls, value):
        ...
        if 'PikBondInterestCapitalisationEvent' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PikBondInterestCapitalisationEvent:
        """Create an instance of PikBondInterestCapitalisationEvent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PikBondInterestCapitalisationEvent:
        """Create an instance of PikBondInterestCapitalisationEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PikBondInterestCapitalisationEvent.parse_obj(obj)

        _obj = PikBondInterestCapitalisationEvent.parse_obj({
...
PikBondInterestCapitalisationEvent.update_forward_refs()
