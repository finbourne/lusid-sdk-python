...
class ShareClassPnlBreakdown(BaseModel):
    ...
    __properties = ["apportionedNonClassSpecificPnl", "classPnl", "groupApportionedPnl", "totalPnl"]
        ...
        if self.group_apportioned_pnl:
            for _key in self.group_apportioned_pnl:
                if self.group_apportioned_pnl[_key]:
                    _field_dict[_key] = self.group_apportioned_pnl[_key].to_dict()
    ...
    def from_dict(cls, obj: dict) -> ShareClassPnlBreakdown:
        ...
        _obj = ShareClassPnlBreakdown.parse_obj({
            ...
            "group_apportioned_pnl": dict(
                (_k, ShareClassAmount.from_dict(_v))
                for _k, _v in obj.get("groupApportionedPnl").items()
            )
            if obj.get("groupApportionedPnl") is not None
            else None,
            "total_pnl": dict(
                (_k, ShareClassAmount.from_dict(_v))
