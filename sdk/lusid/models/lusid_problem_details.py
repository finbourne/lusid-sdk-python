...
class LusidProblemDetails(object):
    ...
    def __init__(self, name=None, error_details=None, code=None, type=None, title=None, status=None, detail=None, instance=None):  # noqa: E501
        """LusidProblemDetails - a model defined in OpenAPI"""  # noqa: E501
