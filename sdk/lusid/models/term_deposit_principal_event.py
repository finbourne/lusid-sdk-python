...
class TermDepositPrincipalEvent(InstrumentEvent):
    ...
    principal_per_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The principal payment made per unit of the held .", alias="principalPerUnit")
...
TermDepositPrincipalEvent.update_forward_refs()
