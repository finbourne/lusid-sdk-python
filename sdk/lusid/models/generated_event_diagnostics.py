...
class GeneratedEventDiagnostics(BaseModel):
    ...
    type:  StrictStr = Field(...,alias="type", description="Available values: MarketDataFailure, TransactionFailure, EventCombinationFailure, RepodOutHolding, ScheduleFailure, ModelSubstitution.") 
