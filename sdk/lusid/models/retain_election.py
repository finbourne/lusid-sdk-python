...
class RetainElection(BaseModel):
    """
    Election to retain the existing holding rather than redeem (PROX).  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetainElection:
        """Create an instance of RetainElection from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetainElection:
        """Create an instance of RetainElection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetainElection.parse_obj(obj)

        _obj = RetainElection.parse_obj({
...
RetainElection.update_forward_refs()
