...
class CreateTransactionPortfolioRequest(object):
    ...
    def __init__(self, display_name=None, description=None, code=None, created=None, base_currency=None, corporate_action_source_id=None, accounting_method=None, sub_holding_keys=None, properties=None):  # noqa: E501
        """CreateTransactionPortfolioRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def created(self):
        ...
        The effectiveAt datetime at which the transaction portfolio will be created. No transactions can be upserted to the transaction portfolio before this date. Defaults to the current datetime if not specified.  # noqa: E501
    ...
    def accounting_method(self):
        ...
        Determines the accounting treatment given to the transaction portfolio's tax lots.  # noqa: E501
    ...
    def sub_holding_keys(self):
        ...
        A set of unique transaction properties to group the transaction portfolio's holdings by. Each property must be from the 'Trade' domain and should be identified by its key which has the format {domain}/{scope}/{code}, e.g. 'Trade/strategies/quantsignal'.  # noqa: E501
    ...
    def properties(self):
        ...
        A set of unique portfolio properties to add to the transaction portfolio. Each property should be identified by its key which has the format {domain}/{scope}/{code}, e.g. 'Portfolio/Manager/Id'. These properties must be pre-defined.  # noqa: E501
