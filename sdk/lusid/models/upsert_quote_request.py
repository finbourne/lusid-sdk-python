...
class UpsertQuoteRequest(object):
    ...
    def __init__(self, quote_id=None, metric_value=None, quote_lineage=None, effective_at=None):  # noqa: E501
        """UpsertQuoteRequest - a model defined in OpenAPI"""  # noqa: E501

        self._quote_id = None
        self._metric_value = None
        self._quote_lineage = None
    ...
    @property
    def quote_lineage(self):
        """Gets the quote_lineage of this UpsertQuoteRequest.  # noqa: E501


        :return: The quote_lineage of this UpsertQuoteRequest.  # noqa: E501
        :rtype: QuoteLineage
        """
        return self._quote_lineage

    @quote_lineage.setter
    def quote_lineage(self, quote_lineage):
        """Sets the quote_lineage of this UpsertQuoteRequest.


        :param quote_lineage: The quote_lineage of this UpsertQuoteRequest.  # noqa: E501
        :type: QuoteLineage
        """
        if quote_lineage is None:
            raise ValueError("Invalid value for `quote_lineage`, must not be `None`")  # noqa: E501

        self._quote_lineage = quote_lineage
