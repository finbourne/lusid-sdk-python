...
class MarketOptions(object):
    ...
    def __init__(self, default_supplier=None, default_instrument_code_type=None, default_scope=None, attempt_to_infer_missing_fx=None, local_vars_configuration=None):  # noqa: E501
        ...
        if default_instrument_code_type is not None:
    ...
    def default_supplier(self, default_supplier):
        ...
        if self.local_vars_configuration.client_side_validation and default_supplier not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `default_supplier` ({0}), must be one of {1}"  # noqa: E501
                .format(default_supplier, allowed_values)
            )
    ...
    def default_instrument_code_type(self, default_instrument_code_type):
        ...
        if self.local_vars_configuration.client_side_validation and default_instrument_code_type not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `default_instrument_code_type` ({0}), must be one of {1}"  # noqa: E501
                .format(default_instrument_code_type, allowed_values)
            )
