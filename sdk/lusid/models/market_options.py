...
class MarketOptions(object):
    ...
    def __init__(self, default_supplier=None, default_instrument_code_type=None, default_scope=None):  # noqa: E501
    ...
    def default_supplier(self, default_supplier):
        ...
        if default_supplier not in allowed_values:
            raise ValueError(
    ...
    def default_instrument_code_type(self, default_instrument_code_type):
        ...
        if default_instrument_code_type not in allowed_values:
            raise ValueError(
