...
class FlowConventionName(BaseModel):
    ...
    tenor:  StrictStr = Field(...,alias="tenor", description="Tenor for the convention name.    For more information on tenors, see [Specifying tenors in LUSID](https://support.lusid.com/docs/specifying-tenors-in-lusid)") 
