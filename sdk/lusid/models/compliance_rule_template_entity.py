...
class ComplianceRuleTemplateEntity(BaseModel):
    """
    ...
    prevailing_compliance_rule_template: Optional[ComplianceRuleTemplate] = Field(default=None, alias="prevailingComplianceRuleTemplate")
    deleted_compliance_rule_template: Optional[ComplianceRuleTemplate] = Field(default=None, alias="deletedComplianceRuleTemplate")
    previewed_status:  Optional[StrictStr] = Field(None,alias="previewedStatus", description="The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist.") 
    previewed_compliance_rule_template: Optional[ComplianceRuleTemplate] = Field(default=None, alias="previewedComplianceRuleTemplate")
    links: Optional[List[Link]] = None
    __properties = ["href", "entityUniqueId", "asAtVersionNumber", "status", "asAtDeleted", "userIdDeleted", "requestIdDeleted", "effectiveAtCreated", "prevailingComplianceRuleTemplate", "deletedComplianceRuleTemplate", "previewedStatus", "previewedComplianceRuleTemplate", "links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ComplianceRuleTemplateEntity:
        """Create an instance of ComplianceRuleTemplateEntity from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of prevailing_compliance_rule_template
        if self.prevailing_compliance_rule_template:
            _dict['prevailingComplianceRuleTemplate'] = self.prevailing_compliance_rule_template.to_dict()
        # override the default output from pydantic by calling `to_dict()` of deleted_compliance_rule_template
        if self.deleted_compliance_rule_template:
            _dict['deletedComplianceRuleTemplate'] = self.deleted_compliance_rule_template.to_dict()
        # override the default output from pydantic by calling `to_dict()` of previewed_compliance_rule_template
        if self.previewed_compliance_rule_template:
            _dict['previewedComplianceRuleTemplate'] = self.previewed_compliance_rule_template.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ComplianceRuleTemplateEntity:
        """Create an instance of ComplianceRuleTemplateEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ComplianceRuleTemplateEntity.parse_obj(obj)

        _obj = ComplianceRuleTemplateEntity.parse_obj({
            "href": obj.get("href"),
            ...
            "prevailing_compliance_rule_template": ComplianceRuleTemplate.from_dict(obj.get("prevailingComplianceRuleTemplate")) if obj.get("prevailingComplianceRuleTemplate") is not None else None,
            "deleted_compliance_rule_template": ComplianceRuleTemplate.from_dict(obj.get("deletedComplianceRuleTemplate")) if obj.get("deletedComplianceRuleTemplate") is not None else None,
            "previewed_status": obj.get("previewedStatus"),
            "previewed_compliance_rule_template": ComplianceRuleTemplate.from_dict(obj.get("previewedComplianceRuleTemplate")) if obj.get("previewedComplianceRuleTemplate") is not None else None,
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

ComplianceRuleTemplateEntity.update_forward_refs()
