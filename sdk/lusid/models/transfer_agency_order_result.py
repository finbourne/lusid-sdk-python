...
class TransferAgencyOrderResult(BaseModel):
    ...
    __properties = ["orderId", "transactionId"]
    ...
    def from_dict(cls, obj: dict) -> TransferAgencyOrderResult:
        ...
        if not isinstance(obj, dict):
            return TransferAgencyOrderResult.parse_obj(obj)

        _obj = TransferAgencyOrderResult.parse_obj({
            "order_id": ResourceId.from_dict(obj.get("orderId")) if obj.get("orderId") is not None else None,
            "transaction_id": obj.get("transactionId")
        })
        return _obj

TransferAgencyOrderResult.update_forward_refs()
