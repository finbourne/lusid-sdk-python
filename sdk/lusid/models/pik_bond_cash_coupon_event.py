...
class PikBondCashCouponEvent(InstrumentEvent):
    """
    Definition of a PIK Bond Cash Coupon Event  This is an event that describes the cash portion of a Payment-in-Kind coupon period on a ComplexBond.  # noqa: E501
    """
    ...
    coupon_per_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The cash coupon amount per unit of the held bond's current face", alias="couponPerUnit")
    ...
    def instrument_event_type_validate_enum(cls, value):
        ...
        if 'PikBondCashCouponEvent' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PikBondCashCouponEvent:
        """Create an instance of PikBondCashCouponEvent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PikBondCashCouponEvent:
        """Create an instance of PikBondCashCouponEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PikBondCashCouponEvent.parse_obj(obj)

        _obj = PikBondCashCouponEvent.parse_obj({
...
PikBondCashCouponEvent.update_forward_refs()
