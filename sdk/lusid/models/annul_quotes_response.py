...
class AnnulQuotesResponse(BaseModel):
    """
    AnnulQuotesResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnulQuotesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnulQuotesResponse:
        """Create an instance of AnnulQuotesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnulQuotesResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AnnulQuotesResponse) in the input: " + obj)

        _obj = AnnulQuotesResponse.parse_obj({
            "href": obj.get("href"),
