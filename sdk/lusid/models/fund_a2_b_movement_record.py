...
class FundA2BMovementRecord(BaseModel):
    """
    Fund A2B Movement Record - shows A2B category based changes relating to a specific movement within a Fund  # noqa: E501
    """
    ...
    __properties = ["portfolioId", "holdingType", "instrumentScope", "instrumentUid", "subHoldingKeys", "currency", "transactionId", "movementName", "effectiveDate", "units", "start", "flows", "gains", "carry", "end", "runningUnits", "runningBalance", "runningCost", "properties", "groupId", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FundA2BMovementRecord:
        """Create an instance of FundA2BMovementRecord from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FundA2BMovementRecord:
        """Create an instance of FundA2BMovementRecord from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FundA2BMovementRecord.parse_obj(obj)

        _obj = FundA2BMovementRecord.parse_obj({
...
FundA2BMovementRecord.update_forward_refs()
