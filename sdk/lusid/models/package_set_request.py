...
class PackageSetRequest(BaseModel):
    ...
    """
    requests: Optional[conlist(PackageRequest)] = Field(None, description="A collection of PackageRequests.")
    ...
    def from_dict(cls, obj: dict) -> PackageSetRequest:
        ...
        if not isinstance(obj, dict):
            return PackageSetRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PackageSetRequest) in the input: " + obj)

        _obj = PackageSetRequest.parse_obj({
