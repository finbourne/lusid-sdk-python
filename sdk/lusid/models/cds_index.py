...
class CdsIndex(LusidInstrument):
    """
    LUSID representation of a Credit Default Swap Index (CDX).                This instrument has multiple legs, to see how legs are used in LUSID see [How does LUSID handle instrument legs?](https://support.lusid.com/docs/how-does-lusid-handle-instrument-legs).                | Leg Index | Leg Identifier | Description |  | --------- | -------------- | ----------- |  | 1 | ProtectionLeg | Payments made by the protection seller in the case of default across all CDS instruments in the index. |  | 2 | PremiumLeg | The premium payments made by the protection buyer across all CDS instruments in the index. |  | 3 | AdditionalPayments | Cash flows relating to any additional payments (optional). |  # noqa: E501
    """
    ...
    flow_conventions: Optional[CdsFlowConventions] = Field(default=None, alias="flowConventions")
    ...
    identifiers: Dict[str, Optional[StrictStr]] = Field(description="External market codes and identifiers for the cds index, e.g. a RED code, BBG ID or ICE code.")
    ...
    __properties = ["instrumentType", "startDate", "maturityDate", "flowConventions", "couponRate", "identifiers", "basket", "conventionName", "notional", "isNonStandard", "additionalPayments", "timeZoneConventions"]
