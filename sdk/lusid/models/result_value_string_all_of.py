...
class ResultValueStringAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultValueStringAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultValueStringAllOf:
        """Create an instance of ResultValueStringAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultValueStringAllOf.parse_obj(obj)

        _obj = ResultValueStringAllOf.parse_obj({
            "value": obj.get("value"),
