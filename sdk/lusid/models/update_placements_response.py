...
class UpdatePlacementsResponse(BaseModel):
    ...
    values: Optional[Dict[str, Placement]] = Field(default=None, description="The placements which have been successfully updated.")
    failed: Optional[Dict[str, ErrorDetail]] = Field(default=None, description="The placements that could not be updated, along with a reason for their failure.")
    metadata: Optional[Dict[str, Optional[List[ResponseMetaData]]]] = Field(default=None, description="Meta data associated with the update event.")
...
UpdatePlacementsResponse.update_forward_refs()
