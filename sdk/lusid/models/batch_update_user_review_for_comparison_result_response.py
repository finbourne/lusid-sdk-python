...
class BatchUpdateUserReviewForComparisonResultResponse(BaseModel):
    ...
    """
    values: Optional[Dict[str, GroupReconciliationComparisonResult]] = Field(default=None, description="The collection of comparison results that have been successfully updated.")
    failed: Optional[Dict[str, ErrorDetail]] = Field(default=None, description="The collection of comparison results that could not be updated with the provided user input along with a reason for their failure.")
    metadata: Optional[Dict[str, Optional[List[ResponseMetaData]]]] = Field(default=None, description="Contains warnings related to the updated comparison result user input")
...
BatchUpdateUserReviewForComparisonResultResponse.update_forward_refs()
