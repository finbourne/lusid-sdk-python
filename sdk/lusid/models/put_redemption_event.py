...
class PutRedemptionEvent(InstrumentEvent):
    ...
    retain_elections: Optional[List[RetainElection]] = Field(default=None, description="List of possible retain elections for this event (PROX) — keep the holding rather than redeem.", alias="retainElections")
    ...
    __properties = ["instrumentEventType", "paymentDate", "offerPrice", "currency", "cashOfferElections", "lapseElections", "marketDeadlineDate", "responseDeadlineDate", "earlyResponseDeadline", "exDate", "announcementDate", "accruedInterestPerUnit", "prorationRate", "retainElections", "unknownProceedsElections"]
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in retain_elections (list)
        _items = []
        if self.retain_elections:
            for _item in self.retain_elections:
                if _item:
                    _items.append(_item.to_dict())
            _dict['retainElections'] = _items
        ...
        # set to None if retain_elections (nullable) is None
        # and __fields_set__ contains the field
        if self.retain_elections is None and "retain_elections" in self.__fields_set__:
            _dict['retainElections'] = None
    ...
    def from_dict(cls, obj: dict) -> PutRedemptionEvent:
        ...
        _obj = PutRedemptionEvent.parse_obj({
            ...
            "retain_elections": [RetainElection.from_dict(_item) for _item in obj.get("retainElections")] if obj.get("retainElections") is not None else None,
