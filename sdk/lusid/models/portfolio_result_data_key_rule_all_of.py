...
class PortfolioResultDataKeyRuleAllOf(BaseModel):
    """
    ...
    __properties = ["supplier", "dataScope", "documentCode", "quoteInterval", "asAt", "portfolioCode", "portfolioScope", "resultKeyRuleType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortfolioResultDataKeyRuleAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortfolioResultDataKeyRuleAllOf:
        """Create an instance of PortfolioResultDataKeyRuleAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortfolioResultDataKeyRuleAllOf.parse_obj(obj)

        _obj = PortfolioResultDataKeyRuleAllOf.parse_obj({
