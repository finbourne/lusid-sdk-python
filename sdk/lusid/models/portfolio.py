...
class Portfolio(object):
    ...
    def __init__(self, href=None, id=None, type=None, display_name=None, description=None, created=None, parent_portfolio_id=None, version=None, is_derived=None, base_currency=None, properties=None, instrument_scopes=None, accounting_method=None, links=None, local_vars_configuration=None):  # noqa: E501
