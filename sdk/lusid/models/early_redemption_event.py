...
class EarlyRedemptionEvent(InstrumentEvent):
    ...
    redemption_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Percentage of the issued amount to be redeemed, value between 0 and 1, where 1 is a full redemption", alias="redemptionPercentage")
...
EarlyRedemptionEvent.update_forward_refs()
