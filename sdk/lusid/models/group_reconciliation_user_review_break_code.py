...
class GroupReconciliationUserReviewBreakCode(BaseModel):
    ...
    """
    break_code:  StrictStr = Field(...,alias="breakCode", description="The break code of the reconciliation result.") 
...
GroupReconciliationUserReviewBreakCode.update_forward_refs()
