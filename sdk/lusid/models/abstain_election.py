...
class AbstainElection(BaseModel):
    """
    Election to abstain from voting on the proposed action (ABST).  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbstainElection:
        """Create an instance of AbstainElection from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbstainElection:
        """Create an instance of AbstainElection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbstainElection.parse_obj(obj)

        _obj = AbstainElection.parse_obj({
...
AbstainElection.update_forward_refs()
