...
class DeleteInstrumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteInstrumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteInstrumentResponse:
        """Create an instance of DeleteInstrumentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteInstrumentResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DeleteInstrumentResponse) in the input: " + obj)
