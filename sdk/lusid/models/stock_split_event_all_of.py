...
class StockSplitEventAllOf(BaseModel):
    """
    ...
    __properties = ["equitySplitRatio", "paymentDate", "recordDate", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StockSplitEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StockSplitEventAllOf:
        """Create an instance of StockSplitEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StockSplitEventAllOf.parse_obj(obj)

        _obj = StockSplitEventAllOf.parse_obj({
