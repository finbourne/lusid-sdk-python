...
class UpsertSingleStructuredDataResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsertSingleStructuredDataResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsertSingleStructuredDataResponse:
        """Create an instance of UpsertSingleStructuredDataResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpsertSingleStructuredDataResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpsertSingleStructuredDataResponse) in the input: " + obj)

        _obj = UpsertSingleStructuredDataResponse.parse_obj({
            "href": obj.get("href"),
            "value": obj.get("value"),
