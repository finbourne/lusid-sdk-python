...
class ValuationPointResourceListOfAccountedComplexMarketData(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfAccountedComplexMarketData:
        ...
        if not isinstance(obj, dict):
            return ValuationPointResourceListOfAccountedComplexMarketData.parse_obj(obj)

        _obj = ValuationPointResourceListOfAccountedComplexMarketData.parse_obj({
            ...
            "values": [AccountedComplexMarketData.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfAccountedComplexMarketData.update_forward_refs()
