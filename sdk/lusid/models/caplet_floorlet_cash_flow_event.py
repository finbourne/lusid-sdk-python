...
class CapletFloorletCashFlowEvent(InstrumentEvent):
    ...
    """
    entitlement_date: Optional[datetime] = Field(default=None, description="Ex-Dividend / entitlement date of the cashflow payment.  Required field.", alias="entitlementDate")
    payment_date: Optional[datetime] = Field(default=None, description="Payment date of the cashflow payment  Required field.", alias="paymentDate")
    currency:  StrictStr = Field(...,alias="currency", description="Currency of the cashflow payment") 
    cash_flow_per_unit: Union[StrictFloat, StrictInt] = Field(description="The total payment per unit of the held instrument, if entitled.  Not required.", alias="cashFlowPerUnit")
...
CapletFloorletCashFlowEvent.update_forward_refs()
