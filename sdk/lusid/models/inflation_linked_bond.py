...
class InflationLinkedBond(LusidInstrument):
    ...
    def to_dict(self):
        ...
        if self.amortisation_schedule:
            _dict['amortisationSchedule'] = self.amortisation_schedule.to_dict()
    ...
    def from_dict(cls, obj: dict) -> InflationLinkedBond:
        ...
        _obj = InflationLinkedBond.parse_obj({
            ...
            "amortisation_schedule": StepSchedule.from_dict(obj.get("amortisationSchedule")) if obj.get("amortisationSchedule") is not None else None
        })
