...
class InflationLinkedBond(LusidInstrument):
    ...
    __properties = ["instrumentType", "startDate", "maturityDate", "flowConventions", "couponRate", "identifiers", "domCcy", "baseCPI", "baseCPIDate", "calculationType", "exDividendDays", "indexPrecision", "inflationIndexName", "inflationInterpolation", "inflationRollDay", "observationLag", "principal", "principalProtection", "stubType"]
