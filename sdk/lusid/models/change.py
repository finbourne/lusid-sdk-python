...
class Change(object):
    ...
    openapi_types = {
        ...
        'correction_as_at': 'object',
        'amended': 'bool',
        'amendment_effective_at': 'datetime',
        'amendment_as_at': 'object',
        'links': 'list[Link]'
    }
