...
class RecDefRecipeIds(BaseModel):
    """
    RecDefRecipeIds
    """
    left: ResourceId
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecDefRecipeIds:
        """Create an instance of RecDefRecipeIds from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecDefRecipeIds:
        """Create an instance of RecDefRecipeIds from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecDefRecipeIds.parse_obj(obj)

        _obj = RecDefRecipeIds.parse_obj({
...
RecDefRecipeIds.update_forward_refs()
