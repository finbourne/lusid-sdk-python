...
class MbsPrincipalWriteOffEvent(InstrumentEvent):
    ...
    """
    ex_date: Optional[datetime] = Field(default=None, description="The ex date (entitlement date) of the principal payment, usually several weeks prior to the payment date", alias="exDate")
    payment_date: Optional[datetime] = Field(default=None, description="The payment date of the principal that is written off", alias="paymentDate")
    currency:  StrictStr = Field(...,alias="currency", description="The currency in which the principal write off is notated") 
    principal_per_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The principal amount to be written off for each unit of the instrument held on the ex date", alias="principalPerUnit")
    ...
    def instrument_event_type_validate_enum(cls, value):
        ...
        if 'MbsPrincipalWriteOffEvent' not in [ 
...
MbsPrincipalWriteOffEvent.update_forward_refs()
