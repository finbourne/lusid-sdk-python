...
class ExoticInstrumentAllOf(BaseModel):
    """
    ...
    __properties = ["instrumentFormat", "content", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExoticInstrumentAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExoticInstrumentAllOf:
        """Create an instance of ExoticInstrumentAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExoticInstrumentAllOf.parse_obj(obj)

        _obj = ExoticInstrumentAllOf.parse_obj({
