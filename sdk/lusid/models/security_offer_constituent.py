...
class SecurityOfferConstituent(BaseModel):
    ...
    __properties = ["newInstrument", "unitsRatio", "settlementDate", "minPieceSize", "minIncrement"]
    ...
    def from_dict(cls, obj: dict) -> SecurityOfferConstituent:
        ...
        if not isinstance(obj, dict):
            return SecurityOfferConstituent.parse_obj(obj)

        _obj = SecurityOfferConstituent.parse_obj({
...
SecurityOfferConstituent.update_forward_refs()
