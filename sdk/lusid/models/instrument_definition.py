...
class InstrumentDefinition(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> InstrumentDefinition:
        ...
        _obj = InstrumentDefinition.parse_obj({
            "name": obj.get("name"),
            "identifiers": {k: None if v is None else {ik: InstrumentIdValue.from_dict(iv) for ik, iv in v.items()} for k, v in obj.get("identifiers").items()} if obj.get("identifiers") is not None else None,
