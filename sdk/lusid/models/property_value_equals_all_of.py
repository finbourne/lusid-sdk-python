...
class PropertyValueEqualsAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PropertyValueEqualsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PropertyValueEqualsAllOf:
        """Create an instance of PropertyValueEqualsAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PropertyValueEqualsAllOf.parse_obj(obj)

        _obj = PropertyValueEqualsAllOf.parse_obj({
