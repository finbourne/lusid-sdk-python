...
class CustomDataModelPropertySpecification(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomDataModelPropertySpecification:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomDataModelPropertySpecification:
        """Create an instance of CustomDataModelPropertySpecification from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomDataModelPropertySpecification.parse_obj(obj)

        _obj = CustomDataModelPropertySpecification.parse_obj({
            "property_key": obj.get("propertyKey"),
            "required": obj.get("required")
        })
        return _obj

CustomDataModelPropertySpecification.update_forward_refs()
