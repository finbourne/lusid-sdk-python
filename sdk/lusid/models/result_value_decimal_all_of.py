...
class ResultValueDecimalAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultValueDecimalAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultValueDecimalAllOf:
        """Create an instance of ResultValueDecimalAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultValueDecimalAllOf.parse_obj(obj)

        _obj = ResultValueDecimalAllOf.parse_obj({
            "value": obj.get("value"),
