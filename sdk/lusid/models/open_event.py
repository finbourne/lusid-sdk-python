...
class OpenEvent(InstrumentEvent):
    ...
    """
    anchor_date: Optional[datetime] = Field(default=None, description="The date on the which the instrument was opened.", alias="anchorDate")
