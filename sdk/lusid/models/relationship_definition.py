...
class RelationshipDefinition(object):
    ...
    def life_time(self, life_time):
        ...
        if (self.local_vars_configuration.client_side_validation and
                life_time is not None and len(life_time) < 1):
    ...
    def relationship_cardinality(self, relationship_cardinality):
        ...
        if (self.local_vars_configuration.client_side_validation and
                relationship_cardinality is not None and len(relationship_cardinality) < 1):
            raise ValueError("Invalid value for `relationship_cardinality`, length must be greater than or equal to `1`")  # noqa: E501
