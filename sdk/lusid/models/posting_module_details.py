...
class PostingModuleDetails(BaseModel):
    ...
    status:  StrictStr = Field(...,alias="status", description="The Posting Module status. Default value: Active. Available values: Active, Inactive.") 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostingModuleDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostingModuleDetails:
        """Create an instance of PostingModuleDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostingModuleDetails.parse_obj(obj)
...
PostingModuleDetails.update_forward_refs()
