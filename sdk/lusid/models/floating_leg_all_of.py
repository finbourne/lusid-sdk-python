...
class FloatingLegAllOf(BaseModel):
    """
    FloatingLegAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FloatingLegAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FloatingLegAllOf:
        """Create an instance of FloatingLegAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FloatingLegAllOf.parse_obj(obj)

        _obj = FloatingLegAllOf.parse_obj({
