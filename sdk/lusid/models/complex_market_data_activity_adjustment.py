...
class ComplexMarketDataActivityAdjustment(NavActivityAdjustmentResponse):
    ...
    __properties = ["navActivityAdjustmentType", "navActivityAdjustmentSource", "asAt", "effectiveAt", "entityUniqueId"]
    ...
    def from_dict(cls, obj: dict) -> ComplexMarketDataActivityAdjustment:
        ...
        if not isinstance(obj, dict):
            return ComplexMarketDataActivityAdjustment.parse_obj(obj)

        _obj = ComplexMarketDataActivityAdjustment.parse_obj({
...
ComplexMarketDataActivityAdjustment.update_forward_refs()
