...
class ValuationRequest(BaseModel):
    ...
    __properties = ["recipeId", "asAt", "metrics", "groupBy", "filters", "sort", "reportCurrency", "equipWithSubtotals", "returnResultAsExpandedTypes", "portfolioEntityIds", "valuationSchedule", "marketDataOverrides"]
    ...
    def from_dict(cls, obj: dict) -> ValuationRequest:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ValuationRequest) in the input: " + obj)
