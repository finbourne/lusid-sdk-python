...
class ReconcileStringRuleAllOf(BaseModel):
    """
    ...
    __properties = ["comparisonType", "oneOfCandidates", "appliesTo", "ruleType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReconcileStringRuleAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReconcileStringRuleAllOf:
        """Create an instance of ReconcileStringRuleAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReconcileStringRuleAllOf.parse_obj(obj)

        _obj = ReconcileStringRuleAllOf.parse_obj({
