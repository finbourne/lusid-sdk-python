...
class UpdateOrdersResponse(BaseModel):
    ...
    values: Optional[Dict[str, Order]] = Field(default=None, description="The orders which have been successfully updated.")
    failed: Optional[Dict[str, ErrorDetail]] = Field(default=None, description="The orders that could not be updated, along with a reason for their failure.")
...
UpdateOrdersResponse.update_forward_refs()
