...
class FxForwardAllOf(BaseModel):
    """
    FxForwardAllOf
    """
    ...
    __properties = ["startDate", "maturityDate", "domAmount", "domCcy", "fgnAmount", "fgnCcy", "refSpotRate", "isNdf", "fixingDate", "settlementCcy", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FxForwardAllOf:
        """Create an instance of FxForwardAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FxForwardAllOf:
        """Create an instance of FxForwardAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FxForwardAllOf.parse_obj(obj)

        _obj = FxForwardAllOf.parse_obj({
