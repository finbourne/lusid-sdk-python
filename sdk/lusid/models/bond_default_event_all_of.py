...
class BondDefaultEventAllOf(BaseModel):
    """
    ...
    __properties = ["amount", "couponPaidDate", "defaultStatus", "defaultType", "graceEndDate", "paymentDate", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BondDefaultEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BondDefaultEventAllOf:
        """Create an instance of BondDefaultEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BondDefaultEventAllOf.parse_obj(obj)

        _obj = BondDefaultEventAllOf.parse_obj({
