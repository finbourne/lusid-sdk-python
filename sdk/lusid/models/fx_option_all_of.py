...
class FxOptionAllOf(BaseModel):
    ...
    __properties = ["startDate", "domCcy", "domAmount", "fgnCcy", "fgnAmount", "strike", "barriers", "exerciseType", "isCallNotPut", "isDeliveryNotCash", "isPayoffDigital", "optionMaturityDate", "optionSettlementDate", "payoutStyle", "premium", "touches", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FxOptionAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FxOptionAllOf:
        """Create an instance of FxOptionAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FxOptionAllOf.parse_obj(obj)

        _obj = FxOptionAllOf.parse_obj({
