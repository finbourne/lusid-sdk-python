...
class ComplianceParameter(object):
    ...
    def parameter_type(self, parameter_type):
        ...
        if self.local_vars_configuration.client_side_validation and parameter_type not in allowed_values:  # noqa: E501
            raise ValueError(
