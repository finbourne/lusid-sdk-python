...
class Order(BaseModel):
    ...
    basis:  Optional[StrictStr] = Field(None,alias="basis", description="The measure in which the order was instructed. Expected values are 'Quantity', 'Amount' or 'Weight'; null when the order carries no size measure. Read-only; derived from the populated size measures, taking quantity first, then amount, then weight.") 
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.derived_compliance_state is None and "derived_compliance_state" in self.__fields_set__:
