...
class Order(object):
    ...
    def __init__(self, properties=None, version=None, instrument_identifiers=None, quantity=None, side=None, order_book_id=None, portfolio_id=None, id=None, lusid_instrument_id=None, state=None, type=None, time_in_force=None, date=None, price=None, order_instruction_id=None, package_id=None, links=None):  # noqa: E501
        """
