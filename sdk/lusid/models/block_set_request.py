...
class BlockSetRequest(BaseModel):
    ...
    """
    requests: Optional[conlist(BlockRequest)] = Field(None, description="A collection of BlockRequests.")
    ...
    def from_dict(cls, obj: dict) -> BlockSetRequest:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BlockSetRequest) in the input: " + obj)
