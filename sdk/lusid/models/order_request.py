...
class OrderRequest(object):
    ...
    def __init__(self, properties=None, instrument_identifiers=None, quantity=None, side=None, order_book_id=None, portfolio_id=None, id=None, state=None, type=None, time_in_force=None, date=None, price=None, order_instruction=None, package=None):  # noqa: E501
        """
