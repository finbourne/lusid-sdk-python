...
class PropertyKeyComplianceParameter(object):
    ...
    def __init__(self, value=None, compliance_parameter_type=None, local_vars_configuration=None):  # noqa: E501
        """PropertyKeyComplianceParameter - a model defined in OpenAPI"
        
        :param value:  The key that uniquely identifies the property. It has the format {domain}/{scope}/{code}. (required)
        :type value: str
    ...
    @property
    def value(self):
        """Gets the value of this PropertyKeyComplianceParameter.  # noqa: E501

        The key that uniquely identifies the property. It has the format {domain}/{scope}/{code}.  # noqa: E501

        :return: The value of this PropertyKeyComplianceParameter.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this PropertyKeyComplianceParameter.

        The key that uniquely identifies the property. It has the format {domain}/{scope}/{code}.  # noqa: E501

        :param value: The value of this PropertyKeyComplianceParameter.  # noqa: E501
        :type value: str
        """
    ...
    def compliance_parameter_type(self):
        """Gets the compliance_parameter_type of this PropertyKeyComplianceParameter.  # noqa: E501
        ...
        :return: The compliance_parameter_type of this PropertyKeyComplianceParameter.  # noqa: E501
        :rtype: str
        """
    ...
    def compliance_parameter_type(self, compliance_parameter_type):
        """Sets the compliance_parameter_type of this PropertyKeyComplianceParameter.

        The parameter type. The available values are: BoolComplianceParameter, StringComplianceParameter, DecimalComplianceParameter, DateTimeComplianceParameter, PropertyKeyComplianceParameter, AddressKeyComplianceParameter, PortfolioIdComplianceParameter, PortfolioGroupIdComplianceParameter, StringListComplianceParameter, BoolListComplianceParameter, DateTimeListComplianceParameter, DecimalListComplianceParameter, PropertyKeyListComplianceParameter, AddressKeyListComplianceParameter, PortfolioIdListComplianceParameter, PortfolioGroupIdListComplianceParameter  # noqa: E501

        :param compliance_parameter_type: The compliance_parameter_type of this PropertyKeyComplianceParameter.  # noqa: E501
        :type compliance_parameter_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PropertyKeyComplianceParameter):
            return False
