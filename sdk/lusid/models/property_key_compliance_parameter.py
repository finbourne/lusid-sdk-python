...
class PropertyKeyComplianceParameter(ComplianceParameter):
    """
    PropertyKeyComplianceParameter
    """
    value:  StrictStr = Field(...,alias="value", description="The key that uniquely identifies the property. It has the format {domain}/{scope}/{code}.") 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PropertyKeyComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PropertyKeyComplianceParameter:
        """Create an instance of PropertyKeyComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PropertyKeyComplianceParameter.parse_obj(obj)

        _obj = PropertyKeyComplianceParameter.parse_obj({
...
PropertyKeyComplianceParameter.update_forward_refs()
