...
class PortfolioGroup(object):
    ...
    def __init__(self, href=None, id=None, display_name=None, description=None, portfolios=None, sub_groups=None, version=None, links=None):  # noqa: E501
        """PortfolioGroup - a model defined in OpenAPI"""  # noqa: E501
