...
class CallOnIntermediateSecuritiesEvent(InstrumentEvent):
    ...
    """
    expiry_date: Optional[datetime] = Field(default=None, description="The date on which the issue ends.", alias="expiryDate")
    ...
    option_exercise_elections: Optional[List[OptionExerciseElection]] = Field(default=None, description="Option exercise election for this event.", alias="optionExerciseElections")
    lapse_elections: Optional[List[LapseElection]] = Field(default=None, description="Lapse election for this event.", alias="lapseElections")
    oversubscribe_elections: Optional[List[OversubscribeElection]] = Field(default=None, description="List of possible oversubscribe elections for this event (OVER) — subscribe for more than the entitled amount.", alias="oversubscribeElections")
    sell_entitlement_elections: Optional[List[SellEntitlementElection]] = Field(default=None, description="List of possible sell-entitlement elections for this event (SLLE) — sell the intermediate securities rather than exercise.", alias="sellEntitlementElections")
    ...
    __properties = ["instrumentEventType", "expiryDate", "paymentDate", "newInstrument", "unitsRatio", "price", "exerciseCurrency", "optionExerciseElections", "lapseElections", "oversubscribeElections", "sellEntitlementElections", "unknownProceedsElections"]
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in oversubscribe_elections (list)
        _items = []
        if self.oversubscribe_elections:
            for _item in self.oversubscribe_elections:
                if _item:
                    _items.append(_item.to_dict())
            _dict['oversubscribeElections'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in sell_entitlement_elections (list)
        _items = []
        if self.sell_entitlement_elections:
            for _item in self.sell_entitlement_elections:
                if _item:
                    _items.append(_item.to_dict())
            _dict['sellEntitlementElections'] = _items
        ...
        # set to None if oversubscribe_elections (nullable) is None
        # and __fields_set__ contains the field
        if self.oversubscribe_elections is None and "oversubscribe_elections" in self.__fields_set__:
            _dict['oversubscribeElections'] = None

        # set to None if sell_entitlement_elections (nullable) is None
        # and __fields_set__ contains the field
        if self.sell_entitlement_elections is None and "sell_entitlement_elections" in self.__fields_set__:
            _dict['sellEntitlementElections'] = None
    ...
    def from_dict(cls, obj: dict) -> CallOnIntermediateSecuritiesEvent:
        ...
        _obj = CallOnIntermediateSecuritiesEvent.parse_obj({
            ...
            "oversubscribe_elections": [OversubscribeElection.from_dict(_item) for _item in obj.get("oversubscribeElections")] if obj.get("oversubscribeElections") is not None else None,
            "sell_entitlement_elections": [SellEntitlementElection.from_dict(_item) for _item in obj.get("sellEntitlementElections")] if obj.get("sellEntitlementElections") is not None else None,
...
CallOnIntermediateSecuritiesEvent.update_forward_refs()
