...
class ResultValueIntAllOf(BaseModel):
    """
    ResultValueIntAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultValueIntAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultValueIntAllOf:
        """Create an instance of ResultValueIntAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultValueIntAllOf.parse_obj(obj)

        _obj = ResultValueIntAllOf.parse_obj({
            "value": obj.get("value"),
