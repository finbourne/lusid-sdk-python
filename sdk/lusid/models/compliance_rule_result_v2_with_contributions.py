...
class ComplianceRuleResultV2WithContributions(BaseModel):
    """
    ...
    rule_result: ComplianceSummaryRuleResultWithContributions = Field(alias="ruleResult")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ComplianceRuleResultV2WithContributions:
        """Create an instance of ComplianceRuleResultV2WithContributions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ComplianceRuleResultV2WithContributions:
        """Create an instance of ComplianceRuleResultV2WithContributions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ComplianceRuleResultV2WithContributions.parse_obj(obj)

        _obj = ComplianceRuleResultV2WithContributions.parse_obj({
            ...
            "rule_result": ComplianceSummaryRuleResultWithContributions.from_dict(obj.get("ruleResult")) if obj.get("ruleResult") is not None else None
        })
        return _obj

ComplianceRuleResultV2WithContributions.update_forward_refs()
