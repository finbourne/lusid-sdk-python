...
class FxForwardPipsCurveDataAllOf(BaseModel):
    """
    ...
    __properties = ["baseDate", "domCcy", "fgnCcy", "dates", "pipRates", "lineage", "marketDataOptions", "marketDataType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FxForwardPipsCurveDataAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FxForwardPipsCurveDataAllOf:
        """Create an instance of FxForwardPipsCurveDataAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FxForwardPipsCurveDataAllOf.parse_obj(obj)

        _obj = FxForwardPipsCurveDataAllOf.parse_obj({
