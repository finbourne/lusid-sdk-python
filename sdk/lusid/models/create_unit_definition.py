...
class CreateUnitDefinition(BaseModel):
    ...
    """
    code: constr(strict=True, max_length=64, min_length=1) = ...
    ...
    def from_dict(cls, obj: dict) -> CreateUnitDefinition:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateUnitDefinition) in the input: " + obj)
