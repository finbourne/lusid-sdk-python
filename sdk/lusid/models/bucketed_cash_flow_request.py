...
class BucketedCashFlowRequest(BaseModel):
    ...
    __properties = ["roundingMethod", "bucketingDates", "bucketTenors", "effectiveAt", "windowStart", "windowEnd", "recipeId", "reportCurrency", "groupBy", "addresses", "equipWithSubtotals", "asAt", "excludeUnsettledTrades"]
    ...
    def from_dict(cls, obj: dict) -> BucketedCashFlowRequest:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BucketedCashFlowRequest) in the input: " + obj)
