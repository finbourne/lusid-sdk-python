...
class FloatSchedule(Schedule):
    ...
    reset_convention:  Optional[StrictStr] = Field(None,alias="resetConvention", description="Control how resets are generated relative to payment convention(s).    Default value: InAdvance. Available values: InAdvance, InArrears.") 
