...
class FloatSchedule(Schedule):
    ...
    __properties = ["scheduleType", "startDate", "maturityDate", "flowConventions", "conventionName", "indexConventionName", "indexConventions", "notional", "paymentCurrency", "spread", "stubType"]
