...
class UpsertSubscriptionRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpsertSubscriptionRequest:
        ...
        if not isinstance(obj, dict):
            return UpsertSubscriptionRequest.parse_obj(obj)

        _obj = UpsertSubscriptionRequest.parse_obj({
            "subscription": SubscriptionDefinition.from_dict(obj.get("subscription")) if obj.get("subscription") is not None else None
        })
        return _obj

UpsertSubscriptionRequest.update_forward_refs()
