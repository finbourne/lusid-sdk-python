...
class ListAggregationReconciliation(BaseModel):
    ...
    diff: Optional[conlist(Dict[str, Dict[str, Any]])] = None
    ...
    def from_dict(cls, obj: dict) -> ListAggregationReconciliation:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ListAggregationReconciliation) in the input: " + obj)
