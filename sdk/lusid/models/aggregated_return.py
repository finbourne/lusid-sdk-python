...
class AggregatedReturn(BaseModel):
    ...
    __properties = ["effectiveAt", "endOfPeriod", "openingMarketValue", "closingMarketValue", "metricsValue", "frequency", "compositeMembers", "compositeMembersWithoutReturn"]
    ...
    def from_dict(cls, obj: dict) -> AggregatedReturn:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AggregatedReturn) in the input: " + obj)
