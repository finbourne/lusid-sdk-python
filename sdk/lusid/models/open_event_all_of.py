...
class OpenEventAllOf(BaseModel):
    """
    OpenEventAllOf
    """
    ...
    __properties = ["anchorDate", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpenEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpenEventAllOf:
        """Create an instance of OpenEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpenEventAllOf.parse_obj(obj)

        _obj = OpenEventAllOf.parse_obj({
