...
class UpdateDepositAmountEvent(InstrumentEvent):
    ...
    """
    var_date: Optional[datetime] = Field(default=None, description="The date of the adjustment to the deposit.", alias="date")
...
UpdateDepositAmountEvent.update_forward_refs()
