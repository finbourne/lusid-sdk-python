...
class RealisedGainLoss(BaseModel):
    ...
    instrument_uid: constr(strict=True, min_length=1) = Field(..., alias="instrumentUid", description="The unqiue Lusid Instrument Id (LUID) of the instrument that this gain or loss is associated with.")
    ...
    def from_dict(cls, obj: dict) -> RealisedGainLoss:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in RealisedGainLoss) in the input: " + obj)
