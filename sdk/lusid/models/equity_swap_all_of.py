...
class EquitySwapAllOf(BaseModel):
    """
    EquitySwapAllOf
    """
    ...
    __properties = ["startDate", "maturityDate", "code", "equityFlowConventions", "fundingLeg", "includeDividends", "initialPrice", "notionalReset", "quantity", "underlyingIdentifier", "equitySwapDividendPaymentTiming", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EquitySwapAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EquitySwapAllOf:
        """Create an instance of EquitySwapAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EquitySwapAllOf.parse_obj(obj)

        _obj = EquitySwapAllOf.parse_obj({
