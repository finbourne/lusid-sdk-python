...
class CloseEvent(InstrumentEvent):
    ...
    """
    start_date: Optional[datetime] = Field(default=None, description="The first date on which the instrument could close", alias="startDate")
    end_date: Optional[datetime] = Field(default=None, description="The last date on which the instrument could close", alias="endDate")
...
CloseEvent.update_forward_refs()
