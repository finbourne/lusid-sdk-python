...
class QueryableKey(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(None,alias="description", description="What does the information that is being queried by the address mean. What is the address for.") 
