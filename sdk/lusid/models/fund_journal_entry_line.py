...
class FundJournalEntryLine(BaseModel):
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.share_class_breakdowns is None and "share_class_breakdowns" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> FundJournalEntryLine:
        ...
        if not isinstance(obj, dict):
            return FundJournalEntryLine.parse_obj(obj)

        _obj = FundJournalEntryLine.parse_obj({
