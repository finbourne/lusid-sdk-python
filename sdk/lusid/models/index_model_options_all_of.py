...
class IndexModelOptionsAllOf(BaseModel):
    """
    ...
    __properties = ["portfolioScaling", "modelOptionsType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IndexModelOptionsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IndexModelOptionsAllOf:
        """Create an instance of IndexModelOptionsAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IndexModelOptionsAllOf.parse_obj(obj)

        _obj = IndexModelOptionsAllOf.parse_obj({
