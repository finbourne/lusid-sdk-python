...
class CurveOptionsAllOf(BaseModel):
    """
    CurveOptionsAllOf
    """
    ...
    __properties = ["dayCountConvention", "frontExtrapolationType", "backExtrapolationType", "marketDataOptionsType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurveOptionsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurveOptionsAllOf:
        """Create an instance of CurveOptionsAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurveOptionsAllOf.parse_obj(obj)

        _obj = CurveOptionsAllOf.parse_obj({
