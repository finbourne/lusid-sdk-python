...
class InformationalErrorEventAllOf(BaseModel):
    """
    ...
    __properties = ["errorDetail", "errorReason", "effectiveAt", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InformationalErrorEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InformationalErrorEventAllOf:
        """Create an instance of InformationalErrorEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InformationalErrorEventAllOf.parse_obj(obj)

        _obj = InformationalErrorEventAllOf.parse_obj({
