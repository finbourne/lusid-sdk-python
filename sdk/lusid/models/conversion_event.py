...
class ConversionEvent(InstrumentEvent):
    ...
    """
    record_date: Optional[datetime] = Field(default=None, description="Required.  Date at which positions are struck at the end of the day to  note which parties will receive the relevant amount of  entitlement, due to be distributed on the PaymentDate.", alias="recordDate")
    payment_date: Optional[datetime] = Field(default=None, description="Required. Date on which the movement is due to take place (cash and/or securities).", alias="paymentDate")
    new_instrument: NewInstrument = Field(alias="newInstrument")
    response_deadline_date: Optional[datetime] = Field(default=None, description="Date/time that the account servicer has set as the deadline to respond,  with instructions, to an outstanding event. Not required.", alias="responseDeadlineDate")
    market_deadline_date: Optional[datetime] = Field(default=None, description="Date/time which the issuer or issuer's agent has set as the deadline to respond,  with an instruction, to an outstanding offer or privilege. Not required.", alias="marketDeadlineDate")
    effective_date: Optional[datetime] = Field(default=None, description="Date which establishes when the conversion is recognised.", alias="effectiveDate")
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.unknown_proceeds_elections is None and "unknown_proceeds_elections" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> ConversionEvent:
        ...
        _obj = ConversionEvent.parse_obj({
            ...
            "unknown_proceeds_elections": [UnknownProceedsElection.from_dict(_item) for _item in obj.get("unknownProceedsElections")] if obj.get("unknownProceedsElections") is not None else None,
...
ConversionEvent.update_forward_refs()
