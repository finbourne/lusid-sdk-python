...
class UpsertInvestorRecordsResponse(BaseModel):
    ...
    values: Optional[Dict[str, InvestorRecord]] = Field(default=None, description="The investor records which have been successfully updated or created.")
    failed: Optional[Dict[str, ErrorDetail]] = Field(default=None, description="The investor records that could not be updated or created or were left unchanged without error along with a reason for their failure.")
...
UpsertInvestorRecordsResponse.update_forward_refs()
