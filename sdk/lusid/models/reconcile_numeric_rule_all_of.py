...
class ReconcileNumericRuleAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReconcileNumericRuleAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReconcileNumericRuleAllOf:
        """Create an instance of ReconcileNumericRuleAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReconcileNumericRuleAllOf.parse_obj(obj)

        _obj = ReconcileNumericRuleAllOf.parse_obj({
