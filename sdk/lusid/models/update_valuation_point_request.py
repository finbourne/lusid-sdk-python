...
class UpdateValuationPointRequest(BaseModel):
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.apply_clear_down is None and "apply_clear_down" in self.__fields_set__:
            _dict['applyClearDown'] = None

        # set to None if update_inclusion_date_nav_adjustments (nullable) is None
        # and __fields_set__ contains the field
        if self.update_inclusion_date_nav_adjustments is None and "update_inclusion_date_nav_adjustments" in self.__fields_set__:
