...
class UpsertLegalEntityAccessMetadataRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpsertLegalEntityAccessMetadataRequest:
        ...
        if not isinstance(obj, dict):
            return UpsertLegalEntityAccessMetadataRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpsertLegalEntityAccessMetadataRequest) in the input: " + obj)

        _obj = UpsertLegalEntityAccessMetadataRequest.parse_obj({
