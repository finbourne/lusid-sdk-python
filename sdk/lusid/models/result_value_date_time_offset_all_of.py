...
class ResultValueDateTimeOffsetAllOf(BaseModel):
    """
    ...
    __properties = ["value", "dimension", "resultValueType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultValueDateTimeOffsetAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultValueDateTimeOffsetAllOf:
        """Create an instance of ResultValueDateTimeOffsetAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultValueDateTimeOffsetAllOf.parse_obj(obj)

        _obj = ResultValueDateTimeOffsetAllOf.parse_obj({
            "value": obj.get("value"),
