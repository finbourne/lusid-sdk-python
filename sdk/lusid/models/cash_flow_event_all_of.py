...
class CashFlowEventAllOf(BaseModel):
    """
    CashFlowEventAllOf
    """
    ...
    __properties = ["cashFlowValue", "eventType", "eventStatus", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashFlowEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashFlowEventAllOf:
        """Create an instance of CashFlowEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CashFlowEventAllOf.parse_obj(obj)

        _obj = CashFlowEventAllOf.parse_obj({
