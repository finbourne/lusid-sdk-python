...
class EarlyCloseOutEvent(InstrumentEvent):
    """
    Early close out event - Ending an OTC instrument early.  # noqa: E501
    """
    close_out_amount: Union[StrictFloat, StrictInt] = Field(description="The amount to be closed out early. Required. Must be strictly positive.", alias="closeOutAmount")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarlyCloseOutEvent:
        """Create an instance of EarlyCloseOutEvent from a JSON string"""
    ...
    def to_dict(self):
        ...
        # set to None if close_out_to_other_rate (nullable) is None
        ...
        if self.other_amount is None and "other_amount" in self.__fields_set__:
            _dict['otherAmount'] = None

        # set to None if other_ccy (nullable) is None
        # and __fields_set__ contains the field
        if self.other_ccy is None and "other_ccy" in self.__fields_set__:
            _dict['otherCcy'] = None

        # set to None if other_to_close_out_rate (nullable) is None
        # and __fields_set__ contains the field
        if self.other_to_close_out_rate is None and "other_to_close_out_rate" in self.__fields_set__:
            _dict['otherToCloseOutRate'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> EarlyCloseOutEvent:
        """Create an instance of EarlyCloseOutEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarlyCloseOutEvent.parse_obj(obj)

        _obj = EarlyCloseOutEvent.parse_obj({
            "instrument_event_type": obj.get("instrumentEventType"),
            "close_out_amount": obj.get("closeOutAmount"),
...
EarlyCloseOutEvent.update_forward_refs()
