...
class FxForwardTenorPipsCurveDataAllOf(BaseModel):
    """
    ...
    __properties = ["baseDate", "domCcy", "fgnCcy", "tenors", "pipRates", "lineage", "marketDataOptions", "calendars", "spotDaysCalculationType", "marketDataType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FxForwardTenorPipsCurveDataAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FxForwardTenorPipsCurveDataAllOf:
        """Create an instance of FxForwardTenorPipsCurveDataAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FxForwardTenorPipsCurveDataAllOf.parse_obj(obj)

        _obj = FxForwardTenorPipsCurveDataAllOf.parse_obj({
