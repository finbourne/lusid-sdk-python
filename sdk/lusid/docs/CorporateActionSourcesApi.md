...
> UpsertCorporateActionsResponse batch_upsert_corporate_actions(scope, code, create_corporate_action=create_corporate_action)
...
create_corporate_action = NULL # list[CreateCorporateAction] | The corporate action definitions (optional)

try:
    # Upsert corporate actions
    api_response = api_instance.batch_upsert_corporate_actions(scope, code, create_corporate_action=create_corporate_action)
    pprint(api_response)
 ...
 **create_corporate_action** | [**list[CreateCorporateAction]**](list.md)| The corporate action definitions | [optional] 
...
# create an instance of the API class
api_instance = lusid.CorporateActionSourcesApi(lusid.ApiClient(configuration))
create_corporate_action_source_request = lusid.CreateCorporateActionSourceRequest() # CreateCorporateActionSourceRequest | The corporate action source definition
