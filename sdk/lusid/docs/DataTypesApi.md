...
create_data_type_request = lusid.CreateDataTypeRequest() # CreateDataTypeRequest | The definition of the new data type (optional)
...
scope = 'scope_example' # str | The scope of the data type
code = 'code_example' # str | The code of the data type
update_data_type_request = lusid.UpdateDataTypeRequest() # UpdateDataTypeRequest | The updated definition of the data type (optional)
