...
> AddTransactionPropertyResponse add_transaction_property(scope, code, transaction_id, request_body=request_body)
...
request_body = {'key': lusid.PerpetualPropertyValue()} # dict(str, PerpetualPropertyValue) | Transaction properties values (optional)

try:
    # Add transaction properties
    api_response = api_instance.add_transaction_property(scope, code, transaction_id, request_body=request_body)
    pprint(api_response)
 ...
 **request_body** | [**dict(str, PerpetualPropertyValue)**](PerpetualPropertyValue.md)| Transaction properties values | [optional] 
...
# **adjust_holdings**
> AdjustHolding adjust_holdings(scope, code, effective_at, adjust_holding_request=adjust_holding_request)
...
adjust_holding_request = NULL # list[AdjustHoldingRequest] | The selected set of holdings adjustments (optional)

try:
    # Adjust holdings
    api_response = api_instance.adjust_holdings(scope, code, effective_at, adjust_holding_request=adjust_holding_request)
    pprint(api_response)
except ApiException as e:
 ...
 **adjust_holding_request** | [**list[AdjustHoldingRequest]**](list.md)| The selected set of holdings adjustments | [optional] 
...
# **build_transactions**
> VersionedResourceListOfOutputTransaction build_transactions(scope, code, as_at=as_at, sort_by=sort_by, start=start, limit=limit, instrument_property_keys=instrument_property_keys, filter=filter, transaction_query_parameters=transaction_query_parameters)
...
transaction_query_parameters = lusid.TransactionQueryParameters() # TransactionQueryParameters | Optional. Transaction query parameters (optional)

try:
    # Build output transactions
    api_response = api_instance.build_transactions(scope, code, as_at=as_at, sort_by=sort_by, start=start, limit=limit, instrument_property_keys=instrument_property_keys, filter=filter, transaction_query_parameters=transaction_query_parameters)
    pprint(api_response)
except ApiException as e:
 ...
 **transaction_query_parameters** | [**TransactionQueryParameters**](TransactionQueryParameters.md)| Optional. Transaction query parameters | [optional] 
...
# **create_portfolio**
> Portfolio create_portfolio(scope, create_transaction_portfolio_request=create_transaction_portfolio_request)
...
create_transaction_portfolio_request = lusid.CreateTransactionPortfolioRequest() # CreateTransactionPortfolioRequest | The transaction portfolio definition (optional)

try:
    # Create transaction portfolio
    api_response = api_instance.create_portfolio(scope, create_transaction_portfolio_request=create_transaction_portfolio_request)
    pprint(api_response)
except ApiException as e:
 ...
 **create_transaction_portfolio_request** | [**CreateTransactionPortfolioRequest**](CreateTransactionPortfolioRequest.md)| The transaction portfolio definition | [optional] 
...
# **set_holdings**
> AdjustHolding set_holdings(scope, code, effective_at, adjust_holding_request=adjust_holding_request)
...
effective_at = '2013-10-20T19:20:30+01:00' # datetime | The effective date of the change
adjust_holding_request = NULL # list[AdjustHoldingRequest] | The complete set of holdings adjustments for the portfolio (optional)

try:
    # Set all holdings on a transaction portfolio
    api_response = api_instance.set_holdings(scope, code, effective_at, adjust_holding_request=adjust_holding_request)
    pprint(api_response)
except ApiException as e:
 ...
 **effective_at** | **datetime**| The effective date of the change | 
 **adjust_holding_request** | [**list[AdjustHoldingRequest]**](list.md)| The complete set of holdings adjustments for the portfolio | [optional] 
...
scope = 'scope_example' # str | The scope of the portfolio
code = 'code_example' # str | The code of the portfolio
execution_request = NULL # list[ExecutionRequest] | The executions to be updated (optional)
 ...
 **scope** | **str**| The scope of the portfolio | 
 **code** | **str**| The code of the portfolio | 
 **execution_request** | [**list[ExecutionRequest]**](list.md)| The executions to be updated | [optional] 
...
> PortfolioDetails upsert_portfolio_details(scope, code, effective_at=effective_at, create_portfolio_details=create_portfolio_details)
...
create_portfolio_details = lusid.CreatePortfolioDetails() # CreatePortfolioDetails | The set of details for the portfolio (optional)

try:
    # Upsert details
    api_response = api_instance.upsert_portfolio_details(scope, code, effective_at=effective_at, create_portfolio_details=create_portfolio_details)
    pprint(api_response)
except ApiException as e:
 ...
 **create_portfolio_details** | [**CreatePortfolioDetails**](CreatePortfolioDetails.md)| The set of details for the portfolio | [optional] 
...
# **upsert_transactions**
> UpsertPortfolioTransactionsResponse upsert_transactions(scope, code, transaction_request=transaction_request)
...
transaction_request = NULL # list[TransactionRequest] | The transactions to be upserted (optional)

try:
    # Upsert transactions into the specified transaction portfolio
    api_response = api_instance.upsert_transactions(scope, code, transaction_request=transaction_request)
    pprint(api_response)
except ApiException as e:
 ...
 **transaction_request** | [**list[TransactionRequest]**](list.md)| The transactions to be upserted | [optional] 
