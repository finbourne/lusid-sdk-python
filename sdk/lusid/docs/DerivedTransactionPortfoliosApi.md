...
create_derived_transaction_portfolio_request = lusid.CreateDerivedTransactionPortfolioRequest() # CreateDerivedTransactionPortfolioRequest | The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope (optional)
...
effective_at = '2013-10-20T19:20:30+01:00' # datetime | The effective date of the change (optional)
 ...
 **effective_at** | **datetime**| The effective date of the change | [optional] 
