...
# **instruments_search**
> list[InstrumentMatch] instruments_search(mastered_effective_at=mastered_effective_at, mastered_only=mastered_only, instrument_search_property=instrument_search_property)
...
instrument_search_property = NULL # list[InstrumentSearchProperty] | A collection of instrument symbols to search for (optional)

try:
    # Search instruments
    api_response = api_instance.instruments_search(mastered_effective_at=mastered_effective_at, mastered_only=mastered_only, instrument_search_property=instrument_search_property)
    pprint(api_response)
 ...
 **instrument_search_property** | [**list[InstrumentSearchProperty]**](list.md)| A collection of instrument symbols to search for | [optional] 
