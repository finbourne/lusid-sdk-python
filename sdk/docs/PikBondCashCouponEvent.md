...
**coupon_per_unit** | **float** | The cash coupon amount per unit of the held bond&#39;s current face | [optional] 
...
pik_bond_cash_coupon_event_instance = PikBondCashCouponEvent(ex_date=ex_date, payment_date=payment_date, currency=currency, coupon_per_unit=coupon_per_unit, instrument_event_type=instrument_event_type)
