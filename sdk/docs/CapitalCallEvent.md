...
------------ | ------------- | ------------- | -------------
**var_date** | **datetime** | The date the capital call takes effect. | [optional] 
**amount** | **float** | The amount of committed capital called. Must be positive. | 
...
capital_call_event_instance = CapitalCallEvent(var_date=var_date, amount=amount, instrument_event_type=instrument_event_type)
