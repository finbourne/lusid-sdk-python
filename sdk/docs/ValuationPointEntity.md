...
**prevailing_valuation_point** | [**FundCalendarEntry**](FundCalendarEntry.md) |  | [optional] 
**deleted_valuation_point** | [**FundCalendarEntry**](FundCalendarEntry.md) |  | [optional] 
**previewed_status** | **str** | The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist. | [optional] 
**previewed_valuation_point** | [**FundCalendarEntry**](FundCalendarEntry.md) |  | [optional] 
...
prevailing_valuation_point: Optional[FundCalendarEntry] = # Replace with your value
deleted_valuation_point: Optional[FundCalendarEntry] = # Replace with your value
previewed_status: Optional[StrictStr] = "example_previewed_status"
previewed_valuation_point: Optional[FundCalendarEntry] = # Replace with your value
links: Optional[List[Link]] = None
valuation_point_entity_instance = ValuationPointEntity(href=href, entity_unique_id=entity_unique_id, as_at_version_number=as_at_version_number, status=status, as_at_deleted=as_at_deleted, user_id_deleted=user_id_deleted, request_id_deleted=request_id_deleted, effective_at_created=effective_at_created, prevailing_valuation_point=prevailing_valuation_point, deleted_valuation_point=deleted_valuation_point, previewed_status=previewed_status, previewed_valuation_point=previewed_valuation_point, links=links)
