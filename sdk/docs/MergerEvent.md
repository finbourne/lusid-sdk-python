...
**lapse_elections** | [**List[LapseElection]**](LapseElection.md) | List of possible lapse elections for this merger event (NOAC). | [optional] 
**unknown_proceeds_elections** | [**List[UnknownProceedsElection]**](UnknownProceedsElection.md) | List of possible unknown-proceeds elections for this merger event (UNKNOWN) — the outturn is not yet known. | [optional] 
