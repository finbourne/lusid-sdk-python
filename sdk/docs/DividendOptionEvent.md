...
dividend_option_event_instance = DividendOptionEvent(announcement_date=announcement_date, cash_elections=cash_elections, ex_date=ex_date, payment_date=payment_date, record_date=record_date, security_elections=security_elections, security_settlement_date=security_settlement_date, instrument_event_type=instrument_event_type)
