...
versioned_resource_list_of_fund_a2_b_movement_record_instance = VersionedResourceListOfFundA2BMovementRecord(version=version, values=values, href=href, next_page=next_page, previous_page=previous_page, links=links)
