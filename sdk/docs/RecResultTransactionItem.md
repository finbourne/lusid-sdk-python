...
rec_result_transaction_item_instance = RecResultTransactionItem(portfolio_id=portfolio_id, transaction_id=transaction_id, holding_impacts=holding_impacts, item_type=item_type, rule_and_attribute_values=rule_and_attribute_values)
