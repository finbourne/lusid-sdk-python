...
bond_all_of_instance = BondAllOf.from_json(json)
# print the JSON string representation of the object
print BondAllOf.to_json()

# convert the object into a dict
bond_all_of_dict = bond_all_of_instance.to_dict()
# create an instance of BondAllOf from a dict
bond_all_of_form_dict = bond_all_of.from_dict(bond_all_of_dict)
```
