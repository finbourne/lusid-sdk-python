...
paged_resource_list_of_order_instruction_instance = PagedResourceListOfOrderInstruction(next_page=next_page, previous_page=previous_page, values=values, href=href, links=links)
