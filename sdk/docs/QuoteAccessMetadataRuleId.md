...
quote_access_metadata_rule_id_instance = QuoteAccessMetadataRuleId(provider=provider, price_source=price_source, instrument_id=instrument_id, instrument_id_type=instrument_id_type, quote_type=quote_type, field=field)
