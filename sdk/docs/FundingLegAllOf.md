...
funding_leg_all_of_instance = FundingLegAllOf.from_json(json)
# print the JSON string representation of the object
print FundingLegAllOf.to_json()

# convert the object into a dict
funding_leg_all_of_dict = funding_leg_all_of_instance.to_dict()
# create an instance of FundingLegAllOf from a dict
funding_leg_all_of_form_dict = funding_leg_all_of.from_dict(funding_leg_all_of_dict)
```
