...
**values** | [**List[FundCashStatementRow]**](FundCashStatementRow.md) |  | 
**href** | **str** |  | [optional] 
...
valuation_point_resource_list_of_fund_cash_statement_row_instance = ValuationPointResourceListOfFundCashStatementRow(start_valuation_point=start_valuation_point, version=version, values=values, href=href, next_page=next_page, previous_page=previous_page, links=links)
