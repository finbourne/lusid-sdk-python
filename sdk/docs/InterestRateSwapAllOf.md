...
json = "{}"
# create an instance of InterestRateSwapAllOf from a JSON string
interest_rate_swap_all_of_instance = InterestRateSwapAllOf.from_json(json)
# print the JSON string representation of the object
print InterestRateSwapAllOf.to_json()

# convert the object into a dict
interest_rate_swap_all_of_dict = interest_rate_swap_all_of_instance.to_dict()
# create an instance of InterestRateSwapAllOf from a dict
interest_rate_swap_all_of_form_dict = interest_rate_swap_all_of.from_dict(interest_rate_swap_all_of_dict)
```
