...
**cash_and_security_offer_elections** | [**List[CashAndSecurityOfferElection]**](CashAndSecurityOfferElection.md) | List of possible CashAndSecurityOfferElections for this exchange offer event. | [optional] 
**consent_and_exchange_elections** | [**List[ConsentAndExchangeElection]**](ConsentAndExchangeElection.md) | List of possible consent-and-exchange elections for this event (CTEN-style consent paired with the exchange). | [optional] 
