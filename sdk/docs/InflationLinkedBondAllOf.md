...
inflation_linked_bond_all_of_instance = InflationLinkedBondAllOf.from_json(json)
# print the JSON string representation of the object
print InflationLinkedBondAllOf.to_json()

# convert the object into a dict
inflation_linked_bond_all_of_dict = inflation_linked_bond_all_of_instance.to_dict()
# create an instance of InflationLinkedBondAllOf from a dict
inflation_linked_bond_all_of_form_dict = inflation_linked_bond_all_of.from_dict(inflation_linked_bond_all_of_dict)
```
