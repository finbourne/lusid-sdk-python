...
allocation_group_class_instance = AllocationGroupClass(share_class_short_code=share_class_short_code, share_class_fund_id=share_class_fund_id, apportionment_factor=apportionment_factor, share_class_series_code=share_class_series_code)
