...
[**delete_definition**](CustomEntityDefinitionsApi.md#delete_definition) | **DELETE** /api/customentities/entitytypes/{entityType} | [EARLY ACCESS] DeleteDefinition: Delete a Custom Entity type definition.
...
# **delete_definition**
> DeletedEntityResponse delete_definition(entity_type)
...
def main():
    ...
    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.delete_definition(entity_type, opts=opts)

        # [EARLY ACCESS] DeleteDefinition: Delete a Custom Entity type definition.
        api_response = api_instance.delete_definition(entity_type)
        pprint(api_response)

    except ApiException as e:
        print("Exception when calling CustomEntityDefinitionsApi->delete_definition: %s\n" % e)
