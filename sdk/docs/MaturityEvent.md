...
------------ | ------------- | ------------- | -------------
**maturity_date** | **datetime** | Maturity date of the instrument | [optional] 
...
maturity_event_instance = MaturityEvent(maturity_date=maturity_date, instrument_event_type=instrument_event_type)
