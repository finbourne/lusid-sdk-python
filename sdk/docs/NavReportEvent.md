...
------------ | ------------- | ------------- | -------------
**var_date** | **datetime** | The date the net asset value is reported as of. | [optional] 
**net_asset_value** | **float** | The reported net asset value of the interest. | 
...
net_asset_value: Union[StrictFloat, StrictInt] = # Replace with your value
instrument_event_type: StrictStr = "example_instrument_event_type"
nav_report_event_instance = NavReportEvent(var_date=var_date, net_asset_value=net_asset_value, instrument_event_type=instrument_event_type)
