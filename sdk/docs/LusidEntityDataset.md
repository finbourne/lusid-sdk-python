...
**scope** | **str** | The scope of the entities to check. Required for scoped entity types (Instrument, Portfolio, InvestorRecord, InvestmentAccount).  Must not be provided for unscoped entity types (LegalEntity). | [optional] 
...
selector_attribute: Optional[StrictStr] = "example_selector_attribute"
selector_value: Optional[StrictStr] = "example_selector_value"
