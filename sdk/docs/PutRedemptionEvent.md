...
**retain_elections** | [**List[RetainElection]**](RetainElection.md) | List of possible retain elections for this event (PROX) — keep the holding rather than redeem. | [optional] 
