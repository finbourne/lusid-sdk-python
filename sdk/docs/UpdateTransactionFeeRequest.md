...
update_transaction_fee_request_instance = UpdateTransactionFeeRequest(description=description, calculation=calculation, condition=condition, txn_property_key=txn_property_key, properties=properties, is_active=is_active)
