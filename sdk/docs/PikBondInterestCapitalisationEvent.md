...
**coupon_per_unit** | **float** | The capitalised coupon amount per unit of the held bond&#39;s current face | [optional] 
...
pik_bond_interest_capitalisation_event_instance = PikBondInterestCapitalisationEvent(ex_date=ex_date, payment_date=payment_date, currency=currency, coupon_per_unit=coupon_per_unit, instrument_event_type=instrument_event_type)
