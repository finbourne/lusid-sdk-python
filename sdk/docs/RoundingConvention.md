...
**rounding_target** | **str** | The target of the rounding convention.    Default value: All. Available values: All, AccruedInterest, Cashflows. | [optional] 
**rounding_type** | **str** | The type of rounding.  Default value: Nearest. Available values: None, Down, Up, Nearest. | [optional] 
## Example
