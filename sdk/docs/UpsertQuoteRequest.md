...
upsert_quote_request_instance = UpsertQuoteRequest(quote_id=quote_id, metric_value=metric_value, lineage=lineage, scale_factor=scale_factor, metadata_fields=metadata_fields)
