...
def main():
    ...
    try:
        ...
        # api_response =  api_instance.list_entity_scopes(entity_type, as_at=as_at, page=page, limit=limit, opts=opts)
...
def main():
    ...
    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.list_scopes(filter=filter, opts=opts)
