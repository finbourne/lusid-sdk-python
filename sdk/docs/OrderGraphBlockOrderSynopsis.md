...
------------ | ------------- | ------------- | -------------
**quantity** | **float** | Total number of units ordered. | [optional] 
**quantity_by_state** | **Dict[str, float]** | Total number of units placed. | [optional] 
**amount** | **float** | Total monetary value ordered, in the block currency. | [optional] 
**amount_by_state** | **Dict[str, float]** | Total monetary value ordered, broken down by order state. | [optional] 
...
order_graph_block_order_synopsis_instance = OrderGraphBlockOrderSynopsis(quantity=quantity, quantity_by_state=quantity_by_state, amount=amount, amount_by_state=amount_by_state, details=details)
