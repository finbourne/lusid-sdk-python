...
**data_point_version** | [**DataPointVersion**](DataPointVersion.md) |  | [optional] 
## Example
...
data_point_version: Optional[DataPointVersion] = # Replace with your value
relational_data_point_response_instance = RelationalDataPointResponse(relational_dataset_definition_id=relational_dataset_definition_id, data_series=data_series, effective_at=effective_at, value_fields=value_fields, meta_data_fields=meta_data_fields, effective_at_entered=effective_at_entered, data_point_version=data_point_version)
