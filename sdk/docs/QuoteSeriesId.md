...
quote_series_id_instance = QuoteSeriesId(provider=provider, price_source=price_source, instrument_id=instrument_id, instrument_id_type=instrument_id_type, quote_type=quote_type, field=field)
