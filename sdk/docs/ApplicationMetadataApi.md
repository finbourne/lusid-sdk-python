...
[**get_latest_as_at**](ApplicationMetadataApi.md#get_latest_as_at) | **GET** /api/metadata/asat | [EXPERIMENTAL] GetLatestAsAt: Get latest AsAt
...
def main():
    ...
    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.get_latest_as_at(opts=opts)
        ...
        print("Exception when calling ApplicationMetadataApi->get_latest_as_at: %s\n" % e)
