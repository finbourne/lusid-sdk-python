...
fx_vol_surface_data_instance = FxVolSurfaceData(base_date=base_date, instruments=instruments, quotes=quotes, lineage=lineage, version=version, market_data_type=market_data_type)
