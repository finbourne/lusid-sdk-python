...
allocation_group_instance = AllocationGroup(classes=classes, name=name, description=description, share_class_short_code=share_class_short_code, apportionment_method_property=apportionment_method_property, formula=formula)
