...
funding_leg_model_options_instance = FundingLegModelOptions(expected_funding_leg_notional=expected_funding_leg_notional, model_options_type=model_options_type)
