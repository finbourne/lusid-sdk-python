...
create_series_identifier_field_instance = CreateSeriesIdentifierField(field_name=field_name, display_name=display_name, description=description, data_type_id=data_type_id)
