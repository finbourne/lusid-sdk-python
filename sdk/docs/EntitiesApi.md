...
[**get_valuation_point_by_entity_unique_id**](EntitiesApi.md#get_valuation_point_by_entity_unique_id) | **GET** /api/entities/valuationpoints/{entityUniqueId} | GetValuationPointByEntityUniqueId: Get valuation point by EntityUniqueId
...
> ComplianceRuleEntity get_compliance_rule_by_entity_unique_id(entity_unique_id, as_at=as_at, previews=previews)
...
def main():
    ...
    # Create an instance of the API class
    api_instance = api_client_factory.build(EntitiesApi)
    entity_unique_id = 'entity_unique_id_example' # str | The universally unique identifier of the compliance rule.
    as_at = '2013-10-20T19:20:30+01:00' # datetime | The asAt datetime at which to retrieve the compliance rule. Defaults to returning the latest version of the compliance rule if not specified. (optional)
    previews = ['previews_example'] # List[str] | The ids of the staged modifications to be previewed in the response. (optional)

    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.get_compliance_rule_by_entity_unique_id(entity_unique_id, as_at=as_at, previews=previews, opts=opts)
        ...
        print("Exception when calling EntitiesApi->get_compliance_rule_by_entity_unique_id: %s\n" % e)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **entity_unique_id** | **str**| The universally unique identifier of the compliance rule. | 
...
# **get_compliance_rule_template_by_entity_unique_id**
> ComplianceRuleTemplateEntity get_compliance_rule_template_by_entity_unique_id(entity_unique_id, as_at=as_at, previews=previews)
...
def main():
    ...
    # Create an instance of the API class
    api_instance = api_client_factory.build(EntitiesApi)
    entity_unique_id = 'entity_unique_id_example' # str | The universally unique identifier of the compliance rule template.
    as_at = '2013-10-20T19:20:30+01:00' # datetime | The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified. (optional)
    previews = ['previews_example'] # List[str] | The ids of the staged modifications to be previewed in the response. (optional)

    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.get_compliance_rule_template_by_entity_unique_id(entity_unique_id, as_at=as_at, previews=previews, opts=opts)

        # [EARLY ACCESS] GetComplianceRuleTemplateByEntityUniqueId: Get compliance rule template by EntityUniqueId
        api_response = api_instance.get_compliance_rule_template_by_entity_unique_id(entity_unique_id, as_at=as_at, previews=previews)
        pprint(api_response)

    except ApiException as e:
        print("Exception when calling EntitiesApi->get_compliance_rule_template_by_entity_unique_id: %s\n" % e)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **entity_unique_id** | **str**| The universally unique identifier of the compliance rule template. | 
 **as_at** | **datetime**| The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified. | [optional] 
 **previews** | [**List[str]**](str.md)| The ids of the staged modifications to be previewed in the response. | [optional] 
...
> ValuationPointEntity get_valuation_point_by_entity_unique_id(entity_unique_id, as_at=as_at, previews=previews)
...
def main():
    ...
    # Create an instance of the API class
    api_instance = api_client_factory.build(EntitiesApi)
    entity_unique_id = 'entity_unique_id_example' # str | The universally unique identifier of the valuation point.
    as_at = '2013-10-20T19:20:30+01:00' # datetime | The asAt datetime at which to retrieve the valuation point. Defaults to returning the latest version of the valuation point if not specified. (optional)
    previews = ['previews_example'] # List[str] | The ids of the staged modifications to be previewed in the response. (optional)

    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.get_valuation_point_by_entity_unique_id(entity_unique_id, as_at=as_at, previews=previews, opts=opts)
        ...
        print("Exception when calling EntitiesApi->get_valuation_point_by_entity_unique_id: %s\n" % e)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **entity_unique_id** | **str**| The universally unique identifier of the valuation point. | 
