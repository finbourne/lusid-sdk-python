...
json = "{}"
# create an instance of TermDepositAllOf from a JSON string
term_deposit_all_of_instance = TermDepositAllOf.from_json(json)
# print the JSON string representation of the object
print TermDepositAllOf.to_json()

# convert the object into a dict
term_deposit_all_of_dict = term_deposit_all_of_instance.to_dict()
# create an instance of TermDepositAllOf from a dict
term_deposit_all_of_form_dict = term_deposit_all_of.from_dict(term_deposit_all_of_dict)
```
