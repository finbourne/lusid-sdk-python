...
**prevailing_compliance_rule** | [**ComplianceRuleResponse**](ComplianceRuleResponse.md) |  | [optional] 
**deleted_compliance_rule** | [**ComplianceRuleResponse**](ComplianceRuleResponse.md) |  | [optional] 
**previewed_status** | **str** | The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist. | [optional] 
**previewed_compliance_rule** | [**ComplianceRuleResponse**](ComplianceRuleResponse.md) |  | [optional] 
...
prevailing_compliance_rule: Optional[ComplianceRuleResponse] = # Replace with your value
deleted_compliance_rule: Optional[ComplianceRuleResponse] = # Replace with your value
previewed_status: Optional[StrictStr] = "example_previewed_status"
previewed_compliance_rule: Optional[ComplianceRuleResponse] = # Replace with your value
links: Optional[List[Link]] = None
compliance_rule_entity_instance = ComplianceRuleEntity(href=href, entity_unique_id=entity_unique_id, as_at_version_number=as_at_version_number, status=status, as_at_deleted=as_at_deleted, user_id_deleted=user_id_deleted, request_id_deleted=request_id_deleted, effective_at_created=effective_at_created, prevailing_compliance_rule=prevailing_compliance_rule, deleted_compliance_rule=deleted_compliance_rule, previewed_status=previewed_status, previewed_compliance_rule=previewed_compliance_rule, links=links)
