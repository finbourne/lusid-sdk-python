...
**result_type** | **str** | Reconciliation run general result. Available values: Match, PartialMatch, Break, NotFound, Resolved. | 
**result_status** | **str** | Indicates how a particular result evolves from one run to the next. Available values: New, Confirmed, Changed. | 
**review_status** | **str** | Status of whether user has provided any input (comments, manual matches, break codes). Available values: Pending, Reviewed, Matched, Invalid. | 
