...
> AnnulStructuredDataResponse delete_structured_result_data(scope, structured_data_ids)
 ...
 **structured_data_ids** | [**dict(str, StructuredResultDataId)**](StructuredResultDataId.md)| The structured result data Ids to delete, each keyed by a unique correlation id. | 
...
> GetStructuredResultDataResponse get_structured_result_data(scope, structured_data_ids, effective_at=effective_at, as_at=as_at, max_age=max_age)
 ...
 **structured_data_ids** | [**dict(str, StructuredResultDataId)**](StructuredResultDataId.md)| The time invariant set of structured data identifiers to retrieve the data for. These need to be               keyed by a unique correlation id allowing the retrieved item to be identified in the response. | 
 **effective_at** | **str**| The effective datetime at which to retrieve the structured result data. Defaults to the current LUSID system datetime if not specified. | [optional] 
...
> UpsertStructuredDataResponse upsert_structured_result_data(scope, structured_data)
 ...
 **structured_data** | [**dict(str, UpsertStructuredResultDataRequest)**](UpsertStructuredResultDataRequest.md)| The set of structured result data items to update or insert keyed by a unique correlation id. | 
