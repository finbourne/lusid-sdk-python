...
**prevailing_compliance_rule_template** | [**ComplianceRuleTemplate**](ComplianceRuleTemplate.md) |  | [optional] 
**deleted_compliance_rule_template** | [**ComplianceRuleTemplate**](ComplianceRuleTemplate.md) |  | [optional] 
**previewed_status** | **str** | The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist. | [optional] 
**previewed_compliance_rule_template** | [**ComplianceRuleTemplate**](ComplianceRuleTemplate.md) |  | [optional] 
...
prevailing_compliance_rule_template: Optional[ComplianceRuleTemplate] = # Replace with your value
deleted_compliance_rule_template: Optional[ComplianceRuleTemplate] = # Replace with your value
previewed_status: Optional[StrictStr] = "example_previewed_status"
previewed_compliance_rule_template: Optional[ComplianceRuleTemplate] = # Replace with your value
links: Optional[List[Link]] = None
compliance_rule_template_entity_instance = ComplianceRuleTemplateEntity(href=href, entity_unique_id=entity_unique_id, as_at_version_number=as_at_version_number, status=status, as_at_deleted=as_at_deleted, user_id_deleted=user_id_deleted, request_id_deleted=request_id_deleted, effective_at_created=effective_at_created, prevailing_compliance_rule_template=prevailing_compliance_rule_template, deleted_compliance_rule_template=deleted_compliance_rule_template, previewed_status=previewed_status, previewed_compliance_rule_template=previewed_compliance_rule_template, links=links)
