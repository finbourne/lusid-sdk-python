...
version: Version
values: List[UnsettledTransaction]
href: Optional[StrictStr] = "example_href"
next_page: Optional[StrictStr] = "example_next_page"
previous_page: Optional[StrictStr] = "example_previous_page"
links: Optional[List[Link]] = None
valuation_point_resource_list_of_unsettled_transaction_instance = ValuationPointResourceListOfUnsettledTransaction(start_valuation_point=start_valuation_point, version=version, values=values, href=href, next_page=next_page, previous_page=previous_page, links=links)
