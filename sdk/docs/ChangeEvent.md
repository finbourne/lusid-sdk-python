...
carry_relationships: Optional[StrictStr] = "example_carry_relationships"
instrument_event_type: StrictStr = "example_instrument_event_type"
change_event_instance = ChangeEvent(record_date=record_date, payment_date=payment_date, new_instrument=new_instrument, units_ratio=units_ratio, change_type=change_type, term_target=term_target, term_target_identifier=term_target_identifier, additional_information=additional_information, carry_relationships=carry_relationships, instrument_event_type=instrument_event_type)
