...
json = "{}"
# create an instance of FxSwapAllOf from a JSON string
fx_swap_all_of_instance = FxSwapAllOf.from_json(json)
# print the JSON string representation of the object
print FxSwapAllOf.to_json()

# convert the object into a dict
fx_swap_all_of_dict = fx_swap_all_of_instance.to_dict()
# create an instance of FxSwapAllOf from a dict
fx_swap_all_of_form_dict = fx_swap_all_of.from_dict(fx_swap_all_of_dict)
```
