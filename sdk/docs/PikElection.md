...
------------ | ------------- | ------------- | -------------
**election_key** | **str** | Unique key associated to this election (the PIK type) | 
...
pik_election_instance = PikElection(election_key=election_key, is_default=is_default, is_chosen=is_chosen)
